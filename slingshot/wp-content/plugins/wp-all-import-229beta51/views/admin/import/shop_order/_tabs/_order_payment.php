						...
						<div class="form-field">
							...
							<div class="switcher-target-payment_method" style="margin-top:10px;">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<a href="#help" class="wpallimport-help" title="<?php _e('Payment method can be matched by title or slug. If payment method is not found \'N/A\' will be applied to order.', 'wp_all_import_plugin') ?>" style="position:relative; top:4px;">?</a>
								</span>
							</div>
						</div>												
					</div>	
