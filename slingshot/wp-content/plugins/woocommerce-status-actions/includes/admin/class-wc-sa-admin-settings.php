    ...
    class WC_SA_Settings extends WC_Settings_Page
    {
        ...
        public function get_sections()
        {
            ...
            $sections = array(
                ...
                'trigger_options' => __('Trigger options', 'woocommerce_status_actions'),
            );
        ...
        public function get_settings($current_section = '')
        {
            ...
            } elseif ('trigger_options' == $current_section) {
                $settings = apply_filters('wc_sa_general_settings', array(
                        array(
                            'title' => __('Trigger options', 'woocommerce_status_actions'),
                            'type' => 'title',
        ...
        public function edit_wc_sa_trigger_days()
        {
            ...
            ?>
            <div id="weekdays">
            <input type="hidden" id="trigger_options_days_off" name="trigger_options[days_off]" value='<?php echo $trigger_options['days_off'] ?>' >
                <?php foreach ($days as $key => $day) { ?>
                    <div class="row">
                        <label for="<?php echo $day ?>"><?php echo $day ?></label>
                        <input type="checkbox" id="<?php echo $day ?>"
                               name="trigger_options[weekday][<?php echo $key ?>]"
                            <?php echo (isset($trigger_options['weekday'][$key])) ? 'checked' : '' ?>>
                    </div>
                <?php } ?>
                <h3 for="days_off"><?php _e('Days off', 'woocommerce_status_actions') ?></h3>
                <div id="days_off">
            </div>
            <?php
        }
        ...
        public function edit_gateway_order_status($val)
        {
            ...
            <table class="wp-list-table widefat striped posts default_status_payments_methods">
                ...
                <tr>
                    <th colspan="7">
                        <input type="button" value="<?php _e('Reset Defaults', 'woocommerce_status_actions'); ?>"
        ...
        public function edit_existing_status($val)
        {
            ...
            <table class="wp-list-table widefat fixed posts default_status_settings">
                ...
                <?php foreach ($order_statuses as $key => $value) {
                    ...
                    <tr valign="top" data-statuskey="<?php echo $key; ?>" class="wc_order_statuses">
                        <th class="order_status column-order_status" scope="row">
                            <mark class="<?php echo $label; ?> tips"
                                  data-tip="<?php echo $value; ?>"><?php echo $value; ?></mark>
                        </th>
                        ...
                        <td class="forminp status_label">
                            <input type="text" name="<?php echo $val['id']; ?>[<?php echo $key; ?>][label]"
                                   value="<?php echo isset($data[$key]) && !empty($data[$key]['label']) ? $data[$key]['label'] : $label; ?>"
                                   class="statuslabel" maxlength="17">
                        </td>
                        <td class="forminp">
                            <?php
                            $color = '';
                ...
                <tr>
                    <th colspan="7">
                        <input type="button" value="Reset Defaults" class="button-primary alignright"
