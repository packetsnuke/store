<form name="warranty_form" id="warranty_form" method="POST" action="" enctype="multipart/form-data" >
    ...
    if ( ! empty( $errors ) ) {
        ...
        _e( 'The following errors were found while processing your request:', 'ultimatewoo-pro' );
        echo '<ul>';
    ...
    if ( $refunds_allowed || $coupons_allowed ):
        ?>
        <div class="wfb-field-div wfb-field-div-select">
            <label><?php _e('I want to request for a', 'ultimatewoo-pro'); ?></label>

            <select name="warranty_request_type" class="wfb-field">
                <option value="replacement"><?php _e('Replacement item', 'ultimatewoo-pro'); ?></option>
                <?php if ( $refunds_allowed ): ?>
                    <option value="refund"><?php _e('Refund', 'ultimatewoo-pro'); ?></option>
                <?php endif; ?>
                <?php if ( $coupons_allowed ): ?>
                    <option value="coupon"><?php _e('Refund as store credit', 'ultimatewoo-pro'); ?></option>
                <?php endif; ?>
            </select>
        </div>
    <?php
    ...
    ?>
	    <div class="wfb-field-div wfb-field-div-select">
		    <label><?php _e('Return Shipping Tracking', 'ultimatewoo-pro'); ?></label>
		    ...
		    <input type="text" class="tracking_code" name="tracking_code" value="" placeholder="<?php _e( 'Tracking code', 'ultimatewoo-pro' ); ?>" />
	    </div>
    ...
    <p>
        ...
        <input type="submit" name="submit" value="<?php _e('Submit', 'ultimatewoo-pro'); ?>" class="button">
    </p>
