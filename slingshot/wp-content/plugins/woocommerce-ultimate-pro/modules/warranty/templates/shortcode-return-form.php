...
<form name="warranty_form" id="warranty_form" method="POST" action="" enctype="multipart/form-data" >
    ...
    <div class="wfb-field-div">
        <label for="first_name" class="wfb-field-label"><?php _e('Name', 'ultimatewoo-pro'); ?></label>
    ...
    <div class="wfb-field-div">
        <label for="email" class="wfb-field-label"><?php _e('Email Address', 'ultimatewoo-pro'); ?></label>
        <input type="email" name="email" id="email" value="<?php echo esc_attr($defaults['email']); ?>" />
    </div>

    <div class="wfb-field-div">
        <label for="order_id" class="wfb-field-label"><?php _e('Order Number', 'ultimatewoo-pro'); ?></label>
        <input type="text" name="order_id" id="order_id" value="<?php echo esc_attr(@$_REQUEST['order_id']); ?>" />
    </div>

    <div class="wfb-field-div">
        <label for="product_name" class="wfb-field-label"><?php _e('Product', 'ultimatewoo-pro'); ?></label>
...
jQuery(document).ready(function($) {
    ...
    $("#warranty_form").submit(function() {
        ...
        if ( is_error ) {
            var msg = "<?php _e('Please complete the required fields and try submitting again. The following fields are incomplete:', 'ultimatewoo-pro'); ?>\n";
