...
<html>
<head>
    <title><?php printf(__('RMA Request #%d - %s', 'ultimatewoo-pro'), $warranty['ID'], get_bloginfo('name')); ?></title>
...
<div id="content">
    ...
    <table class="borderless details" cellpadding="5">
        ...
        ?>
        <tr>
            <th><?php _e('Tracking', 'ultimatewoo-pro'); ?>:</th>
