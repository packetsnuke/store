<tr valign="top">
    <td colspan="2" class="categories-warranty-container">
        <table class="wp-list-table widefat fixed striped posts warranty-category-table <?php echo $value['class']; ?>" style="min-width: 400px;">
            <thead>
            <tr>
                <th scope="col" id="col_category" class="manage-column column-category" style="padding-left: 20px;"><?php _e('Category', 'ultimatewoo-pro'); ?></th>
                <th scope="col" id="col_warranty" class="manage-column column-warranty"><?php _e('Warranty', 'ultimatewoo-pro'); ?></th>
            </tr>
            </thead>
                ...
                <tr id="edit_<?php echo $category_id; ?>" data-id="<?php echo $category_id; ?>" class="inline-edit-row inline-edit-row-post inline-edit-product quick-edit-row quick-edit-row-post inline-edit-product alternate inline-editor">
                    <td class="colspanchange" colspan="2">
                        ...
                        <p class="submit inline-edit-save">
                            <a class="button-primary updateinline" data-target="edit_<?php echo $category_id; ?>" href="#"><?php _e('Update', 'ultimatewoo-pro'); ?></a>
                            <a class="button-secondary editinline" data-target="edit_<?php echo $category_id; ?>" href="#"><?php _e('Close', 'ultimatewoo-pro'); ?></a>
                            <br class="clear">
                        </p>
                    </td>
                </tr>
