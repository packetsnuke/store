...
<div class="wrap woocommerce">
    <h2><?php _e('Product Warranties', 'ultimatewoo-pro'); ?></h2>
    <?php
    if ( isset($_GET['updated']) ) {
        echo '<div class="updated fade"><p>'. __('Product warranties saved!', 'ultimatewoo-pro') .'</p></div>';
    }
    ?>
    <form method="post" action="admin-post.php">
        <div class="tablenav">
            <div class="alignleft actions bulkactions">
                <label class="screen-reader-text" for="bulk-action-selector-top"><?php _e('Select bulk action', 'ultimatewoo-pro'); ?></label>
                <select id="bulk-action-selector-top">
                    <option selected="selected" value="-1"><?php _e('Bulk Actions', 'ultimatewoo-pro'); ?></option>
                    <option class="hide-if-no-js" value="edit"><?php _e('Edit', 'ultimatewoo-pro'); ?></option>
                </select>
        ...
        <table class="wp-list-table widefat fixed woocommerce_page_warranty_requests" cellspacing="0">
            ...
            <tr>
                ...
                <th scope="col" id="id" class="manage-column column-id" width="50"><?php _e('ID', 'ultimatewoo-pro'); ?></th>
                <th scope="col" id="thumb" class="manage-column column-thumb" style="width: 52px;"></th>
                <th scope="col" id="name" class="manage-column column-name"><?php _e('Name', 'ultimatewoo-pro'); ?></th>
                <th scope="col" id="price" class="manage-column column-price"><?php _e('Price', 'ultimatewoo-pro'); ?></th>
                <th scope="col" id="categories" class="manage-column column-categories"><?php _e('Categories', 'ultimatewoo-pro'); ?></th>
                <th scope="col" id="warranty" class="manage-column column-warranty"><?php _e('Warranty', 'ultimatewoo-pro'); ?></th>
            </tr>
            </thead>
            <tbody>
            <?php
                ...
                <tr id="row_<?php echo $_product->get_id(); ?>" data-id="<?php echo $_product->get_id(); ?>">
                    ...
                    <td>
                        ...
                        <div class="row-actions">
                            <span class="inline hide-if-no-js"><a class="editinline" data-target="edit_<?php echo $_product->get_id(); ?>" href="#"><?php _e('Edit', 'ultimatewoo-pro'); ?></a></span>
                        </div>
                    </td>
                    <td>
                    ...
                    <td class="colspanchange" colspan="7">
                        ...
                        <fieldset class="inline-edit-col-left">
                            <div class="inline-edit-col">
                                <h4><?php _e('Warranty Settings', 'ultimatewoo-pro'); ?></h4>
                                ...
                                <div class="inline-edit-group">
                                    <label class="alignleft">
                                        ...
                                        <span class="checkbox-title"><?php _e('Default warranty', 'ultimatewoo-pro'); ?></span>
                                    </label>
                                </div>

                                <label class="alignleft">
                                    <span class="title"><?php _e('Type', 'ultimatewoo-pro'); ?></span>
                                    <span class="input-text-wrap">
                                        <select name="warranty_type[<?php echo $_product->get_id(); ?>]" class="warranty-type warranty_<?php echo $_product->get_id(); ?>" id="warranty_type_<?php echo $_product->get_id(); ?>" data-id="<?php echo $_product->get_id(); ?>">
                                            <option <?php selected($warranty['type'], 'no_warranty'); ?> value="no_warranty"><?php _e('No Warranty', 'ultimatewoo-pro'); ?></option>
                                            <option <?php selected($warranty['type'], 'included_warranty'); ?> value="included_warranty"><?php _e('Warranty Included', 'ultimatewoo-pro'); ?></option>
                                            <option <?php selected($warranty['type'], 'addon_warranty'); ?> value="addon_warranty"><?php _e('Warranty as Add-On', 'ultimatewoo-pro'); ?></option>
                                        </select>
                                    </span>
                                </label>
                                <br class="clear" />
                                ...
                                <label class="alignleft show_if_included_warranty show_if_addon_warranty">
                                    <span class="title"><?php _e('Label', 'ultimatewoo-pro'); ?></span>
                                    <span class="input-text-wrap">
                                ...
                                <label class="alignleft included-form">
                                    <span class="title"><?php _e('Validity', 'ultimatewoo-pro'); ?></span>
                                    <span class="input-text-wrap">
                                        <select name="included_warranty_length[<?php echo $_product->get_id(); ?>]" class="select short included-warranty-length warranty_<?php echo $_product->get_id(); ?>" id="included_warranty_length_<?php echo $_product->get_id(); ?>">
                                            <option <?php if ($warranty['type'] == 'included_warranty' && $warranty['length'] == 'lifetime') echo 'selected'; ?> value="lifetime"><?php _e('Lifetime', 'ultimatewoo-pro'); ?></option>
                                            <option <?php if ($warranty['type'] == 'included_warranty' && $warranty['length'] == 'limited') echo 'selected'; ?> value="limited"><?php _e('Limited', 'ultimatewoo-pro'); ?></option>
                                        </select>
                                    </span>
                                </label>
                                <br class="clear" />
                                ...
                                <div class="inline-edit-group included-form" id="limited_warranty_row_<?php echo $_product->get_id(); ?>">
                                    <label class="alignleft">
                                        <span class="title"><?php _e('Length', 'ultimatewoo-pro'); ?></span>
                                        <span class="input-text-wrap">
                                    ...
                                    <label class="alignleft">
                                        <select name="limited_warranty_length_duration[<?php echo $_product->get_id(); ?>]" class="warranty_<?php echo $_product->get_id(); ?>" style="vertical-align: baseline;">
                                            <option <?php if ($warranty['type'] == 'included_warranty' && $warranty['duration'] == 'days') echo 'selected'; ?> value="days"><?php _e('Days', 'ultimatewoo-pro'); ?></option>
                                            <option <?php if ($warranty['type'] == 'included_warranty' && $warranty['duration'] == 'weeks') echo 'selected'; ?> value="weeks"><?php _e('Weeks', 'ultimatewoo-pro'); ?></option>
                                            <option <?php if ($warranty['type'] == 'included_warranty' && $warranty['duration'] == 'months') echo 'selected'; ?> value="months"><?php _e('Months', 'ultimatewoo-pro'); ?></option>
                                            <option <?php if ($warranty['type'] == 'included_warranty' && $warranty['duration'] == 'years') echo 'selected'; ?> value="years"><?php _e('Years', 'ultimatewoo-pro'); ?></option>
                                        </select>
                                    </label>
                                </div>
                            ...
                            <div class="inline-edit-col addon-form">
                                ...
                                <div class="inline-edit-group">
                                    <label class="alignleft">
                                        ...
                                        <span class="checkbox-title"><?php _e( '"No Warranty" option', 'ultimatewoo-pro'); ?></span>
                                    </label>
                                </div>
                                ...
                                <div class="inline-edit-group">
                                    <table class="widefat">
                                        <thead>
                                        <tr>
                                            <th><?php _e('Cost', 'ultimatewoo-pro'); ?></th>
                                            <th><?php _e('Duration', 'ultimatewoo-pro'); ?></th>
                                            <th width="50">&nbsp;</th>
                                        </tr>
                                        </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle">
                                                    ...
                                                    <select name="addon_warranty_length_duration[<?php echo $_product->get_id(); ?>][]" class="warranty_<?php echo $_product->get_id(); ?>">
                                                        <option <?php if ($warranty['type'] == 'addon_warranty') selected($addon['duration'], 'days'); ?> value="days"><?php _e('Days', 'ultimatewoo-pro'); ?></option>
                                                        <option <?php if ($warranty['type'] == 'addon_warranty') selected($addon['duration'], 'weeks'); ?> value="weeks"><?php _e('Weeks', 'ultimatewoo-pro'); ?></option>
                                                        <option <?php if ($warranty['type'] == 'addon_warranty') selected($addon['duration'], 'months'); ?> value="months"><?php _e('Months', 'ultimatewoo-pro'); ?></option>
                                                        <option <?php if ($warranty['type'] == 'addon_warranty') selected($addon['duration'], 'years'); ?> value="years"><?php _e('Years', 'ultimatewoo-pro'); ?></option>
                                                    </select>
                                                </td>
                        ...
                        <p class="submit inline-edit-save">
                            <a class="button-secondary alignleft editinline" data-target="edit_<?php echo $_product->get_id(); ?>" href="#"><?php _e('Close', 'ultimatewoo-pro'); ?></a>
                            <a class="button-primary save alignright" href="#inline-edit"><?php _e('Update', 'ultimatewoo-pro'); ?></a>
                    ...
                    foreach ($_product->get_children() as $child):
                        ...
                        <tr id="edit_<?php echo $child; ?>" data-id="<?php echo $child; ?>" class="inline-edit-row inline-edit-row-post inline-edit-product quick-edit-row quick-edit-row-post inline-edit-product alternate inline-editor">
                            <td class="colspanchange" colspan="7">
                                ...
                                <p class="submit inline-edit-save">
                                    <a class="button-secondary alignleft editinline" data-target="edit_<?php echo $child; ?>" href="#"><?php _e('Close', 'ultimatewoo-pro'); ?></a>
                                    <a class="button-primary save alignright" href="#inline-edit"><?php _e('Update', 'ultimatewoo-pro'); ?></a>
                                    <span class="spinner"></span>
                                    <br class="clear">
                                </p>
        ...
        <div class="tablenav">
            <div class="alignleft actions bulkactions">
                <label class="screen-reader-text" for="bulk-action-selector-bottom"><?php _e('Select bulk action', 'ultimatewoo-pro'); ?></label>
            ...
            <div class="alignleft" style="line-height: 30px;">
                <span class="displaying-num"><?php _e('Products per Page:', 'ultimatewoo-pro'); ?></span>
                <span class="pagination-links">
    ...
    <tr id="bulk-edit" data-id="bulk" class="inline-edit-row inline-edit-row-post inline-edit-product bulk-edit-row bulk-edit-row-post bulk-edit-product inline-editor">
        <td class="colspanchange" colspan="7">
                    ...
                    <label class="alignleft">
                        ...
                        <span class="input-text-wrap">
                            <select name="warranty_type_bulk" class="warranty-type warranty_bulk" id="warranty_type_bulk" data-id="bulk">
                                <option value="no_warranty"><?php _e('No Warranty', 'ultimatewoo-pro'); ?></option>
                                <option value="included_warranty"><?php _e('Warranty Included', 'ultimatewoo-pro'); ?></option>
                                <option value="addon_warranty"><?php _e('Warranty as Add-On', 'ultimatewoo-pro'); ?></option>
                            </select>
                        </span>
                    </label>
                    <br class="clear" />
                    ...
                    <label class="alignleft included-form">
                        ...
                        <span class="input-text-wrap">
                            <select name="included_warranty_length_bulk" class="select short included-warranty-length warranty_bulk" id="included_warranty_length_bulk">
                                <option value="lifetime"><?php _e('Lifetime', 'ultimatewoo-pro'); ?></option>
                                <option value="limited"><?php _e('Limited', 'ultimatewoo-pro'); ?></option>
                            </select>
                        </span>
                    </label>
                    <br class="clear" />
            ...
            <p class="submit inline-edit-save">
                <a class="button-secondary alignleft close-bulk-edit" href="#"><?php _e('Cancel', 'ultimatewoo-pro'); ?></a>
                <input type="hidden" name="action" value="warranty_bulk_edit" />
                <input type="submit" value="<?php _e('Update', 'ultimatewoo-pro'); ?>" class="button button-primary alignright" id="bulk_edit" name="bulk_edit">
                <br class="clear">
            </p>
        </td>
    </tr>
