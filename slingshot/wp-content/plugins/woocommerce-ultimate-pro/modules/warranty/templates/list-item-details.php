    ...
    <td colspan="<?php echo $this->num_columns; ?>" class="colspanchange">
        ...
        <fieldset class="inline-edit-col">
            <div class="warranty-comments" style="float: right;">
                <h4><?php _e('Admin Notes', 'ultimatewoo-pro'); ?></h4>
                ...
                <div class="add-note">
                    ...
                    <p>
                        <a class="add_note button" data-request="<?php echo esc_attr( $request['ID'] ); ?>" href="#"><?php _e('Add', 'ultimatewoo-pro'); ?></a>
                    </p>
                </div>
            </div>
            ...
            <div class="inline-edit-col">
                <div class="codes_form closeable">
                    <?php if ( !empty( $this->inputs ) ): ?>
                        <h4><?php _e('Additional Details', 'ultimatewoo-pro'); ?></h4>
                        <?php
                    ...
                    if ( $shipping_label_id ) {
                        ...
                        <input class="rma-upload-button button" type="button" data-id="<?php echo $request['ID']; ?>" data-uploader_title="<?php _e('Set Shipping Label', 'ultimatewoo-pro'); ?>" data-uploader_button_text="<?php _e('Set Shipping Label', 'ultimatewoo-pro'); ?>" value="<?php _e('Select Shipping Label', 'ultimatewoo-pro'); ?>" />
                    <?php
            ...
            <div class="inline-edit-col warranty-tracking">
                <h4><?php _e('Return tracking details', 'ultimatewoo-pro'); ?></h4>
                ...
                ?>
                <div class="codes_form closeable">
                    <div class="wc-tracking-requested wc-updated <?php echo $class; ?>"><p><?php _e('Tracking information requested from customer', 'ultimatewoo-pro'); ?></p></div>
                ...
                <div class="codes_form closeable">
                    <div class="wc-tracking-saved wc-updated hidden"><p><?php _e('Shipping/Tracking data saved', 'ultimatewoo-pro'); ?></p></div>
                    <?php
        ...
        <div class="submit inline-edit-save">
            <div class="alignright">
                ...
                <input type="button" class="button-primary rma-update" data-id="<?php echo $request['ID']; ?>" data-security="<?php echo $update_nonce; ?>" value="<?php _e('Update', 'ultimatewoo-pro'); ?>" />
            </div>
