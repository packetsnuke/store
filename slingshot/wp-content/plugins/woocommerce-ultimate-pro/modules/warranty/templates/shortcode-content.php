<div id="primary">
    <div id="wcContent" role="main">
        ...
        if ( in_array($order_status, $include) && Warranty_Order::order_has_warranty($order) ) {
            ...
            echo '<div class="woocommerce-error">'. __('There are no valid warranties for this order', 'ultimatewoo-pro') .'</div>';
            echo '<p><a href="'. get_permalink(wc_get_page_id('myaccount')) .'" class="button">'. __('Back to My Account', 'ultimatewoo-pro') .'</a></p>';
        }
