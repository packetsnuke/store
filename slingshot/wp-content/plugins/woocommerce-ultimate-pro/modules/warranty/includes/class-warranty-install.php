...
class Warranty_Install {
    ...
    public function install_notice() {
        ...
        if ( get_option( 'warranty_needs_update' ) == 1 ) {
            ...
            <div id="message" class="updated">
                <p><?php _e( '<strong>WC Warranty Data Update Required</strong>', 'ultimatewoo-pro' ); ?></p>
                <p class="submit"><a href="<?php echo add_query_arg( 'warranty_update', 'true', admin_url( 'admin.php?page=warranties' ) ); ?>" class="warranty-update-now button-primary"><?php _e( 'Run the updater', 'ultimatewoo-pro' ); ?></a></p>
            </div>
    ...
    public function updated_notice() {
        ?>
        <div id="message" class="updated">
            <p><?php _e('Data update have been successfully applied!', 'ultimatewoo-pro'); ?></p>
        </div>
    <?php
    }
    ...
    public function register_post_type() {
        ...
        if (! taxonomy_exists( 'shop_warranty_status' ) ) {
            register_taxonomy( 'shop_warranty_status',
                ...
                array(
                    ...
                    'labels' => array(
                        'name'              => __( 'Warranty Statuses', 'ultimatewoo-pro'),
                        'singular_name'     => __( 'Warranty Status', 'ultimatewoo-pro'),
                        'search_items'      => __( 'Search Warranty Statuses', 'ultimatewoo-pro'),
                        'all_items'         => __( 'All Warranty Statuses', 'ultimatewoo-pro'),
                        'parent_item'       => __( 'Parent Warranty Status', 'ultimatewoo-pro'),
                        'parent_item_colon' => __( 'Parent Warranty Status:', 'ultimatewoo-pro'),
                        'edit_item'         => __( 'Edit Warranty Status', 'ultimatewoo-pro'),
                        'update_item'       => __( 'Update Warranty Status', 'ultimatewoo-pro'),
                        'add_new_item'      => __( 'Add New Warranty Status', 'ultimatewoo-pro'),
                        'new_item_name'     => __( 'New Warranty Status Name', 'ultimatewoo-pro')
                    ),
                    'show_ui'               => false,
        ...
        if (! post_type_exists( 'warranty_request' ) ) {
            register_post_type( 'warranty_request', array(
                    'label'                 => __('Warranty Requests', 'ultimatewoo-pro'),
                    'labels'                => array(
                        'name'              => __('Warranty Requests', 'ultimatewoo-pro'),
                        'singular_name'     => __('Warranty Request', 'ultimatewoo-pro'),
                        'all_items'         => __('All Requests', 'ultimatewoo-pro'),
                        'menu_name'         => __( 'Warranty', 'ultimatewoo-pro' ),
                        'not_found'         => __('No requests found', 'ultimatewoo-pro')
                    ),
                    'public'                => true,
    ...
    public function create_warranty_request_page() {
        ...
        if (! get_option('woocommerce_warranty_page_id') ) {
            ...
            if ( $parent_id ) {
                $_p = array();
                $_p['post_title'] = __('Request Warranty', 'ultimatewoo-pro');
    ...
    private function migrate_warranty_form() {
        ...
        if (false == get_option( 'wc_warranty_form_migrated', false ) ) {
            ...
            $field  = array(
                'name'      => __('Reason', 'ultimatewoo-pro'),
                'label'     => __('Select reason to request for warranty', 'ultimatewoo-pro'),
            ...
            if ( $question ) {
                ...
                $field  = array(
                    'name'      => __('Description', 'ultimatewoo-pro'),
            ...
            if ( $upload_file == 'yes' ) {
                ...
                $field  = array(
                    'name'      => __('Attachment', 'ultimatewoo-pro'),
