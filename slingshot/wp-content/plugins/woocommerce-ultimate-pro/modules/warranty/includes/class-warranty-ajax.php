...
class Warranty_Ajax {
    ...
    public static function update_request_fragment() {
        ...
        if ( $type == 'change_status' ) {
            ...
            $message = __('Request status updated', 'ultimatewoo-pro');
            ...
            $message = __('RMA Code generated successfully', 'ultimatewoo-pro');
            ...
            $message = __('Tracking code requested', 'ultimatewoo-pro');
            ...
            $message = __('Return tracking code updated', 'ultimatewoo-pro');
        }
    ...
    public static function update_request_status() {
        ...
        wp_send_json(array(
            'status'    => 'OK',
            'message'   => __('Status updated', 'ultimatewoo-pro'),
    ...
    public static function set_tracking() {
        ...
        wp_send_json(array(
            'status' => 'OK',
            'message' => __('Shipping tracking details saved', 'ultimatewoo-pro')
        ));
    }
    ...
    public static function update_inline() {
        ...
        wp_send_json(array(
            'status'    => 'OK',
            'message'   => __('RMA request updated', 'ultimatewoo-pro'),
    ...
    public static function return_inventory() {
        ...
        wp_send_json(array(
            'status'    => 'OK',
            'message'   => __('Product stock returned', 'ultimatewoo-pro')
        ));
    }
