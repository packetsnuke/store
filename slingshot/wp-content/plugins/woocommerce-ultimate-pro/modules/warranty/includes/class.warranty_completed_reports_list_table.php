...
class Warranty_Completed_Reports_List_Table extends WP_List_Table {
    ...
    function get_columns(){
        $columns = array(
            ...
            'status'    => __('RMA Status', 'ultimatewoo-pro'),
            'customer'  => __('Customer Name', 'ultimatewoo-pro'),
            'product'   => __('Product', 'ultimatewoo-pro'),
            'validity'  => __('Validity', 'ultimatewoo-pro'),
            'date'      => __('Order Date', 'ultimatewoo-pro')
        );
        return $columns;
    }
        ...
        if ( $warranty ) {
            ...
            if ( 'addon_warranty' === $warranty['type'] ) {
                ...
                if ( $warranty['length'] == 'lifetime' ) {
                    echo __('Lifetime', 'ultimatewoo-pro');
                } else {
                    if (! empty($completed) ) {
