...
class WC_Points_Rewards_Actions {
	...
	public function points_rewards_action_settings( $settings ) {
		...
		$settings = array_merge(
			...
			array(
				array(
					'title'    => __( 'Points earned for account signup', 'ultimatewoo-pro' ),
					'desc_tip' => __( 'Enter the amount of points earned when a customer signs up for an account.', 'ultimatewoo-pro' ),
					'id'       => 'wc_points_rewards_account_signup_points',
				),

				array(
					'title'    => __( 'Points earned for writing a review', 'ultimatewoo-pro' ),
					'desc_tip' => __( 'Enter the amount of points earned when a customer first reviews a product.', 'ultimatewoo-pro' ),
	...
	public function add_action_event_descriptions( $event_description, $event_type, $event ) {
		...
		switch ( $event_type ) {
			case 'product-review': $event_description = sprintf( __( '%s earned for product review', 'ultimatewoo-pro' ), $points_label ); break;
			case 'account-signup': $event_description = sprintf( __( '%s earned for account signup', 'ultimatewoo-pro' ), $points_label ); break;
		}
