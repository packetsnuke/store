 ...
 */
?>
<h2><?php printf( __( 'My %s', 'ultimatewoo-pro' ), $points_label  ); ?></h2>

<p><?php printf( __( "You have %d %s", 'ultimatewoo-pro' ), $points_balance, $points_label ); ?></p>

<?php if ( $events ) : ?>
	<table class="shop_table my_account_points_rewards my_account_orders">
		<thead>
			<tr>
				<th class="points-rewards-event-description"><span class="nobr"><?php _e( 'Event', 'ultimatewoo-pro' ); ?></span></th>
				<th class="points-rewards-event-date"><span class="nobr"><?php _e( 'Date', 'ultimatewoo-pro' ); ?></span></th>
