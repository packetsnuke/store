...
class WC_Points_Rewards {
	...
	public function add_menu_items( $menu_items ) {
		...
		$menu_items[ $this->endpoint ] = __( 'Points', 'ultimatewoo-pro' );
	...
	public function add_plugin_configure_link( $actions ) {
		...
		return ( array_merge( array( 'configure' => sprintf( '<a href="%s">%s</a>', admin_url( 'admin.php?page=woocommerce-points-and-rewards&tab=settings' ), __( 'Configure', 'ultimatewoo-pro' ) ) ),
		$actions )
		);
	}
	...
	public function get_plugin_path() {
		return $this->plugin_path = ULTIMATEWOO_MODULES_DIR . '/points-and-rewards';
	}
	...
	public function get_plugin_url() {
		return $this->plugin_url = ULTIMATEWOO_MODULES_URL . '/points-and-rewards';
	}
