...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	<thead>
	<tr>
		<th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Customer', 'ultimatewoo-pro'); ?></th>
		<th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Email Address', 'ultimatewoo-pro'); ?></th>
		<th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Event', 'ultimatewoo-pro'); ?></th>
		<th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Ticket', 'ultimatewoo-pro'); ?></th>
		<th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Paid', 'ultimatewoo-pro'); ?></th>
		<th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Date', 'ultimatewoo-pro'); ?></th>
	</tr>
	</thead>
	<tbody>
	<?php
