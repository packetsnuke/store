<ul class="fue-templates">
	...
	if ( empty( $templates ) && empty( $installed_templates ) ) {
		echo '<li>'. __('No templates available', 'ultimatewoo-pro') .'</li>';
	} else {
...
<div id="template_editor">
	<p class="submit">
		<input type="button" class="button-primary edit-html-save" value="<?php _e('Save', 'ultimatewoo-pro'); ?>" />
		<input type="button" class="button edit-html-close" value="<?php _e('Close', 'ultimatewoo-pro'); ?>" />
