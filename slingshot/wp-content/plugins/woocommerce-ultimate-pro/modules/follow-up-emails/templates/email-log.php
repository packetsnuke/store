<div class="wrap">
	<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
		<a href="admin.php?page=followup-emails&amp;tab=history" class="nav-tab nav-tab-active"><?php _e('Emails History', 'ultimatewoo-pro'); ?></a>
		<a href="admin.php?page=followup-emails-reports&amp;tab=dbg_queue" class="nav-tab <?php if ($tab == 'dbg_queue') echo 'nav-tab-active'; ?>"><?php _e('Queue', 'ultimatewoo-pro'); ?></a>
	</h2>
		...
		<div class="tablenav top">
			<div class="alignleft actions">
				<select id="email_filter" name="id">
					<option selected="selected" value=""><?php _e('Select Email', 'ultimatewoo-pro'); ?></option>
