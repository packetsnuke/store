...
<div class="wrap woocommerce">
	...
	<h2>
		<?php _e('Follow-Up Emails &raquo; Email Coupons', 'ultimatewoo-pro'); ?>
		<a href="admin.php?page=followup-emails-coupons&action=new-coupon" class="add-new-h2"><?php _e('Add Coupon', 'wc_followup_emalis'); ?></a>
	</h2>
	
	<p><?php _e('Add customized and automated coupons to your follow-ups. You must create the coupon in this menu first, then select to include it in your Follow-up. The coupon code generation feature used here allows coupons to be created that are are unique for each user.', 'ultimatewoo-pro'); ?></p> 
	...
	<div class="subsubsub_section">
		<ul class="subsubsub">
			<li>
				<a href="#coupons" class="current"><?php _e('Coupons', 'ultimatewoo-pro'); ?></a> |
				<a href="#usage" class=""><?php _e('Reports', 'ultimatewoo-pro'); ?></a>
			</li>
		</ul>
		<br class="clear">
		...
		<div class="section" id="coupons">
			<form action="admin-post.php" method="post">
				<table class="widefat fixed striped posts">
					<thead>
					<tr>
						<th scope="col" id="name" class="manage-column column-name" style=""><?php _e('Name', 'ultimatewoo-pro'); ?></th>
						<th scope="col" id="type" class="manage-column column-type" style=""><?php _e('Type', 'ultimatewoo-pro'); ?></th>
						<th scope="col" id="amount" class="manage-column column-amount" style=""><?php _e('Amount', 'ultimatewoo-pro'); ?></th>
						<th scope="col" id="usage_count" class="manage-column column-usage_count" style=""><?php _e('Sent', 'ultimatewoo-pro'); ?></th>
					</tr>
					</thead>
					<tbody id="the_list">
					<?php
					if (empty($coupons)):
						?>
						<tr scope="row">
							<th colspan="4"><?php _e('No coupons available', 'ultimatewoo-pro'); ?></th>
						</tr>
					<?php
					else:
							...
							<tr scope="row">
								<td class="post-title column-title">
									...
									<div class="row-actions">
										<span class="edit"><a href="admin.php?page=followup-emails-coupons&action=edit-coupon&id=<?php echo $coupon->id; ?>"><?php _e('Edit', 'ultimatewoo-pro'); ?></a></span>
										|
										<span class="trash"><a onclick="return confirm('<?php _e('Really delete this entry?', 'ultimatewoo-pro'); ?>');" href="admin-post.php?action=fue_delete_coupon&id=<?php echo $coupon->id; ?>"><?php _e('Delete', 'ultimatewoo-pro'); ?></a></span>
									</div>
								</td>
			...
			<form action="admin-post.php" method="post">
				<table class="widefat fixed striped posts">
					...
					<tr>
						...
						<th scope="col" id="coupon_name" class="manage-column column-type" style=""><?php _e('Coupon Name', 'ultimatewoo-pro'); ?></th>
						<th scope="col" id="email_address" class="manage-column column-usage_count <?php echo $email_address_class .' '. $email_address_sort; ?>" style="">
							<a href="admin.php?page=followup-emails-reports&tab=reports&sortby=email_address&sort=<?php echo $email_address_dir; ?>&v=coupons">
								<span><?php _e('Email Address', 'ultimatewoo-pro'); ?></span>
								<span class="sorting-indicator"></span>
							</a>
						</th>
						<th scope="col" id="coupon_code" class="manage-column column-usage_count" style=""><?php _e('Coupon Code', 'ultimatewoo-pro'); ?> <img class="help_tip" width="16" height="16" title="<?php _e('This is the unique coupon code generated by the follow-up email for this specific email address', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" /></th>
						<th scope="col" id="email_name" class="manage-column column-usage_count" style=""><?php _e('Email Name', 'ultimatewoo-pro'); ?> <img class="help_tip" width="16" height="16" title="<?php _e('This is the name of the follow-up email that generated the coupon that was sent to this specific email address', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" /></th>
						<th scope="col" id="used" class="manage-column column-used <?php echo $used_class .' '. $used_sort; ?>" style="">
							<a href="admin.php?page=followup-emails-reports&tab=reports&sortby=coupon_used&sort=<?php echo $used_dir; ?>&v=coupons">
								<span><?php _e('Used', 'ultimatewoo-pro'); ?>  <img class="help_tip" width="16" height="16" title="<?php _e('This tells you if this specific coupon code generated and sent via follow-up emails has been used, and if it has, it includes the date and time', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" /></span>
								<span class="sorting-indicator"></span>
							</a>
						</th>
						<th scope="col" id="date_sent" class="manage-column column-date_sent <?php echo $sent_class .' '. $sent_sort; ?>" style="">
							<a href="admin.php?page=followup-emails-reports&tab=reports&sortby=date_sent&sort=<?php echo $sent_dir; ?>&v=coupons">
								<span><?php _e('Date Sent', 'ultimatewoo-pro'); ?> <img class="help_tip" width="16" height="16" title="<?php _e('This is the date and time that this specific coupon code was sent to this email address', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" /></span>
								<span class="sorting-indicator"></span>
							</a>
						</th>
					</tr>
				...
				<div class="tablenav bottom">
					<div class="alignleft actions bulkactions">
						...
						<select name="coupons_action">
							...
							<option value="trash"><?php _e('Delete Selected', 'ultimatewoo-pro'); ?></option>
						</select>
