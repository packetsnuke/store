...
<div id="coupons_details" class="panel fue_panel">
	...
	<div class="options_group class_coupon coupon_tr" style="display: none;">
		<p class="form-field">
			<label for="coupon_id"><?php _e('Select a Coupon', 'ultimatewoo-pro'); ?></label>
