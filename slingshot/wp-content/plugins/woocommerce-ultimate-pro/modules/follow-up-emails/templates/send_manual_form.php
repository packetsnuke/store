...
<div class="wrap email-form">
	...
	<h2><?php _e('Follow-Up Emails &raquo; Send Manual Email', 'ultimatewoo-pro'); ?></h2>

	<form action="admin-post.php" method="post" id="frm">
		<h3><?php printf(__('Send Email: %s', 'ultimatewoo-pro'), $email->name); ?></h3>

		<table class="form-table">
			<tbody>
				<tr valign="top" class="send_type_tr">
					<th scope="row" class="send_type_th">
						<label for="send_type"><?php _e('Send Email To', 'ultimatewoo-pro'); ?></label>
					</th>
					<td class="send_type_td">
						<select name="send_type" id="send_type" style="min-width: 25em;">
							<option value="email"><?php _e('This email address', 'ultimatewoo-pro'); ?></option>
							<option value="subscribers"><?php _e('Subscribers and Lists', 'ultimatewoo-pro'); ?></option>
							<option value="roles"><?php _e('User Role', 'ultimatewoo-pro'); ?></option>
						...
						<div class="send-type-subscribers send-type-div">
							<select name="email_list" id="email_list" style="min-width: 25em;">
								<option value=""><?php _e('All Subscribers', 'ultimatewoo-pro'); ?></option>
						...
						<div class="send-type-roles send-type-div">
							<select name="roles[]" multiple id="roles" class="select2" data-placeholder="<?php _e('Select the Roles to send to', 'ultimatewoo-pro'); ?>" style="width: 400px;">
				...
				<tr valign="top" class="sending_schedule">
					<th scope="row">
						<label for="schedule_email"><?php _e('Send at a specific time', 'ultimatewoo-pro'); ?></label>
					</th>
					<td>
				...
				<tr valign="top" class="sending_schedule_picker">
					...
					<td>
						...
						<input type="number" min="1" max="12" step="1" name="sending_schedule_hour" value="" placeholder="<?php _e('Hour', 'ultimatewoo-pro'); ?>" style="width:80px;" />
						<input type="number" min="0" max="59" step="1" name="sending_schedule_minute" value="" placeholder="<?php _e('Minute', 'ultimatewoo-pro'); ?>" style="width:80px;" />
				...
				<tr valign="top" class="send_again_tr">
					<th scope="row">
						<label for="send_again"><?php _e('Send again', 'ultimatewoo-pro'); ?></label>
					</th>
					<td>
				...
				<tr valign="top" class="class_send_again send_again_interval_tr">
					<th scope="row" class="interval_th">
						<label for="interval_type"><?php _e('Send again in:', 'ultimatewoo-pro'); ?></label>
					</th>
				...
				<tr valign="top">
					<th scope="row">
						<label for="subject"><?php _e('Email Subject', 'ultimatewoo-pro'); ?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="message"><?php _e('Email Body', 'ultimatewoo-pro'); ?></label>
						<br />
						<span class="description">
							<?php _e('You may use the following variables in the Email Subject and Body', 'ultimatewoo-pro'); ?>
							<ul>
								<?php do_action('fue_email_manual_variables_list', $email); ?>
								<li class="var hideable var_web_version_url"><strong>{webversion_url}</strong> <img class="help_tip" title="<?php _e('The URL to the web version of the email.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_web_version_link"><strong>{webversion_link}</strong> <img class="help_tip" title="<?php _e('Renders a <em>View in browser</em> link that points to the web version of the email.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_customer_username"><strong>{customer_username}</strong> <img class="help_tip" title="<?php _e('The first name of the customer who purchased from your store.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_customer_first_name"><strong>{customer_first_name}</strong> <img class="help_tip" title="<?php _e('The first name of the customer who purchased from your store.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_customer_name"><strong>{customer_name}</strong> <img class="help_tip" title="<?php _e('The full name of the customer who purchased from your store.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_customer_email"><strong>{customer_email}</strong> <img class="help_tip" title="<?php _e('The email address of the customer who purchased from your store.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_store_url"><strong>{store_url}</strong> <img class="help_tip" title="<?php _e('The URL/Address of your store.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_store_url_path"><strong>{store_url=path}</strong> <img class="help_tip" title="<?php _e('The URL/Address of your store with path added at the end. Ex. {store_url=/categories}', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_store_name"><strong>{store_name}</strong> <img class="help_tip" title="<?php _e('The name of your store.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_unsubscribe_url"><strong>{unsubscribe_url}</strong> <img class="help_tip" title="<?php _e('URL where users will be able to opt-out of the email list.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
								<li class="var hideable var_post_id"><strong>{post_id=xx}</strong> <img class="help_tip" title="<?php _e('Include the excerpt of the specified Post ID.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
							</ul>
						</span>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="tracking_on"><?php _e('Add Google Analytics tracking to links', 'ultimatewoo-pro'); ?></label>
					</th>
					<td>
				...
				<tr class="tracking_on">
					...
					<td>
						...
						<p class="description">
							<?php _e('The value inserted here will be appended to all URLs in the Email Body', 'ultimatewoo-pro'); ?>
						</p>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<input type="button" id="test_send" value="<?php _e('Send Test', 'ultimatewoo-pro'); ?>" class="button" />
					</td>
				</tr>
			</tbody>
		</table>
		<p class="submit">
			...
			<input type="submit" name="save" id="save" value="<?php _e('Send Email Now', 'ultimatewoo-pro'); ?>" class="button-primary" />
		</p>
	</form>
</div>
