<div class="wrap">
	...
	<h2>
		<?php _e('Manage Opt-outs', 'ultimatewoo-pro'); ?>
	</h2>

	<?php if (isset($_GET['restored']) && $_GET['restored'] > 0): ?>
		<div id="message" class="updated"><p><?php printf( _n('1 email has been restored', '%d emails have been restored', intval($_GET['restored']), 'ultimatewoo-pro'), intval($_GET['restored'])); ?></p></div>
	<?php endif; ?>

	<?php if (isset($_GET['added'])): ?>
		<div id="message" class="updated"><p><?php printf(__('<em>%s</em> has been added to the opt-out list', 'ultimatewoo-pro'), strip_tags($_GET['added'])); ?></p></div>
	<?php endif; ?>
	...
	<form action="admin-post.php" method="post">
		...
		<table class="wp-list-table widefat fixed striped posts">
			...
			<tr>
				...
				<th scope="col" class="manage-column column-email_address" style=""><?php _e('Email Address', 'ultimatewoo-pro'); ?></th>
				<th scope="col" class="manage-column column-date" style="width:200px;"><?php _e('Date', 'ultimatewoo-pro'); ?></th>
