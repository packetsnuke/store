...
<h3><?php _e('Notify me for Failed Subscription Payments', 'ultimatewoo-pro'); ?></h3>

<table class="form-table">
	<tr>
		<th><label for="subscription_failure_notification"><?php _e('Send Notification Email', 'ultimatewoo-pro'); ?></label></th>
		<td>
