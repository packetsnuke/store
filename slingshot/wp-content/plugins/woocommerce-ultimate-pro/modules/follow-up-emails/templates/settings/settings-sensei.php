...
?>
<h3><?php _e('Sensei Settings', 'ultimatewoo-pro'); ?></h3>
...
<table class="form-table">
	<tr>
		<th colspan="2">
			<label for="sensei_course_completed_email">
				...
				<?php _e('Send email to the course creator when all learners have taken and passed the course', 'ultimatewoo-pro'); ?>
			</label>
		</th>
	</tr>
	<tr class="sensei_course_completed_email_row">
		<th>
			<label for="sensei_course_completed_email_subject"><?php _e('Email Subject', 'ultimatewoo-pro'); ?></label>
		</th>
		<td>
	...
	<tr class="sensei_course_completed_email_row">
		<th>
			<label for="sensei_course_completed_email_body"><?php _e('Email Body', 'ultimatewoo-pro'); ?></label>
			<p>
				<?php _e('Email Variables', 'ultimatewoo-pro'); ?>
			</p>
			<dl>
				<dd>{course}</dd>
				<dd>{learners}</dd>
	...
	<tr>
		<th colspan="2">
			<label for="sensei_course_incomplete_email">
				...
				<?php _e('Send an email to the course creator when there are learners who haven\'t completed a course in ', 'ultimatewoo-pro'); ?>
			</label>
	...
	<tr class="sensei_course_incomplete_email_row">
		<th>
			<label for="sensei_course_incomplete_email_subject"><?php _e('Email Subject', 'ultimatewoo-pro'); ?></label>
		</th>
		<td>
	...
	<tr class="sensei_course_incomplete_email_row">
		<th>
			<label for="sensei_course_incomplete_email_body"><?php _e('Email Body', 'ultimatewoo-pro'); ?></label>
			<p>
				<?php _e('Email Variables', 'ultimatewoo-pro'); ?>
			</p>
			<dl>
