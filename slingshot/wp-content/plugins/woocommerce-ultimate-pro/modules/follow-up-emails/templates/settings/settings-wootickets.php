...
<h3><?php _e('Event Booking Notification', 'ultimatewoo-pro'); ?></h3>

<table class="form-table">
	<tr>
		<th><label for="event_booking_notification"><?php _e('Send Notification Email', 'ultimatewoo-pro'); ?></label></th>
		<td>
	...
	<tr class="wootickets">
		<th>
			<label for="event_booking_notification_emails">
				<?php _e('Email Address', 'ultimatewoo-pro'); ?>
			</label>
		</th>
		<td>
			...
			<span class="description"><?php _e('Comma-separated email addresses of recipients', 'ultimatewoo-pro'); ?></span>
		</td>
	</tr>
	<tr class="wootickets">
		<th><label for="event_booking_notification_schedule"><?php _e('Notification Schedule', 'ultimatewoo-pro'); ?></label></th>
		<td>
			<select name="event_booking_notification_schedule" id="event_booking_notification_schedule">
				<option value="instant" <?php selected( 'instant', get_option( 'fue_event_booking_notification_schedule', 'instant' ) ); ?>><?php _e('Send notification on every booking', 'ultimatewoo-pro'); ?></option>
				<option value="digest" <?php selected( 'digest', get_option( 'fue_event_booking_notification_schedule', 'instant' ) ); ?>><?php _e('Send notification once daily', 'ultimatewoo-pro'); ?></option>
			</select>
		</td>
	</tr>
	<tr valign="top" class="wootickets time">
		<th><label for="event_booking_notification_time_hour"><?php _e('Preferred Time', 'ultimatewoo-pro'); ?></label></th>
		<td>
			<?php
			$args = array(
