...
<div class="wrap">
	<h2><?php _e('Send Emails', 'ultimatewoo-pro'); ?></h2>
	...
	<p id="total-recipients-label">
		...
		if ( $data['schedule_email'] ) {
			$title = _n( 'Scheduling %d email', 'Scheduling %d emails', $recipients_count, 'ultimatewoo-pro' );
		} else {
			$title = _n( 'Sending %d email', 'Sending %d emails', $recipients_count, 'ultimatewoo-pro' );
		}
