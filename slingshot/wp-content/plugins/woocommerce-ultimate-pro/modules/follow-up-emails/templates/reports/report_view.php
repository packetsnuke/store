...
if ( empty($reports) ) {
	$report_name = sprintf(__('Email #%d', 'ultimatewoo-pro'), $id);
} else {
	$report = $reports[0];
...
<h4><?php _e('Quick Stats', 'ultimatewoo-pro'); ?></h4>
...
<ul class="reports-stats">
	<?php if ( empty( $country_data ) ): ?>
		<li style="text-align: center;"><strong><?php _e('No data', 'ultimatewoo-pro'); ?></strong></li>
	<?php
	else:
...
<table class="wp-list-table widefat fixed striped posts">
	<thead>
	<tr>
		<th scope="col" id="type" class="manage-column column-type" style=""><?php _e('Customer Name', 'ultimatewoo-pro'); ?></th>
		<th scope="col" id="user_email" class="manage-column column-user_email" style=""><?php _e('Email', 'ultimatewoo-pro'); ?></th>
