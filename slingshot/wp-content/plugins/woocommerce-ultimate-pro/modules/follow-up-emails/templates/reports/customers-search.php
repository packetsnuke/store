...
class FUE_Reports_Customers_Table extends WP_List_Table {
	...
	public function get_columns(){
		...
		$columns = array(
			'user'                  => __( 'Customer Name', 'ultimatewoo-pro' ),
			'is_customer'           => __( 'Purchased', 'ultimatewoo-pro' ),
			'is_subscriber'         => __( 'Mailing List', 'ultimatewoo-pro' ),
			'stats'                 => __( 'Email Stats', 'ultimatewoo-pro' ),
			'total_orders'          => __( 'Total Orders', 'ultimatewoo-pro' ),
			'last_order_date'       => __( 'Last Order Date', 'ultimatewoo-pro' ),
			'lifetime_value'        => __( 'Lifetime Value', 'ultimatewoo-pro' )
		);
...
<div class="wrap">
	<h2><?php _e('Customer Data Manager', 'ultimatewoo-pro'); ?></h2>
