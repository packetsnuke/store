<h2 class="nav-tab-wrapper woo-nav-tab-wrapper reports-overview-tabs">
	<a href="#opens" class="nav-tab nav-tab-active"><?php _e('Top Emails by Opens', 'ultimatewoo-pro'); ?></a>
	<a href="#clicks" class="nav-tab"><?php _e('Top Emails by Clicks', 'ultimatewoo-pro'); ?></a>
	<a href="#ctor" class="nav-tab"><?php _e('Top Emails by CTOR', 'ultimatewoo-pro'); ?></a>
</h2>
...
<h4><?php _e('Stats', 'ultimatewoo-pro'); ?></h4>
...
<ul class="reports-stats">
	<li>
		<div
			id="sent_gauge"
			class="gauge"
			data-title="<?php _e('Emails Sent', 'ultimatewoo-pro'); ?>"
	...
	<li>
		<div
			id="opens_gauge"
			class="gauge"
			data-title="<?php _e('Emails Opened', 'ultimatewoo-pro'); ?>"
	...
	<li>
		<div
			id="bounces_gauge"
			class="gauge"
			data-title="<?php _e('Bounces', 'ultimatewoo-pro'); ?>"
	...
	<li>
		<div
			id="clicks_gauge"
			class="gauge"
			data-title="<?php _e('Clicks', 'ultimatewoo-pro'); ?>"
	...
	<li>
		<div
			...
			class="gauge"
			data-title="<?php _e('Unsubscribes', 'ultimatewoo-pro'); ?>"
...
<ul class="reports-stats">
	...
	<li class="auto-width">
		...
		(<?php echo (empty( $country->user_country ) ) ? __('Unknown', 'ultimatewoo-pro') : $country->user_country; ?>)
	</li>
	<?php
		endforeach;
	endif;
...
<h3><?php _e('Emails', 'ultimatewoo-pro'); ?></h3>
	...
	<table class="wp-list-table widefat fixed striped posts">
		<thead>
			<tr>
				...
				<th scope="col" id="type" class="manage-column column-type" style=""><?php _e('Email Name', 'ultimatewoo-pro'); ?></th>
				<th scope="col" id="usage_count" class="manage-column column-usage_count" style=""><?php _e('Emails Sent', 'ultimatewoo-pro'); ?> <img class="help_tip" width="16" height="16" title="<?php _e('The number of individual emails sent using this follow-up email', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" /></th>
				<th scope="col" id="opened" class="manage-column column-opens" style=""><?php _e('Opens', 'ultimatewoo-pro'); ?> <img class="help_tip" width="16" height="16" title="<?php _e('The number of times the this specific follow-up emails has been opened', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" /></th>
				<th scope="col" id="clicked" class="manage-column column-clicks" style=""><?php _e('Clicks', 'ultimatewoo-pro'); ?> <img class="help_tip" width="16" height="16" title="<?php _e('The number of times links in this follow-up email have been clicked', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" /></th>
				<th scope="col" id="bounces" class="manage-column column-bounces" style=""><?php _e('Bounces', 'ultimatewoo-pro'); ?></th>
				<th scope="col" id="web_views" class="manage-column column-web-views" style=""><?php _e('Web Version Views', 'ultimatewoo-pro'); ?></th>
				<th scope="col" id="conversions" class="manage-column column-conversions" style=""><?php _e('Conversions', 'ultimatewoo-pro'); ?></th>
			</tr>
		</thead>
		<tbody id="the_list">
			<?php
			if (empty($email_reports)) {
				?>
				<tr scope="row">
					<th colspan="7"><?php _e('No reports available', 'ultimatewoo-pro'); ?></th>
				</tr><?php
			} else {
				foreach ($email_reports as $report) {
					...
					?><tr scope="row">
						...
						<td class="post-title column-title">
							...
							<a href="admin.php?page=followup-emails-reports&tab=reportview&eid=<?php echo urlencode($report->email_id); ?>"><?php _e('View Report', 'ultimatewoo-pro'); ?></a>
						</td>
