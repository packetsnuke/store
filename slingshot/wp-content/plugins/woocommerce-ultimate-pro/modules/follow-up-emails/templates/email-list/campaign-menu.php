...
<div class="subsubsub_section">
	<ul class="subsubsub">
		<li><?php _e('Filter by Campaign:', 'ultimatewoo-pro'); ?></li>
		<li>
			<a href="admin.php?page=followup-emails" class="<?php if (empty($_GET['campaign'])) echo 'current'; ?>"><?php _e('All', 'ultimatewoo-pro'); ?></a>
			<?php if ( $count > 0 ) echo '|'; ?>
		</li>
		<?php
