<div class="wrap">
	...
	<h2>
		<?php _e('Follow-Up Emails', 'ultimatewoo-pro'); ?>
		<a class="add-new-h2" href="post-new.php?post_type=follow_up_email"><?php _e('Create New Follow-Up', 'ultimatewoo-pro'); ?></a>
	</h2>
	...
	?>
		<form action="admin-post.php" method="post" id="update_priorities">
			...
			<p class="submit">
				...
				<input type="submit" name="update_priorities" value="<?php _e('Update Priorities', 'ultimatewoo-pro'); ?>" class="button-primary" />
			</p>
		</form>
	<?php
	endif;
