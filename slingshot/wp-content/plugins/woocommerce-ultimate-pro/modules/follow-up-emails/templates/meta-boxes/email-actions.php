			...
			?>
				...
				<div id="post-status-select" class="hide-if-js">
					...
					<select name='post_status' id='post_status'>
						<option<?php selected( in_array( $email->status, array( 'draft', 'auto-draft', FUE_Email::STATUS_ACTIVE ) ) ); ?> value='<?php esc_attr_e(FUE_Email::STATUS_ACTIVE); ?>'><?php _e('Active', 'ultimatewoo-pro') ?></option>
