<div class="options_group">
	...
	<p class="form-field">
		<label><?php _e('Sending Delay', 'ultimatewoo-pro'); ?></label>
	...
	<p class="form-field">
		<label><?php _e('Trigger', 'ultimatewoo-pro'); ?></label>
		...
		<span class="show-if-date interval_date_span hideable">
			...
			<select name="send_date_hour">
				<option value=""><?php _e('Hour', 'ultimatewoo-pro'); ?></option>
				<?php
				for ( $x = 1; $x <= 12; $x++ ):
			...
			<select name="send_date_minute">
				<option value=""><?php _e('Minute', 'ultimatewoo-pro'); ?></option>
				<?php
				for ( $x = 0; $x <= 55; $x+=5 ):
					?>
	...
	<p class="form-field hideable show-if-list_signup">
		<label><?php _e('List', 'ultimatewoo-pro'); ?></label>

		<?php
		$selected_list = (empty( $email->meta['list'] ) ) ? 'any' : $email->meta['list'];
		?>
		<select name="meta[list]">
			<option value="any" <?php selected( $selected_list, 'any' ); ?>><?php _e('Any list', 'ultimatewoo-pro'); ?></option>
	...
	<div id="trigger_conditions" class="hide-if-date non-signup">
		...
		<p>
			<a class="button button-primary btn-add-condition"><?php _e('Add Additional Rule', 'ultimatewoo-pro'); ?></a>
		</p>
	</div>
