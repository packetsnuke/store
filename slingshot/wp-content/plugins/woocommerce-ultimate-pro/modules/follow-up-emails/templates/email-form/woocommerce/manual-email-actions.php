...
<div class="send-type-category send-type-div">
	<select id="category_ids" name="category_ids[]" class="select2" multiple data-placeholder="<?php _e('Search for a category&hellip;', 'ultimatewoo-pro'); ?>" style="width: 600px;">
