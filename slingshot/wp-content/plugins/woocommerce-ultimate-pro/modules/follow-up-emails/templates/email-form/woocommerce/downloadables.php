<div class="options_group storewide non-signup hideable <?php do_action('fue_form_downloadables_class', $email); ?> downloadables_div">
	...
	<p class="form-field">
		<label for="downloadable_file"><?php _e('Downloadable Files', 'ultimatewoo-pro'); ?></label>
		...
		?>
		<select id="downloadable_file" name="meta[downloadable_file]" class="select2" data-placeholder="<?php _e('Select file&hellip;', 'ultimatewoo-pro'); ?>" style="width:400px;">
			<option></option>
