<div class="options_group storewide non-signup hideable <?php do_action('fue_form_coupons_class', $email); ?> coupons_div">
	...
	<p class="form-field">
		<label for="coupon_id"><?php _e('Coupon', 'ultimatewoo-pro'); ?></label>
		...
		<input
			...
			>
		<!--<select id="coupon_id" name="meta[coupon]" class="wc-coupon-search" data-placeholder="<?php _e('All coupons', 'ultimatewoo-pro'); ?>" data-multiple="false" style="width:400px;">
			<option value=""></option>
			<?php
