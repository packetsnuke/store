<div class="options_group wootickets-selector">
	...
	<p class="form-field hideable ticket_category_tr">
		<label for="ticket_category_id"><?php _e('Category', 'ultimatewoo-pro'); ?></label>

		<select id="ticket_category_id" name="ticket_category_id" class="select2" data-placeholder="<?php _e('Search for a category&hellip;', 'ultimatewoo-pro'); ?>">
	...
	<p class="form-field hideable ticket_event_category_tr">
		...
		?>
		<label for="ticket_event_category_id"><?php _e('Event Category', 'ultimatewoo-pro'); ?></label>

		<select
			id="ticket_event_category_id"
			name="ticket_event_category_id"
			class="select2"
			data-placeholder="<?php _e('Search for a category&hellip;', 'ultimatewoo-pro'); ?>"
			>
			<option value="0"><?php _e('Any Category', 'ultimatewoo-pro'); ?></option>
			<?php
