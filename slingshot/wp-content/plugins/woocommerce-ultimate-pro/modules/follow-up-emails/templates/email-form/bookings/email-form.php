<div class="options_group wc-bookings-selector">
	<p class="form-field">
		...
		<select name="meta[storewide_type]" id="storewide_type" class="">
			<option value="all" <?php selected( $storewide_type, 'all' ); ?>><?php _e('All products', 'ultimatewoo-pro'); ?></option>
			<option value="products" <?php selected( $storewide_type, 'products' ); ?>><?php _e('A specific product', 'ultimatewoo-pro'); ?></option>
