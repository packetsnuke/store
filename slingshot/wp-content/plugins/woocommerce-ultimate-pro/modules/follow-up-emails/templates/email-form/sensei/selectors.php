<div>
	<p class="form-field sensei sensei-courses">
		<label for="course_id"><?php _e('Enable for', 'ultimatewoo-pro'); ?></label>
		<input
			type="hidden"
			id="course_id"
	...
	<p class="form-field sensei sensei-lessons">
		<label for="lesson_id"><?php _e('Enable for', 'ultimatewoo-pro'); ?></label>
		<input
			type="hidden"
			id="lesson_id"
	...
	<p class="form-field sensei sensei-quizzes">
		<label for="quiz_id"><?php _e('Enable for', 'ultimatewoo-pro'); ?></label>
		<input
			type="hidden"
			id="quiz_id"
	...
	<p class="form-field sensei sensei-answers">
		<label for="question_id"><?php _e('Question', 'ultimatewoo-pro'); ?></label>
		<input
			type="hidden"
			id="question_id"
			...
			data-placeholder="<?php _e('Search for a question', 'ultimatewoo-pro'); ?>"
			value="<?php
			$question_name = '';
		...
		<label for="answer"><?php _e('Answer', 'ultimatewoo-pro'); ?></label>
