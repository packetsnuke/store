...
<p class="form-field show-if-booking-status">
	<label for="meta_bookings_last_status"><?php _e('Last Status', 'ultimatewoo-pro'); ?></label>
	<select name="meta[bookings_last_status]" id="meta_bookings_last_status">
		<option value="" <?php selected($last_status, ''); ?>><?php _e('Any status', 'ultimatewoo-pro'); ?></option>
	...
	<br/>
	<span class="description"><?php _e('Only send this email if the booking\'s last status matches the selected value', 'ultimatewoo-pro'); ?></span>
</p>