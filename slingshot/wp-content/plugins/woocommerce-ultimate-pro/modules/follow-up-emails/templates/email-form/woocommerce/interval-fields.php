...
<span class="show-if-total_purchases hide-if-date total_purchases_span hideable">
	<span class="description"><?php _e('is', 'ultimatewoo-pro'); ?></span>
	<select name="meta[total_purchases_mode]">
		<option value="equal to" <?php if (isset($email->meta['total_purchases_mode']) && $email->meta['total_purchases_mode'] == 'equal to') echo  'selected'; ?>><?php _e('equal to', 'ultimatewoo-pro'); ?></option>
		<option value="greater than" <?php if (isset($email->meta['total_purchases_mode']) && $email->meta['total_purchases_mode'] == 'greater than') echo  'selected'; ?>><?php _e('greater than', 'ultimatewoo-pro'); ?></option>
	</select>
...
<span class="show-if-total_orders hide-if-date total_orders_span hideable">
	...
	<select name="meta[total_orders_mode]">
		<option value="equal to" <?php if (isset($email->meta['total_orders_mode']) && $email->meta['total_orders_mode'] == 'equal to') echo  'selected'; ?>><?php _e('equal to', 'ultimatewoo-pro'); ?></option>
		<option value="greater than" <?php if (isset($email->meta['total_orders_mode']) && $email->meta['total_purchases_mode'] == 'greater than') echo  'selected'; ?>><?php _e('greater than', 'ultimatewoo-pro'); ?></option>
	</select>
