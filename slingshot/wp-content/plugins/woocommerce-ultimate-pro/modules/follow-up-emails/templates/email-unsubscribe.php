		...
		<div id="content" class="site-content" role="main">
			...
			<article class="page type-page status-publish hentry">
				<header class="entry-header">
					<h1 class="entry-title"><?php _e('Unsubscribe from Email List', 'ultimatewoo-pro'); ?></h1>
				</header>
				<?php
				$email = '';
				...
				<div class="fue-unsubscribe-form entry-content">
					<form action="" method="post">
						...
						<p>
							<label for="fue_email"><?php _e('Email Address:', 'ultimatewoo-pro'); ?></label>
							<br/>
						...
						<p>
							<label for="fue_unsubscribe_order">
								...
								<?php printf( __('Do not send me emails regarding <a href="%s">Order %s</a> again.', 'ultimatewoo-pro'), esc_url( $order_url ), $order->get_order_number() ); ?>
							</label>
						</p>
						<?php endif; ?>
						...
						<p>
							<label for="fue_unsubscribe_all">
								...
								<?php _e('Do not send me non-order emails again', 'ultimatewoo-pro'); ?>
							</label>
						</p>

						<?php do_action('fue_unsubscribe_form', $email); ?>
						<p>
							<input type="submit" name="fue_submit" id="fue_submit" value="<?php _e('Unsubscribe', 'ultimatewoo-pro'); ?>" />
						</p>
					</form>
				</div>
			</article>
