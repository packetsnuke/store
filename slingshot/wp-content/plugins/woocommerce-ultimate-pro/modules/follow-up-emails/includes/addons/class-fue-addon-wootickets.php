...
class FUE_Addon_Wootickets {
	...
	public function register_email_type( $types ) {
		$triggers = array(
			'before_tribe_event_starts' => __('before event starts', 'ultimatewoo-pro'),
			'after_tribe_event_ends'    => __('after event ends', 'ultimatewoo-pro')
		);
		...
		foreach ( $statuses as $i => $status ) {
			$triggers[ 'ticket_status_'. $status ] = sprintf(
				__('after ticket status: %s', 'ultimatewoo-pro'),
				$status
			);
		}

		$props = array(
			'label'                 => __('WooTickets', 'ultimatewoo-pro'),
			'singular_label'        => __('WooTickets', 'ultimatewoo-pro'),
			'triggers'              => $triggers,
	...
	public function manual_types() {
		?><option value="event_attendees"><?php _e('Event Attendees', 'ultimatewoo-pro'); ?></option><?php
	}
	...
	public function manual_type_actions() {
		...
		<div class="send-type-event-attendees send-type-div">
			...
			<select id="attendee_status" name="attendee_status">
				<option value="all"><?php _e('Send to all attendees', 'ultimatewoo-pro'); ?></option>
				<option value="checked_in"><?php _e('Send to checked in attendees', 'ultimatewoo-pro'); ?></option>
				<option value="not_checked_in"><?php _e('Send to attendees who have not yet checked in', 'ultimatewoo-pro'); ?></option>
			</select>
		</div>
	<?php
	}
	...
	public function add_variables( $email ) {
		...
		?>
			<li class="var hideable var_events_calendar var_event_name">
				...
				<img
					class="help_tip"
					title="<?php _e('The name of the event', 'ultimatewoo-pro'); ?>"
			...
			<li class="var hideable var_events_calendar var_event_link">
				...
				<img
					class="help_tip"
					title="<?php _e('The name of the event with a link to the event page', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16"
					/>
			...
			<li class="var hideable var_events_calendar var_event_url">
				...
				<img
					class="help_tip"
					title="<?php _e('The URL of the event', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_location">
				...
				<img
					class="help_tip"
					title="<?php _e('The name and address of the venue', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_organizer">
				...
				<img
					class="help_tip"
					title="<?php _e('The name of the event organizer', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_start_datetime">
				...
				<img
					class="help_tip"
					title="<?php _e('The start date/time of the event', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_end_datetime">
				...
				<img
					class="help_tip"
					title="<?php _e('The end date/time of the event', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_venue_phone">
				...
				<img
					class="help_tip"
					title="<?php _e('The phone number of the event venue', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_gcal">
				...
				<img
					class="help_tip"
					title="<?php _e('The URL to the Google Calendar linked to the even', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_ical">
				...
				<img
					class="help_tip"
					title="<?php _e('The URL to the iCalendar linked to the event', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_ticket_sale_start">
				...
				<img
					class="help_tip"
					title="<?php _e('The date/time that tickets go on sale', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
			<li class="var hideable var_events_calendar var_event_ticket_sale_end">
				...
				<img
					class="help_tip"
					title="<?php _e('The date/time that ticket sales end', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16"
					/>
			...
			<li class="var hideable var_events_calendar var_event_ticket_name">
				...
				<img
					class="help_tip"
					title="<?php _e('The name of the ticket', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16"
					/>
			...
			<li class="var hideable var_events_calendar var_event_ticket_image">
				...
				<img
					class="help_tip"
					title="<?php _e('The image assigned to the ticket', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16"
					/>
			...
			<li class="var hideable var_events_calendar var_event_ticket_description">
				...
				<img
					class="help_tip"
					title="<?php _e('The description of the ticket', 'ultimatewoo-pro'); ?>"
					src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
					width="16"
					height="16" />
			</li>
	...
	public function send_email_digest() {
		...
		$subject        = sprintf( __('Event Bookings for %s', 'ultimatewoo-pro'), $current_date );
	...
	public function attendees_table_script() {
		...
		<script type="text/html" id="list_template_top">
			<select name="fue_list" id="fue_list" class="fue_list" style="display: none;">
				<option value="-1"><?php _e('New List', 'ultimatewoo-pro'); ?></option>
	...
	public function add_bulk_actions( $actions ) {
		$actions['fue_list_import'] = esc_attr('Add to email list', 'ultimatewoo-pro');
	...
	public function send_event_booking_notification( $order_id ) {
		...
		if ( $post->post_type == 'shop_order' ) {
			...
			$subject        = __('New Event Booking', 'ultimatewoo-pro');
			$message        = WC()->mailer()->wrap_message( $subject, $message );
			$wc_email       = new WC_Email();
			$message        = $wc_email->style_inline( $message );
