...
class FUE_Addon_Twitter {
	...
	public function register_addon( $addons ) {
		$addons['twitter'] = array(
			...
			'settings'      => true,
			'url'           => '#',
			'description'   => __('Collect @twitter usernames from your customers and create followups that tweet messages to your customers.', 'ultimatewoo-pro')
		);
	...
	public function register_email_types( $types ) {
		...
		$props = array(
			'priority'              => 10,
			'label'                 => __('Twitter Messages', 'ultimatewoo-pro'),
			'singular_label'        => __('Twitter Message', 'ultimatewoo-pro'),
			'triggers'              => $triggers,
			'durations'             => Follow_Up_Emails::$durations,
			'long_description'      => __('Collect @twitter usernames from your customers and create followups that tweet messages to your customers.', 'ultimatewoo-pro'),
			'short_description'     => __('Collect @twitter usernames from your customers and create followups that tweet messages to your customers.', 'ultimatewoo-pro'),
