...
class FUE_Addon_Points_And_Rewards {
	...
	public function register_email_type( $types ) {
		...
		$props = array(
			'label'                 => __('Points and Rewards Emails', 'ultimatewoo-pro'),
			'singular_label'        => __('Points and Rewards Email', 'ultimatewoo-pro'),
			'triggers'              => $triggers,
			'durations'             => Follow_Up_Emails::$durations,
			'long_description'      => __('Points and Rewards emails will send to a user based upon the point earnings status you define when creating your emails.', 'ultimatewoo-pro'),
			'short_description'     => __('Points and Rewards emails will send to a user based upon the point earnings status you define when creating your emails.', 'ultimatewoo-pro')
		);
	...
	public function manual_types() {
		$options = array(
			'points_rewards_over'   => __('Points &amp; Rewards: Customers that have over N points', 'ultimatewoo-pro'),
			'points_rewards_under'  => __('Points &amp; Rewards: Customers that have under N points', 'ultimatewoo-pro')
		);
