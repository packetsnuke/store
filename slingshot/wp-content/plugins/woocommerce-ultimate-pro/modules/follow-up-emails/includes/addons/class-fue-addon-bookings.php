...
class FUE_Addon_Bookings {
	...
	public function register_email_type( $types ) {
		$triggers = array(
			'before_booking_event'      => __( 'Before Booked Date', 'ultimatewoo-pro' ),
			'after_booking_event'       => __( 'After Booked Date', 'ultimatewoo-pro' ),
			'booking_created'           => __( 'After Booking is Created', 'ultimatewoo-pro' )
		);

		// add booking statuses
		foreach ( self::$statuses as $status ) {
			$triggers['booking_status_'. $status] = sprintf( __( 'After Booking Status: %s', 'ultimatewoo-pro' ), $status );
		}

		$props = array(
			'label'                 => __('WooCommerce Bookings', 'ultimatewoo-pro'),
			'singular_label'        => __('WooCommerce Booking', 'ultimatewoo-pro'),
			'triggers'              => $triggers,
			'durations'             => Follow_Up_Emails::$durations,
			'long_description'      => __('Send follow-up emails to customers that book appointments, services or rentals.', 'ultimatewoo-pro'),
			'short_description'     => __('Send follow-up emails to customers that book appointments, services or rentals.', 'ultimatewoo-pro')
		);
	...
	public function manual_types() {
		?><option value="booked_event"><?php _e('Customers who booked this event', 'ultimatewoo-pro'); ?></option><?php
	}
	...
	public function email_variables_list( $email ) {
		...
		?>
		<li class="var hideable var_wc_bookings"><strong>{item_name}</strong> <img class="help_tip" title="<?php _e('The name of the purchased item.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{item_category}</strong> <img class="help_tip" title="<?php _e('The list of categories where the purchased item is under.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings var_wc_bookings_item_quantity"><strong>{item_quantity}</strong> <img class="help_tip" title="<?php _e('The quantity of the purchased item.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_start}</strong> <img class="help_tip" title="<?php _e('The start date of the booked product or service', 'ultimatewoo-pro'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_end}</strong> <img class="help_tip" title="<?php _e('The end date of the booked product or service', 'ultimatewoo-pro'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_duration}</strong> <img class="help_tip" title="<?php _e('The duration of the booked product or service', 'ultimatewoo-pro'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_date}</strong> <img class="help_tip" title="<?php _e('The date of the booked product or service', 'ultimatewoo-pro'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_time}</strong> <img class="help_tip" title="<?php _e('The time of the booked product or service', 'ultimatewoo-pro'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_amount}</strong> <img class="help_tip" title="<?php _e('The amount or cost of the booked product or service', 'ultimatewoo-pro'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_resource}</strong> <img class="help_tip" title="<?php _e('The resource booked', 'ultimatewoo-pro'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_wc_bookings"><strong>{booking_persons}</strong> <img class="help_tip" title="<?php _e( 'The list of persons with counts for this booking', 'ultimatewoo-pro' ); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
	<?php
	}
	...
	protected function add_variable_replacements( $variables, $email_data, $queue_item, $email ) {
		if ( $queue_item->order_id || $queue_item->product_id ) {
			...
			if ( $booking->get_persons_total() > 0 ) {
				...
				$persons_html = '<p><strong>' . esc_html( __( 'No. of persons', 'ultimatewoo-pro' ) ) . '</strong><br /><ul>';
		...
		foreach ( $emails as $email ) {
			...
			if ( !is_wp_error( FUE_Sending_Scheduler::queue_email( $insert, $email ) ) ) {
				...
				if ( $order ) {
					...
					$note = sprintf(
						__('Email queued: %s scheduled on %s<br/>Trigger: %s', 'ultimatewoo-pro'),
						$email->name,
						$send_date,
						$email_trigger
					);
