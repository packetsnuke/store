...
class FUE_Addon_Sensei {
	...
	public function register_email_type( $types ) {
		$triggers = array(
			'specific_answer'       => __('after selecting a specific answer', 'ultimatewoo-pro'),
			'course_signup'         => __('after signed up to a course', 'ultimatewoo-pro'),
			'course_completed'      => __('after course is completed', 'ultimatewoo-pro'),
			'lesson_start'          => __('after lesson is started', 'ultimatewoo-pro'),
			'lesson_completed'      => __('after lesson is completed', 'ultimatewoo-pro'),
			'quiz_completed'        => __('after completing a quiz', 'ultimatewoo-pro'),
			'quiz_passed'           => __('after passing a quiz', 'ultimatewoo-pro'),
			'quiz_failed'           => __('after failing a quiz', 'ultimatewoo-pro'),
			'lesson_added'          => __('after lesson added', 'ultimatewoo-pro')
		);

		$props = array(
			'label'                 => __('Sensei Emails', 'ultimatewoo-pro'),
			'singular_label'        => __('Sensei Email', 'ultimatewoo-pro'),
			'supports'              => array('conditions'),
			'triggers'              => $triggers,
			'durations'             => Follow_Up_Emails::$durations,
			'long_description'      => __('Create emails to send based upon the quiz/course/lesson/test status you define for Sensei.', 'ultimatewoo-pro'),
			'short_description'     => __('Create emails to send based upon the quiz/course/lesson/test status you define for Sensei.', 'ultimatewoo-pro')
		);
	...
	public function send_crm_course_completed_email( $user_id, $course_id ) {
		...
		$queue->email_trigger   = __('Sensei CRM: Course Completed', 'ultimatewoo-pro');
	...
	public function schedule_crm_course_incomplete_email( $user_id, $course_id ) {
		...
		$queue = new FUE_Sending_Queue_Item();
		$queue->email_trigger   = __('Sensei CRM: Course Incomplete', 'ultimatewoo-pro');
		$queue->user_id         = $course->post_author;
		$queue->user_email      = $creator->user_email;
		$queue->is_sent         = 0;
	...
	public function email_variables_list( $email ) {
		...
		?>
		<li class="var hideable var_sensei var_sensei_course"><strong>{teacher_first_name}</strong> <img class="help_tip" title="<?php _e('The Teacher\'s first name', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_course"><strong>{teacher_last_name}</strong> <img class="help_tip" title="<?php _e('The Teacher\'s last name', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_course"><strong>{teacher_name}</strong> <img class="help_tip" title="<?php _e('The Teacher\'s full name', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_course"><strong>{course_name}</strong> <img class="help_tip" title="<?php _e('The name of the course', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_course"><strong>{course_url}</strong> <img class="help_tip" title="<?php _e('The raw URL to the course', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_course"><strong>{course_link}</strong> <img class="help_tip" title="<?php _e('The link to the course with the course name as the display text', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_course"><strong>{course_results_url}</strong> <img class="help_tip" title="<?php _e('The URL to the course results page', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>

		<?php if ( self::is_certificates_installed() ): ?>
			<li class="var hideable var_sensei var_sensei_course"><strong>{certificate_url}</strong> <img class="help_tip" title="<?php _e('The raw URL to the course certificate', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
			<li class="var hideable var_sensei var_sensei_course"><strong>{certificate_link}</strong> <img class="help_tip" title="<?php _e('The link to the course certificate with the course name as the display text', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<?php endif; ?>

		<li class="var hideable var_sensei var_sensei_lesson"><strong>{lesson_name}</strong> <img class="help_tip" title="<?php _e('The name of the lesson', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_lesson"><strong>{lesson_url}</strong> <img class="help_tip" title="<?php _e('The raw URL to the lesson', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_lesson"><strong>{lesson_link}</strong> <img class="help_tip" title="<?php _e('The link to the lesson with the lesson name as the display text', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>

		<li class="var hideable var_sensei var_sensei_quiz"><strong>{quiz_url}</strong> <img class="help_tip" title="<?php _e('The raw URL to the quiz', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_quiz"><strong>{quiz_link}</strong> <img class="help_tip" title="<?php _e('The link to the quiz', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_quiz var_sensei_grade"><strong>{quiz_grade}</strong> <img class="help_tip" title="<?php _e('The score the user got on the quiz', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_sensei var_sensei_quiz var_sensei_passmark"><strong>{quiz_passmark}</strong> <img class="help_tip" title="<?php _e('The passing mark on the quiz taken', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
		<?php
	}
	...
	public function manual_types() {
		$options = array(
			'course' => __('Customers who have signed up for these courses', 'ultimatewoo-pro')
		);
