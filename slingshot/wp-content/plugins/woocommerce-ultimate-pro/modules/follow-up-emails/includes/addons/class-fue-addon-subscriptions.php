...
class FUE_Addon_Subscriptions extends FUE_Addon_Woocommerce_Scheduler {
	...
	public function update_notice() {
		...
		if ( get_option( 'fue_subscription_needs_update' ) == 1 ) {
			...
			<div id="message" class="updated">
				<p><?php _e( '<strong>Follow-Ups Data Update Required</strong>', 'ultimatewoo-pro' ); ?></p>
				<p class="submit"><a href="<?php echo add_query_arg( 'tab', 'subscription_update', admin_url( 'admin.php?page=followup-emails' ) ); ?>" class="fue-update-now button-primary"><?php _e( 'Run the updater', 'ultimatewoo-pro' ); ?></a></p>
			</div>
			<script type="text/javascript">
				jQuery('.fue-update-now').click('click', function(){
					var answer = confirm( '<?php _e( 'It is strongly recommended that you backup your database before proceeding. Are you sure you wish to run the updater now?', 'ultimatewoo-pro' ); ?>' );
					return answer;
				});
			</script>
		<?php
	...
	public function register_email_type( $types ) {
		...
		$triggers = array(
			'subs_activated'        => __('after subscription activated', 'ultimatewoo-pro'),
			'subs_renewed'          => __('after subscription renewed', 'ultimatewoo-pro'),
			'subs_cancelled'        => __('after subscription cancelled', 'ultimatewoo-pro'),
			'subs_pending_cancel'   => __('after subscription pending cancellation', 'ultimatewoo-pro'),
			'subs_expired'          => __('after subscription expired', 'ultimatewoo-pro'),
			'subs_suspended'        => __('after subscription suspended', 'ultimatewoo-pro'),
			'subs_reactivated'      => __('after subscription reactivated', 'ultimatewoo-pro'),
			'subs_payment_failed'   => __('after subscription payment failed', 'ultimatewoo-pro'),
			'subs_renewal_order'    => __('after a renewal order has been created', 'ultimatewoo-pro'),
			'subs_before_renewal'   => __('before next subscription payment', 'ultimatewoo-pro'),
			'subs_before_expire'    => __('before active subscription expires', 'ultimatewoo-pro'),
		);

		$props = array(
			'label'                 => __('Subscription Emails', 'ultimatewoo-pro'),
			'singular_label'        => __('Subscription Email', 'ultimatewoo-pro'),
			'triggers'              => $triggers,
			'durations'             => Follow_Up_Emails::$durations,
			'long_description'      => __('Create emails to send to a user based upon the subscription statuses of your customers.', 'ultimatewoo-pro'),
			'short_description'     => __('Create emails to send to a user based upon the subscription statuses of your customers.', 'ultimatewoo-pro'),
	...
	public function manual_types() {
		?><option value="active_subscription"><?php _e('Customers with an active subscription', 'ultimatewoo-pro'); ?></option><?php
	}
	...
	public function email_variables_list( $email ) {
		...
		if ( $email->product_id > 0 ): ?>
			<li class="var hideable var_subscriptions"><strong>{item_name}</strong> <img class="help_tip" title="<?php _e('The subscription product\'s name', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
			...
			<li class="var hideable var_subscriptions"><strong>{item_categories}</strong> <img class="help_tip" title="<?php _e('The list of categories where the purchased items are under.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
		<?php else: ?>
			<li class="var hideable var_subscriptions"><strong>{item_names}</strong> <img class="help_tip" title="<?php _e('Displays a list of purchased items.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
			<li class="var hideable var_subscriptions"><strong>{item_names_list}</strong> <img class="help_tip" title="<?php _e('Displays a comma-separated list of purchased items.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
			<li class="var hideable var_subscriptions"><strong>{item_categories}</strong> <img class="help_tip" title="<?php _e('The list of categories where the purchased items are under.', 'ultimatewoo-pro'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
		<?php endif; ?>
		<li class="var hideable var_subscriptions"><strong>{subs_renew_date}</strong> <img class="help_tip" title="<?php _e('The date that a customer\'s subscription renews', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{subs_end_date}</strong> <img class="help_tip" title="<?php _e('The date that a customer\'s subscription ends', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{days_to_renew}</strong> <img class="help_tip" title="<?php _e('The number of days before a subscription is up for renewal', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{subs_start_date}</strong> <img class="help_tip" title="<?php _e('The start date of the subscription', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{subs_trial_length}</strong> <img class="help_tip" title="<?php _e('The length of the trial (e.g. 20 days)', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{subs_first_payment}</strong> <img class="help_tip" title="<?php _e('The initial cost + any signup fees', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{subs_cost_term}</strong> <img class="help_tip" title="<?php _e('The cost and term of the subscription', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{subs_cost}</strong> <img class="help_tip" title="<?php _e('The cost of the subscription', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<li class="var hideable var_subscriptions"><strong>{subs_id}</strong> <img class="help_tip" title="<?php _e('The ID of the subscription', 'ultimatewoo-pro'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
		<?php
	}
	...
	protected function add_test_variable_replacements( $variables, $email_data, $email ) {
		...
		if ( $email_data['order_id'] > 0 ) {
			...
			if ( WC_Subscriptions_Order::order_contains_subscription( $order ) ) {
				...
				if ( $end_date == 0 ) {
					$variables['subs_end_date'] = __('Until Cancelled', 'ultimatewoo-pro');
				} else {
	...
	public function email_replacements( $reps, $email_data, $email_order, $email_row ) {
		...
		if ( $email_order->order_id ) {
			...
			if ( $end_date == 0 ) {
				$end_date = __('Until Cancelled', 'ultimatewoo-pro');
			} else {
	...
	public static function get_subscription_meta( $subs_key ) {
		...
		if ( $data['end_date'] == 0 ) {
			$data['end_date'] = __('Until cancelled', 'ultimatewoo-pro');
		} else {
