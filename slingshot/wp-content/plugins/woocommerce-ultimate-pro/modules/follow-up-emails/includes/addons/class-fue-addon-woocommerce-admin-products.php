...
class FUE_Addon_Woocommerce_Admin_Products {
	...
	public function add_product_data_tab( $tabs ) {
		$tabs['follow-ups'] = array(
			'label'  => __( 'Follow-ups', 'ultimatewoo-pro' ),
	...
	public function add_product_data_panel() {
		...
		<div id="follow_ups_product_data" class="panel woocommerce_options_panel">
			...
			<div class="options_group">
				<p><?php _e('Add purchaser of this product to the following list(s)', 'ultimatewoo-pro'); ?></p>
			...
			<div class="options_group">
				<p class="form-field">
					<label for="new_fue_list"><?php _e('New List', 'ultimatewoo-pro'); ?></label>
					<input type="text" class="short" id="new_fue_list" style="width: 40%;" />
					<input type="button" id="add_new_fue_list" class="button add-new-fue-list" value="<?php _e('Add', 'ultimatewoo-pro'); ?>" />
				</p>
			</div>
