...
class FUE_Subscribers_List_Table extends WP_List_Table {
	...
	public function get_columns() {
		return array(
			...
			'email'      => __( 'Email Address', 'ultimatewoo-pro' ),
			'lists'      => __( 'Subscriptions', 'ultimatewoo-pro' ),
			'name'       => __( 'Full name', 'ultimatewoo-pro' ),
			'date_added' => __( 'Signup Date/Time', 'ultimatewoo-pro' ),
		);
	}
	...
	protected function get_bulk_actions() {
		return array(
			'move'      => __( 'Move subscriber to existing list', 'ultimatewoo-pro' ),
			'new'       => __( 'Create new list and move subscriber', 'ultimatewoo-pro' ),
			'delete'    => __( 'Remove subscriber and email address', 'ultimatewoo-pro' )
		);
	}
	...
	public function display() {
		...
		<form method="get" id="subscribers_list_form">
			...
			<?php
			$this->search_box( __('Search', 'ultimatewoo-pro'), 'subscribers' );
			...
			<div id="div_lists" style="display:none;">
				<select name="list[]" id="select_lists" class="select2" multiple style="width: 300px; clear: both;" data-placeholder="<?php _e('Select lists', 'ultimatewoo-pro'); ?>">
					<option></option>
					<?php foreach ( $this->newsletter->get_lists() as $list ): ?>
