...
class FUE_Reports {
	...
	public function menu() {
		add_submenu_page( 'followup-emails', __('Reports', 'ultimatewoo-pro'), __('Reports', 'ultimatewoo-pro'), 'manage_follow_up_emails', 'followup-emails-reports', 'FUE_Reports::settings_main' );
		add_submenu_page( 'followup-emails', __('Customers', 'ultimatewoo-pro'), __('Customers', 'ultimatewoo-pro'), 'manage_follow_up_emails', 'followup-emails-reports-customers', 'FUE_Reports::customers_search' );
	}
	...
	public function user_profile_script() {
		...
		wp_localize_script( 'fue-user-report-link', 'FUE_USER_REPORT', array(
			...
			'reports_title' => __('Customer Data', 'ultimatewoo-pro'),
	...
	static function reports_html() {
		...
		$cols = array(
			__('Email', 'ultimatewoo-pro'),
			__('Sent', 'ultimatewoo-pro'),
			__('Opens', 'ultimatewoo-pro'),
			__('Clicks', 'ultimatewoo-pro')
		);
	...
	public static function send_summary() {
		// send the email
		$subject    = __('Follow-up emails summary', 'ultimatewoo-pro');
	...
	public static function get_summary_email_html() {
		...
		$body = '<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
					<thead>
						<tr>
							<th scope="col" style="text-align:left; border: 1px solid #eee;">'. __('Email Name', 'ultimatewoo-pro') .'</th>
							<th scope="col" style="text-align:left; border: 1px solid #eee;">'. __('Email Address', 'ultimatewoo-pro') .'</th>
							<th scope="col" style="text-align:left; border: 1px solid #eee;">'. __('Product', 'ultimatewoo-pro') .'</th>
							<th scope="col" style="text-align:left; border: 1px solid #eee;">'. __('Order', 'ultimatewoo-pro') .'</th>
							<th scope="col" style="text-align:left; border: 1px solid #eee;">'. __('Trigger', 'ultimatewoo-pro') .'</th>
							<th scope="col" style="text-align:left; border: 1px solid #eee;">'. __('Sent Coupon', 'ultimatewoo-pro') .'</th>
						</tr>
					</thead>
					<tbody>
						'. $reports .'
	...
	public static function queue() {
		...
		<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
			<a href="admin.php?page=followup-emails&amp;tab=history" class="nav-tab"><?php _e('Emails History', 'ultimatewoo-pro'); ?></a>
			<a href="admin.php?page=followup-emails-reports&amp;tab=dbg_queue" class="nav-tab nav-tab-active"><?php _e('Queue', 'ultimatewoo-pro'); ?></a>
		</h2>
		...
		<?php if (! $items ): ?>
			<p><?php _e('No items in the queue', 'ultimatewoo-pro'); ?></p>
		<?php
		else:
	...
	public static function reports_header($tab) {
		...
		<h2>
		<?php _e('Follow-Up Emails &raquo; Email Reports', 'ultimatewoo-pro'); ?>
		</h2><?php

		if ( isset($_GET['cleared']) ) {
			echo '<div class="updated"><p>'. __('The selected reports have been deleted', 'ultimatewoo-pro') .'</p></div>';
		}
	}
