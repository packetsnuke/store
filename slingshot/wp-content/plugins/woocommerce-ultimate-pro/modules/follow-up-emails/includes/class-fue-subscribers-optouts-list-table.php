...
class FUE_Subscribers_Optouts_List_Table extends WP_List_Table {
	...
	public function get_columns() {
		return array(
			...
			'date_added'        => __('Date', 'ultimatewoo-pro')
		);
	}
	...
	protected function get_bulk_actions() {
		return array(
			'restore'   => __( 'Remove from Opt-Out List', 'ultimatewoo-pro' )
		);
	}
	...
	public function column_email( $item ) {
		...
		$actions = array(
			'trash' => '<a class="submitdelete" title="' . esc_attr( __( 'Delete', 'ultimatewoo-pro' ) ) . '" href="'. $delete_url .'">' . __( 'Delete', 'ultimatewoo-pro' ) . '</a>'
		);
	...
	public function display() {
		...
		<form method="get" id="subscribers_optout_form">
			...
			<?php
			$this->search_box( __('Search', 'ultimatewoo-pro'), 'optout' );
