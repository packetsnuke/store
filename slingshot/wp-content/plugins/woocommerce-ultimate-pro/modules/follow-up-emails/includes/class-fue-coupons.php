...
class FUE_Coupons {
	...
	public function menu() {
		add_submenu_page( 'followup-emails', __( 'Coupons', 'ultimatewoo-pro' ), __( 'Coupons', 'ultimatewoo-pro' ), 'manage_follow_up_emails', 'followup-emails-coupons', 'FUE_Coupons::settings_main' );
	}
