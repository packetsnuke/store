...
class FUE_Install {
	...
	public function install_notice() {
		...
		if ( get_option( 'fue_needs_update' ) == 1 ) {
			...
			<div id="message" class="updated">
				<p><?php _e( '<strong>Follow-Up Emails Data Update Required</strong>', 'ultimatewoo-pro' ); ?></p>
				<p class="submit"><a href="<?php echo add_query_arg( 'fue_update', 'true', admin_url( 'admin.php?page=followup-emails' ) ); ?>" class="fue-update-now button-primary"><?php _e( 'Run the updater', 'ultimatewoo-pro' ); ?></a></p>
			</div>
	...
	public function create_role() {
		...
		add_role( 'fue_manager', __('Follow-Up Emails Manager', 'ultimatewoo-pro'), array(
			'level_9'                => true,
			'level_8'                => true,
			'level_7'                => true,
			'level_6'                => true,
