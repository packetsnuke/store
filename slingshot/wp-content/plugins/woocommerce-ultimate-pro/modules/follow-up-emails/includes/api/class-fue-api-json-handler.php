	...
	public function generate_response( $data ) {
		...
		if ( isset( $_GET['_jsonp'] ) ) {
			...
			if ( ! apply_filters( 'fue_api_jsonp_enabled', true ) ) {
				...
				$data = array( array( 'code' => 'fue_api_jsonp_disabled', 'message' => __( 'JSONP support is disabled on this site', 'ultimatewoo-pro' ) ) );
			}
			...
			if ( preg_match( '/\W/', $_GET['_jsonp'] ) ) {
				...
				$data = array( array( 'code' => 'fue_api_jsonp_callback_invalid', __( 'The JSONP callback function is invalid', 'ultimatewoo-pro' ) ) );
			}
