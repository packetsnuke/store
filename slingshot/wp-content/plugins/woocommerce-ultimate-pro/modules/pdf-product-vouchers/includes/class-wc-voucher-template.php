...
class WC_Voucher_Template extends WC_Voucher_Base {
	...
	public static function get_voucher_fields() {
		...
		$fields = array(
			...
			'logo' => array(
				'data_type' => 'property',
				'label'     => __( 'Logo', 'ultimatewoo-pro' ),
			),

			'product_name' => array(
				'data_type' => 'property',
				'label'     => __( 'Product Name', 'ultimatewoo-pro' ),
			),

			'product_sku' => array(
				'data_type' => 'property',
				'label'     => __( 'Product SKU', 'ultimatewoo-pro' ),
			),

			'product_price' => array(
				'data_type' => 'property',
				'label'     => __( 'Product Price', 'ultimatewoo-pro' ),
			),

			'product_quantity' => array(
				'data_type' => 'property',
				'label'     => __( 'Product Quantity', 'ultimatewoo-pro' ),
			),

			'voucher_number' => array(
				'data_type' => 'property',
				'label'     => __( 'Voucher Number', 'ultimatewoo-pro' ),
			),

			'expiration_date' => array(
				'data_type' => 'property',
				'label'     => __( 'Expiration Date', 'ultimatewoo-pro' ),
			),

			'purchaser_name' => array(
				'data_type' => 'user_input',
				'type'      => 'text',
				'label'     => __( 'Purchaser Name', 'ultimatewoo-pro' ),
			),

			'recipient_name' => array(
				'data_type' => 'user_input',
				'type'      => 'text',
				'label'     => __( 'Recipient Name', 'ultimatewoo-pro' ),
			),

			'recipient_email' => array(
				'data_type' => 'user_input',
				'type'      => 'email',
				'label'     => __( 'Recipient Email', 'ultimatewoo-pro' ),
			),

			'message' => array(
				'data_type' => 'user_input',
				'type'      => 'textarea',
				'label'     => __( 'Message', 'ultimatewoo-pro' ),
			),
		);
	...
	public static function get_voucher_field_default_controls( $data_type = 'property' ) {
		...
		$controls = array(
			'pos' => array(
				...
				'label' => __( 'Position', 'ultimatewoo-pro' ),
			),

			'font_family' => array(
				'type'    => 'select',
				'label'   => __( 'Font', 'ultimatewoo-pro' ),
			...
			'font_settings' => array(
				...
				'label'    => __( 'Font Style', 'ultimatewoo-pro' ),
				'settings' => array(
					'font_style_b',
					'font_style_i',
					'text_align',
			...
			'font_color' => array(
				'type'    => 'color',
				'label'   => __( 'Font Color', 'ultimatewoo-pro' ),
			),
		);
		...
		if ( 'user_input' === $data_type )	{
			...
			$controls = array_merge( $controls, array(
				...
				'label' => array(
					...
					'description' => __( 'The field label to show on the frontend/emails', 'ultimatewoo-pro' ),
				),

				'max_length' => array(
					'type'        => 'number',
					'label'       => __( 'Max Length', 'ultimatewoo-pro' ),
					'description' => __( 'The maximum number of characters of the field', 'ultimatewoo-pro' ),
					'input_attrs' => array(
						'min'   => 1,
						'step'  => 1,
						'placeholder' => __( 'No limit', 'ultimatewoo-pro' ),
					),
				),

				'is_enabled' => array(
					'type'        => 'checkbox',
					'label'       => __( 'Enabled', 'ultimatewoo-pro' ),
					'description' => __( 'Display this field on the product page', 'ultimatewoo-pro' ),
				),

				'is_required' => array(
					'type'        => 'checkbox',
					'label'       => __( 'Required', 'ultimatewoo-pro' ),
					'description' => __( 'Make this field required in order to add a voucher product to the cart', 'ultimatewoo-pro' ),
				),
			) );
		}
	...
	public static function get_voucher_field_controls( $field_id, $attrs ) {
		...
		elseif ( 'expiration_date' === $field_id ) {
			$controls['days_to_expiry'] = array(
				'type'        => 'number',
				'label'       => __( 'Days to expiration', 'ultimatewoo-pro' ),
				'description' => __( 'Optional number of days after purchase until the voucher expires', 'ultimatewoo-pro' ),
				'input_attrs' => array(
					'min'         => 0,
					'step'        => 1,
					'placeholder' => __( 'days', 'ultimatewoo-pro' ),
				),
			);
		}
		...
		elseif ( 'product_quantity' === $field_id ) {
			$controls['amount'] = array(
				'type'        => 'number',
				'label'       => __( 'Amount', 'ultimatewoo-pro' ),
				'description' => __( 'Number of products/tickets/passess this voucher is eligible for', 'ultimatewoo-pro' ),
				'input_attrs' => array(
					'min'         => 1,
					'step'        => 1,
				),
		...
		elseif ( 'logo' === $field_id ) {
			$controls = array(
				'image_id' => array(
					'type'          => 'image',
					'label'         => __( 'Logo', 'ultimatewoo-pro' ),
					'description'   => __( 'Optional image that can be displayed as a logo on the voucher.', 'ultimatewoo-pro' ),
					'button_labels' => array(
						'select'       => __( 'Select image', 'ultimatewoo-pro' ),
						'change'       => __( 'Change image', 'ultimatewoo-pro' ),
						'remove'       => __( 'Remove', 'ultimatewoo-pro' ),
						'default'      => __( 'Default', 'ultimatewoo-pro' ),
						'placeholder'  => __( 'No image selected', 'ultimatewoo-pro' ),
						'frame_title'  => __( 'Select voucher logo', 'ultimatewoo-pro' ),
						'frame_button' => __( 'Choose image', 'ultimatewoo-pro' ),
					),
				),
				'pos' => array(
					'type'  => 'wc_pdf_product_vouchers_position',
	...
	private static function get_voucher_font_family_options( $include_default = true ) {
		...
		if ( $include_default ) {
			$options = array( '' => __( '(Default)', 'ultimatewoo-pro' ) ) + $options;
		}
