	...
	public function enqueue() {
		...
		wp_localize_script( 'customize-views', '_wpCustomizeHeader', array(
			...
			'_pdf_vouchers' => array(
				...
				'i18n' => array(
					'default_images_title' => __( 'Default Images', 'ultimatewoo-pro' ),
				),
			),
		) );
	...
	public function print_voucher_image_template() {
		...
		<script type="text/template" id="tmpl-header-choice">
			...
			<button type="button" class="choice thumbnail"
				...
				<span class="screen-reader-text"><?php esc_html_e( 'Set image', 'ultimatewoo-pro' ); ?></span>
				<img src="{{{data.header.thumbnail_url}}}" alt="{{{data.header.alt_text || data.header.description}}}">
			</button>

			<# if ( data.type === 'uploaded' ) { #>
				<button type="button" class="dashicons dashicons-no close"><span class="screen-reader-text"><?php esc_html_e( 'Remove image', 'ultimatewoo-pro' ); ?></span></button>
			<# } #>
		</script>
		...
		<script type="text/template" id="tmpl-header-current">
			...
			<div class="placeholder">
				<?php esc_html_e( 'No image set', 'ultimatewoo-pro' ); ?>
			</div>
	...
	public function render_content() {
		...
		<div class="customize-control-content">
			...
			<p class="customizer-section-intro customize-control-description">
				<?php _e( 'Please upload one or more voucher background images by clicking <strong>Add New Image</strong>. While any dimensions are accepted, if you upload more than one background, please ensure alternative images have the <strong>same dimensions and resolution</strong> as the primary image.', 'ultimatewoo-pro' ); ?>
			</p>

			<div class="current">
				<label for="wc_pdf_product_vouchers_voucher_image-button">
					<span class="customize-control-title">
						<?php esc_html_e( 'Primary image', 'ultimatewoo-pro' ); ?>
					</span>
				</label>
				<div class="container">
				</div>
			...
			<div class="actions">
				...
				<button type="button" class="button new" id="wc_pdf_product_vouchers_voucher_image-button"  aria-label="<?php esc_attr_e( 'Add new voucher image', 'ultimatewoo-pro' ); ?>"><?php esc_html_e( 'Add new image', 'ultimatewoo-pro' ); ?></button>
			...
			<div class="choices">
				...
				<span class="customize-control-title uploaded-voucher-images">
					<?php esc_html_e( 'All Voucher Images', 'ultimatewoo-pro' ); ?>
				</span>
