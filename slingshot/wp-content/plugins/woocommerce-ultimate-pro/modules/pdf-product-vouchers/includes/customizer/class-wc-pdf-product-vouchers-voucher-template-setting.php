	...
	protected function get_root_value( $default = null ) {
		...
		switch ( $key ) {
			...
			case 'voucher_primary_image':
				...
				$image_id = $voucher_template->get_image_id();
			...
			case 'voucher_additional_image':
				return $voucher_template->get_additional_image_id();

			case 'logo_image_id':
				return $voucher_template->get_logo_id();

			case 'voucher_images':
				return $voucher_template->get_image_ids();
