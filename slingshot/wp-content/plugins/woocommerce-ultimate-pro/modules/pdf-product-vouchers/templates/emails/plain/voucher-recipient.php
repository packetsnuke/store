...
printf( _n( "Hi there. You've been sent a voucher!", "Hi there. You've been sent %d vouchers!", $voucher_count, 'ultimatewoo-pro' ), $voucher_count );

if ( $message ) {
	echo '&ldquo;' . esc_html( $message ) . '&rdquo;';
}

echo _n( 'You can find your voucher attached to this email', 'You can find your vouchers attached to this email', $voucher_count, 'ultimatewoo-pro' );
