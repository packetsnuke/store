...
<?php if ( empty ( $restricted_content->posts ) ) : ?>
	...
	<p><?php esc_html_e( 'There is no content assigned to this membership.', 'ultimatewoo-pro' ); ?></p>
		...
		<thead>
			<tr>
				...
				$my_membership_content_columns = (array) apply_filters( 'wc_memberships_members_area_my_membership_content_column_names', array(
					'membership-content-title'      => esc_html__( 'Title', 'ultimatewoo-pro' ),
					'membership-content-type'       => esc_html__( 'Type', 'ultimatewoo-pro' ),
					'membership-content-accessible' => esc_html__( 'Accessible', 'ultimatewoo-pro' ),
					'membership-content-excerpt'    => esc_html__( 'Excerpt', 'ultimatewoo-pro' ),
