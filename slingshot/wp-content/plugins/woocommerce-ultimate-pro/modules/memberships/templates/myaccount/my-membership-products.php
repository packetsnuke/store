...
<?php if ( empty ( $restricted_products->posts ) ) : ?>
	...
	<p><?php esc_html_e( 'There are no products assigned to this membership.', 'ultimatewoo-pro' ); ?></p>
		...
		<thead>
			<tr>
				...
				$my_membership_products_columns = (array) apply_filters( 'wc_memberships_members_area_my_membership_products_column_names', array(
					...
					'membership-product-title'      => wc_memberships_get_members_area_sorting_link( 'title', __( 'Title', 'ultimatewoo-pro' ) ),
					'membership-product-accessible' => esc_html__( 'Accessible', 'ultimatewoo-pro' ),
					'membership-product-price'      => esc_html__( 'Price', 'ultimatewoo-pro' ),
					'membership-product-excerpt'    => esc_html__( 'Description', 'ultimatewoo-pro' ),
					...
					<?php foreach ( $my_membership_products_columns as $column_id => $column_header ) : ?>
						...
						<?php elseif ( 'membership-product-accessible' === $column_id ) : ?>
							...
							<td class="membership-product-accessible" data-title="<?php echo esc_attr( $column_header ); ?>">
								<?php if ( $can_view_product ) : ?>
									<?php esc_html_e( 'Now', 'ultimatewoo-pro' ); ?>
								<?php else : ?>
