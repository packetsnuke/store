...
<?php if ( empty ( $customer_notes ) ) : ?>
	...
	<p><?php esc_html_e( 'There are no notes for this membership.', 'ultimatewoo-pro' ); ?> </p>
		...
		<thead>
			<tr>
				...
				$my_membership_notes_columns = (array) apply_filters( 'wc_memberships_members_area_my_membership_notes_column_names', array(
					'membership-note-date'    => __( 'Date', 'ultimatewoo-pro' ),
					'membership-note-time'    => __( 'Time', 'ultimatewoo-pro' ),
					'membership-note-author'  => __( 'Author', 'ultimatewoo-pro' ),
					'membership-note-content' => __( 'Note Content', 'ultimatewoo-pro' ),
				), $user_id );
