	...
	public function enable_discounts_to_sign_up_fees( $product_settings ) {
		...
		$new_option = array(
			array(
				...
				'name'    => __( 'Discounts apply to subscriptions sign up fees', 'ultimatewoo-pro' ),
				'desc'    => __( 'If enabled, membership discounts will also apply to sign up fees of subscription products.', 'ultimatewoo-pro' ),
				'default' => 'no',
			),
		);
