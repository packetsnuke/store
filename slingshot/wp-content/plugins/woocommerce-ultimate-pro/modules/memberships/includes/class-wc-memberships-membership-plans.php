...
class WC_Memberships_Membership_Plans {
	...
	public function get_membership_plans_access_length_periods( $with_labels = false ) {
		...
		$access_length_periods = array(
			'days'   => __( 'Day(s)', 'ultimatewoo-pro' ),
			'weeks'  => __( 'Week(s)', 'ultimatewoo-pro' ),
			'months' => __( 'Month(s)', 'ultimatewoo-pro' ),
			'years'  => __( 'Year(s)', 'ultimatewoo-pro' ),
		);
			...
			foreach ( $membership_plans as $membership_plan ) {
				...
				if ( 'labels' === $values ) {
					...
					if ( 'publish' !== $membership_plan->post->post_status ) {
						...
						$membership_plan_name = sprintf( __( '%s (inactive)', 'ultimatewoo-pro' ), $membership_plan_name );
					}
