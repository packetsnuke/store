...
function wc_memberships_get_members_area_sections( $membership_plan = '' ) {
	...
	return apply_filters( 'wc_membership_plan_members_area_sections', array(
		'my-membership-content'   => __( 'Content', 'ultimatewoo-pro' ),
		'my-membership-products'  => __( 'Products', 'ultimatewoo-pro' ),
		'my-membership-discounts' => __( 'Discounts', 'ultimatewoo-pro' ),
		'my-membership-notes'     => __( 'Notes', 'ultimatewoo-pro' ),
		'my-membership-details'   => __( 'Manage', 'ultimatewoo-pro' ),
	), $membership_plan );
}
