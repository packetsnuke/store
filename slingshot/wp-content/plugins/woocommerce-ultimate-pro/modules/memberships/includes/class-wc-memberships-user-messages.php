...
class WC_Memberships_User_Messages {
	...
	public static function get_default_messages( $with_labels = true ) {
		...
		$messages = array(
			...
			'content_delayed_message'                                 => __( 'This content is part of your membership, but not yet! You will gain access on {date}.', 'ultimatewoo-pro' ),
			'content_restricted_message'                              => __( 'To access this content, you must purchase {products}.', 'ultimatewoo-pro' ),
			'content_restricted_message_no_products'                  => __( 'This content is only available to members.', 'ultimatewoo-pro' ),

			// blog posts
			'post_content_delayed_message'                            => __( 'This post is part of your membership, but not yet! You will gain access on {date}.', 'ultimatewoo-pro' ),
			'post_content_restricted_message'                         => __( 'To access this post, you must purchase {products}.', 'ultimatewoo-pro' ),
			'post_content_restricted_message_no_products'             => __( 'This post is only available to members.', 'ultimatewoo-pro' ),

			// pages
			'page_content_delayed_message'                            => __( 'This page is part of your membership, but not yet! You will gain access on {date}.', 'ultimatewoo-pro' ),
			'page_content_restricted_message'                         => __( 'To access this page, you must purchase {products}.', 'ultimatewoo-pro' ),
			'page_content_restricted_message_no_products'             => __( 'This page is only available to members.', 'ultimatewoo-pro' ),

			// products
			'product_access_delayed_message'                          => __( 'This product is part of your membership, but not yet! It will become available on {date}.', 'ultimatewoo-pro' ),
			'product_viewing_restricted_message'                      => __( 'This product can only be viewed by members. To view or purchase this product, sign up by purchasing {products}.', 'ultimatewoo-pro' ),
			'product_viewing_restricted_message_no_products'          => __( 'This product can only be viewed by members.', 'ultimatewoo-pro' ),
			'product_purchasing_restricted_message'                   => __( 'This product can only be purchased by members. To purchase this product, sign up by purchasing {products}.', 'ultimatewoo-pro' ),
			'product_purchasing_restricted_message_no_products'       => __( 'This product can only be purchased by members.', 'ultimatewoo-pro' ),

			// product categories
			'product_category_viewing_delayed_message'                => __( 'This product category is part of your membership, but not yet! You will gain access on {date}.', 'ultimatewoo-pro' ),
			'product_category_viewing_restricted_message'             => __( 'This product category can only be viewed by members. To view this category, sign up by purchasing {products}.', 'ultimatewoo-pro' ),
			'product_category_viewing_restricted_message_no_products' => __( 'This product category can only be viewed by members.', 'ultimatewoo-pro' ),

			// product discount messages (non-restrictions)
			'product_discount_message'                                => __( 'Want a discount? Become a member by purchasing {products}!', 'ultimatewoo-pro' ),
			'product_discount_message_no_products'                    => __( 'Want a discount? Become a member!', 'ultimatewoo-pro' ),

			// product discount cart messages (non-restrictions)
			'cart_sole_item_discount_message'                         => __( 'This item is discounted for members. {Login} to claim it!', 'ultimatewoo-pro' ),
			'cart_item_discount_message'                              => __( 'An item in your cart is discounted for members. {Login} to claim it!', 'ultimatewoo-pro' ),
			'cart_items_discount_message'                             => __( 'Some items in your cart are discounted for members. {Login} to claim them!', 'ultimatewoo-pro' ),
	...
	public static function parse_message_merge_tags( $message, $args = array() ) {
		...
		if ( false !== stripos( $message, '{login' ) ) {
			...
			$message = str_replace( '{Login}', sprintf( _x( '%1$sLog in%2$s', 'Capitalized', 'ultimatewoo-pro' ), '<a href="{login_url}">', '</a>' ), $message );
			/* translators: Placeholders: %1$s - opening HTML <a> link tag, %2$s closing HTML </a> link tag */
