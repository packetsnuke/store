...
class WC_Memberships_Meta_Box_User_Membership_Notes extends WC_Memberships_Meta_Box {
	...
	public function get_title() {
		return __( 'Membership Notes', 'ultimatewoo-pro' );
	}
	...
	public function output( WP_Post $post ) {
		...
		<div class="wc-user-membership-add-note">
			...
			<h4><?php esc_html_e( 'Add note', 'woocommerce' ); ?>
				<?php echo wc_help_tip( __( 'Add a note for your reference, or add a customer note (the user will be notified).', 'ultimatewoo-pro' ) ); ?></h4>
			...
			<p class="note-controls">
				<label>
					<input
						...
						class="notify-member"
						value="1"
					/><?php esc_html_e( 'Notify Member', 'ultimatewoo-pro' ); ?>
				</label>
				<a href="#" class="add-note js-add-note button"><?php esc_html_e( 'Add Note', 'ultimatewoo-pro' ); ?></a>
			</p>
		...
		<ul class="wc-user-membership-notes">
			...
			if ( $notes ) :
				...
				?><li><?php esc_html_e( 'There are no notes yet.', 'ultimatewoo-pro' ); ?></li><?php
