...
class WC_Memberships_Modal_Add_User_Membership extends WC_Memberships_Member_Modal {
	...
	public function __construct() {
		...
		$this->title        = __( 'Add Member', 'ultimatewoo-pro' );
		$this->button_label = __( 'Add Member', 'ultimatewoo-pro' );
	}
	...
	protected function get_description() {
		return __( 'Search for an existing user or create a new one to add as a new member.', 'ultimatewoo-pro' );
	}
