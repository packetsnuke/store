		...
		if ( is_object( $note ) ) :
			...
			<li rel="<?php echo absint( $note->comment_ID ); ?>" class="<?php echo implode( ' ', array_map( 'sanitize_html_class', $note_classes ) ); ?>">
				...
				<p class="meta">
					...
					$note_meta = sprintf( $abbr_start . __( 'added on %1$s at %2$s', 'ultimatewoo-pro' ) . $abbr_end,
					...
					?>
					<a href="#" class="delete-note js-delete-note"><?php esc_html_e( 'Delete note', 'ultimatewoo-pro' ); ?></a>
				</p>
