...
class WC_Memberships_Modal_Transfer_User_Membership extends WC_Memberships_Member_Modal {
	...
	public function __construct() {
		...
		$this->title        = __( 'Transfer Membership', 'ultimatewoo-pro' );
		$this->button_label = __( 'Transfer Membership', 'ultimatewoo-pro' );
	}
	...
	protected function get_description() {
		return __( 'Search for an existing user or create a new user to transfer this membership to.', 'ultimatewoo-pro' );
	}
	...
	protected function get_user_source_options() {
		return array(
			'existing' => __( 'Transfer this membership to an existing user', 'ultimatewoo-pro' ),
			'new'      => __( 'Create a new user to transfer this membership to', 'ultimatewoo-pro' ),
		);
	}
