...
class WC_Memberships_Meta_Box_Membership_Plan_Email_Content_Merge_Tags extends WC_Memberships_Meta_Box {
	...
	public function get_title() {
		return __( 'Email Content Merge Tags', 'ultimatewoo-pro' );
	}
	...
	public function output( WP_Post $post ) {
		...
		<div class="panel-wrap data">
			...
			<small><?php esc_html_e( 'For any of the emails, or the renewal prompt content, you can use any of the following merge tags to add dynamic content to the membership plan emails:', 'ultimatewoo-pro' ); ?><br><br></small>
