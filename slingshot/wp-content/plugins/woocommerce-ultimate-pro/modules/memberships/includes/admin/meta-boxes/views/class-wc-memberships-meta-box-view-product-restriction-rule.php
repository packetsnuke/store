		...
		<tbody
			...
			<tr>
				...
				<th scope="row" class="check-column">
					<p class="form-field">
						<label for="_product_restriction_rules_<?php echo esc_attr( $index ); ?>_checkbox"><?php esc_html_e( 'Select', 'ultimatewoo-pro' ); ?>:</label>
				...
				<?php if ( 'membership_plan' === $context ) : ?>
					...
					<td class="product-restriction-content-type content-type-column">
						<p class="form-field">
							<label for="_product_restriction_rules_<?php echo esc_attr( $index ); ?>_content_type_key"><?php esc_html_e( 'Type', 'ultimatewoo-pro' ); ?>:</label>
					...
					<td class="product-restriction-objects objects-column">
						<p class="form-field">
							<label for="_product_restriction_rules_<?php echo esc_attr( $index ); ?>_object_ids"><?php esc_html_e( 'Title', 'ultimatewoo-pro' ); ?>:</label>
				...
				<?php else : ?>
					...
					<td class="product-restriction-membership-plan membership-plan-column">
						<p class="form-field">
							<label for="_product_restriction_rules_<?php echo esc_attr( $index ); ?>_membership_plan_id"><?php esc_html_e( 'Plan', 'ultimatewoo-pro' ); ?>:</label>
				...
				<td class="product-restriction-access-type access-type-column">
					<p class="form-field">
						<label for="_product_restriction_rules_<?php echo esc_attr( $index ); ?>_access_type"><?php esc_html_e( 'Only Members Can', 'ultimatewoo-pro' ); ?>:</label>
				...
				<td class="product-restriction-access-schedule access-schedule-column">
					<p class="form-field">
						<label><?php esc_html_e( 'Accessible', 'ultimatewoo-pro' ); ?>:</label>
					...
					<td colspan="<?php echo 'membership_plan' === $context || $is_variable_product ? 4 : 3; ?>">
						...
						<?php else : ?>
							...
							<span class="description"><?php
								...
								printf( __( 'This rule cannot be edited here because it applies to multiple products. You can %1$sedit this rule on the membership plan screen%2$s.', 'ultimatewoo-pro' ),
