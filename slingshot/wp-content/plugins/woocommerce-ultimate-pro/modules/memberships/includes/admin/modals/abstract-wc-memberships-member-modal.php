...
abstract class WC_Memberships_Member_Modal extends WC_Memberships_Modal {
		...
		<article>
			<form id="<?php echo esc_attr( $this->get_id() ); ?>">
				...
				<div id="wc-memberships-modal-select-existing-user">
					...
					<h3 class="wc-memberships-select-user"><?php esc_html_e( 'Select User', 'ultimatewoo-pro' ); ?></h3>
				...
				<div id="wc-memberships-modal-create-new-user" style="display: none;">
					...
					<h3 class="wc-memberships-select-user"><?php esc_html_e( 'Create User', 'ultimatewoo-pro' ); ?></h3>
	...
	protected function get_user_source_options() {
		...
		return array(
			'existing' => __( 'Add an existing user as a member', 'ultimatewoo-pro' ),
			'new'      => __( 'Create a new user to add as a member', 'ultimatewoo-pro' ),
		);
	}
	...
	protected function get_user_search_field_html() {
		...
		if ( SV_WC_Plugin_Compatibility::is_wc_version_gte_3_0() ) : ?>
			...
			<select
				...
				id="search_member_id"
				placeholder="<?php esc_html_e( 'Search for user', 'ultimatewoo-pro' ); ?>"
				data-placeholder="<?php esc_html_e( 'Search for user', 'ultimatewoo-pro' ); ?>"
	...
	protected function get_new_user_fields() {
		...
		$user_fields = array(
			'wc-memberships-member-modal-user-login' => array(
				...
				'type'  => 'text',
				'title' => __( 'Username', 'ultimatewoo-pro' ),
			...
			'wc-memberships-member-modal-user-email'  => array(
				...
				'title' => sprintf( __( 'Email %s', 'ultimatewoo-pro' ), __( '(Required)', 'ultimatewoo-pro' ) ),
			),
