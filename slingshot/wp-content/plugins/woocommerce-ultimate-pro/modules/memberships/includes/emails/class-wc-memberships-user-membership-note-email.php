...
class WC_Memberships_User_Membership_Note_Email extends WC_Memberships_User_Membership_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Membership note', 'ultimatewoo-pro' );
		$this->description    = __( 'Membership note emails are sent when you add a membership note and notify member.', 'ultimatewoo-pro' );
		$this->subject        = __( 'Note added to your {site_title} membership', 'ultimatewoo-pro');
		$this->heading        = __( 'A note has been added about your membership', 'ultimatewoo-pro');
