...
class WC_Memberships_User_Membership_Ended_Email extends WC_Memberships_User_Membership_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Membership ended', 'ultimatewoo-pro' );

		$description  =  __( 'Membership ended emails are sent to plan members in the moment their membership expires.', 'ultimatewoo-pro' );
		...
		$this->subject        = __( 'Your {site_title} membership has expired', 'ultimatewoo-pro');
		$this->heading        = __( 'Renew your {membership_plan}', 'ultimatewoo-pro');
