...
class WC_Authorize_Net_AIM_API extends SV_WC_API_Base implements SV_WC_Payment_Gateway_API {
	...
	protected function do_pre_parse_response_validation() {
		...
		if ( 200 != $this->get_response_code() ) {
			...
			throw new SV_WC_API_Exception( sprintf( __( 'HTTP %s: %s', 'ultimatewoo-pro' ), $this->get_response_code(), $this->get_response_message() ) );
		}
	}
	...
	protected function do_post_parse_response_validation() {
		...
		if ( $this->get_response()->has_api_error() && 'E00027' !== $this->get_response()->get_api_error_code() ) {
			...
			throw new SV_WC_API_Exception( sprintf( __( 'Code: %s, Message: %s', 'ultimatewoo-pro' ), $this->get_response()->get_api_error_code(), $this->get_response()->get_api_error_message() ), $exception_code );
