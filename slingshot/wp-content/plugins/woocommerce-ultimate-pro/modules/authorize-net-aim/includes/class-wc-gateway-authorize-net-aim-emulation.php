...
class WC_Gateway_Authorize_Net_AIM_Emulation extends SV_WC_Payment_Gateway_Direct {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				'method_title'       => __( 'Authorize.Net AIM Emulation', 'ultimatewoo-pro' ),
				'method_description' => __( 'Allow customers to securely pay using their credit cards via a payment processor that supports Authorize.Net AIM Emulation.', 'ultimatewoo-pro' ),
				'supports'           => array(
				...
				'environments'       => array(
					...
					self::ENVIRONMENT_TEST       => __( 'Test', 'ultimatewoo-pro' ),
				),
			)
		);
	}
	...
	protected function get_method_form_fields() {
		...
		return array(
			...
			'gateway_url' => array(
				'title'    => __( 'Payment Gateway URL', 'ultimatewoo-pro' ),
				'type'     => 'text',
				'class'    => 'environment-field production-field',
				'desc_tip' => __( 'The URL to post transaction requests to. Your payment processor should provide this to you.', 'ultimatewoo-pro' ),
				'default' => 'https://secure2.authorize.net/gateway/transact.dll',
			),

			'api_login_id' => array(
				'title'    => __( 'API Login ID', 'ultimatewoo-pro' ),
				'type'     => 'text',
				'class'    => 'environment-field production-field',
				'desc_tip' => __( 'Your Authorize.Net API Login ID', 'ultimatewoo-pro' ),
			),

			'api_transaction_key' => array(
				'title'    => __( 'API Transaction Key', 'ultimatewoo-pro' ),
				'type'     => 'password',
				'class'    => 'environment-field production-field',
				'desc_tip' => __( 'Your Authorize.Net API Transaction Key', 'ultimatewoo-pro' ),
			),

			'test_gateway_url' => array(
				'title'    => __( 'Test Payment Gateway URL', 'ultimatewoo-pro' ),
				'type'     => 'text',
				'class'    => 'environment-field test-field',
				'desc_tip' => __( 'The test URL to post transaction requests to. Your payment processor should provide this to you.', 'ultimatewoo-pro' ),
				'default'  => 'https://test.authorize.net/gateway/transact.dll',
			),

			'test_api_login_id' => array(
				'title'    => __( 'Test API Login ID', 'ultimatewoo-pro' ),
				'type'     => 'text',
				'class'    => 'environment-field test-field',
				'desc_tip' => __( 'Your test Authorize.Net API Login ID', 'ultimatewoo-pro' ),
			),

			'test_api_transaction_key' => array(
				'title'    => __( 'Test API Transaction Key', 'ultimatewoo-pro' ),
				'type'     => 'password',
				'class'    => 'environment-field test-field',
				'desc_tip' => __( 'Your test Authorize.Net API Transaction Key', 'ultimatewoo-pro' ),
			),
		);
	}
