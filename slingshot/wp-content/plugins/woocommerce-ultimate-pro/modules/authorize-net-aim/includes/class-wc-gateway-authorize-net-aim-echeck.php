...
class WC_Gateway_Authorize_Net_AIM_eCheck extends WC_Gateway_Authorize_Net_AIM {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				'method_title'       => __( 'Authorize.Net AIM eCheck', 'ultimatewoo-pro' ),
				'method_description' => __( 'Allow customers to securely pay using their checking accounts with Authorize.Net AIM.', 'ultimatewoo-pro' ),
				'supports'           => array(
