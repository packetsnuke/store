...
class WC_Gateway_Authorize_Net_AIM extends SV_WC_Payment_Gateway_Direct {
	...
	public function get_order( $order_id ) {
		 ...
		 */
		$order->description = apply_filters( 'wc_authorize_net_aim_transaction_description', sprintf( _x( '%s - Order %s', 'Order description', 'ultimatewoo-pro' ), wp_specialchars_decode( get_bloginfo( 'name' ) ), $order->get_order_number() ), $order_id, $this );
