...
define( 'WC_PRE_ORDERS_VERSION', '1.5.3' );
...
class WC_Pre_Orders {
	...
	public function plugin_action_links( $actions ) {
		$plugin_actions = array(
			'manage'  => sprintf( '<a href="%s">%s</a>', esc_url( admin_url( 'admin.php?page=wc_pre_orders' ) ), __( 'Manage Pre-Orders', 'ultimatewoo-pro' ) ),
			'support' => '<a href="https://woocommerce.com/my-account/create-a-ticket/">' . __( 'Support', 'ultimatewoo-pro' ) . '</a>',
			'docs'    => '<a href="https://docs.woocommerce.com/document/pre-orders/">' . __( 'Docs', 'ultimatewoo-pro' ) . '</a>',
		);
	...
	public function get_plugin_path() {
		return $this->plugin_path = ULTIMATEWOO_MODULES_DIR . '/pre-orders';
	}
	...
	public function get_plugin_url() {
		return $this->plugin_url = ULTIMATEWOO_MODULES_URL . '/pre-orders';
	}
