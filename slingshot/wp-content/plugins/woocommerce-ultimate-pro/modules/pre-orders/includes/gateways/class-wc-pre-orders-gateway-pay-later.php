...
class WC_Pre_Orders_Gateway_Pay_Later extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'Pay Later', 'ultimatewoo-pro' );
		$this->method_description = __( 'This payment method replaces all other methods that do not support pre-orders when the pre-order is charged upon release.', 'ultimatewoo-pro' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled' => array(
				...
				'label'       => __( 'Enable Pay Later', 'ultimatewoo-pro' ),
				'type'        => 'checkbox',
				'description' => '',
				'default'     => 'yes'
			),
			'title'       => array(
				...
				'default'     => __( 'Pay Later', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			),
			'description' => array(
				'title'       => __( 'Customer Message', 'ultimatewoo-pro' ),
				'type'        => 'textarea',
				'description' => __( 'Let the customer know how they will be able to pay for their pre-order.', 'ultimatewoo-pro' ),
				'default'     => __( 'You will receive an email when the pre-order is available along with instructions on how to complete your order.', 'ultimatewoo-pro' ),
			)
		);
	}
	...
	public function receipt_page( $order ) {
		echo '<p>' . __( 'Thank you for your order.', 'ultimatewoo-pro' ) . '</p>';
	}
