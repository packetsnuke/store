...
class WC_Pre_Orders_Email_Pre_Ordered extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Pre-ordered', 'ultimatewoo-pro' );
		$this->description    = __( 'This is an order notification sent to the customer after placing a pre-order and containing order details.', 'ultimatewoo-pro' );

		$this->heading        = __( 'Thank you for your pre-order', 'ultimatewoo-pro' );
		$this->subject        = __( 'Your {blogname} pre-order confirmation from {order_date}', 'ultimatewoo-pro' );
