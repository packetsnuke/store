...
class WC_Pre_Orders_Email_Pre_Order_Available extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Pre-order Available', 'ultimatewoo-pro' );
		$this->description    = __( 'This is an order notification sent to the customer once a pre-order is complete.', 'ultimatewoo-pro' );

		$this->heading        = __( 'Pre-order Available', 'ultimatewoo-pro' );
		$this->subject        = __( 'Your {blogname} pre-order from {order_date} is now available', 'ultimatewoo-pro' );
