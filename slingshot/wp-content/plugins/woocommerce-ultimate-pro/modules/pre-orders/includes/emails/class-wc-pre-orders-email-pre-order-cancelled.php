...
class WC_Pre_Orders_Email_Pre_Order_Cancelled extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Pre-order Cancelled', 'ultimatewoo-pro' );
		$this->description    = __( 'This is an order notification sent to the customer after a pre-order is cancelled.', 'ultimatewoo-pro' );

		$this->heading        = __( 'Pre-order Cancelled', 'ultimatewoo-pro' );
		$this->subject        = __( 'Your {blogname} pre-order from {order_date} has been cancelled', 'ultimatewoo-pro' );
