...
class WC_Pre_Orders_Email_Pre_Order_Date_Changed extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Pre-order Release Date Changed', 'ultimatewoo-pro' );
		$this->description    = __( 'This is an order notification sent to the customer after a pre-order release date is changed.', 'ultimatewoo-pro' );

		$this->heading        = __( 'Pre-order Release Date Changed', 'ultimatewoo-pro' );
		$this->subject        = __( 'The release date for your {blogname} pre-order from {order_date} has been changed', 'ultimatewoo-pro' );
