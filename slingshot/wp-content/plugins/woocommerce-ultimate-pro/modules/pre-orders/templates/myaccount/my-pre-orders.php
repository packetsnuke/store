...
<?php if ( $show_title ) : ?>
	<h2><?php _e( 'My Pre-Orders', 'ultimatewoo-pro' ); ?></h2>
<?php endif; ?>
...
<?php if ( ! empty( $items ) ) : ?>
	<table class="shop_table my_account_pre_orders my_account_orders">
		...
		<thead>
			<tr>
				<th class="pre-order-order-number"><span class="nobr"><?php _e( 'Order', 'ultimatewoo-pro' ); ?></span></th>
				<th class="pre-order-title"><span class="nobr"><?php _e( 'Product', 'ultimatewoo-pro' ); ?></span></th>
				<th class="pre-order-status"><span class="nobr"><?php _e( 'Status', 'ultimatewoo-pro' ); ?></span></th>
				<th class="pre-order-release-date"><span class="nobr"><?php _e( 'Release Date', 'ultimatewoo-pro' ); ?></span></th>
...
<?php else : ?>
	...
	<p><?php _e( 'You have no pre-orders.', 'ultimatewoo-pro' ); ?></p>
