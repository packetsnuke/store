...
echo sprintf( __( 'You have received a pre-order from %s. Their pre-order is as follows:', 'ultimatewoo-pro' ), $full_name ) . "\n\n";
...
echo sprintf( __( 'Order date: %s', 'ultimatewoo-pro'), date_i18n( __( 'jS F Y', 'ultimatewoo-pro' ), strtotime( $pre_wc_30 ? $order->order_date : ( $order->get_date_created() ? gmdate( 'Y-m-d H:i:s', $order->get_date_created()->getOffsetTimestamp() ) : '' ) ) ) ) . "\n";
...
_e( 'Customer details', 'ultimatewoo-pro' );
