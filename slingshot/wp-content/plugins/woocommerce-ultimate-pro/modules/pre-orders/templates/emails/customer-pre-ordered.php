...
<?php if ( WC_Pre_Orders_Order::order_will_be_charged_upon_release( $order ) ) : ?>
	...
	<?php if ( WC_Pre_Orders_Order::order_has_payment_token( $order ) )
		echo "<p>" . sprintf( __( "Your pre-order has been received. You will be automatically charged for your order via your selected payment method when your pre-order is released%s Your order details are shown below for your reference.", 'ultimatewoo-pro' ), $availability_date_text ) . "</p>";
	else
		echo "<p>" . sprintf( __( "Your pre-order has been received. You will be prompted for payment for your order when your pre-order is released%s Your order details are shown below for your reference.", 'ultimatewoo-pro' ), $availability_date_text ) . "</p>";
	?>
<?php else : ?>

	<p><?php
/* translators: 1: availability date */
printf( __( "Your pre-order has been received. You will be notified when your pre-order is released%s Your order details are shown below for your reference.", 'ultimatewoo-pro' ), $availability_date_text ); ?></p>
