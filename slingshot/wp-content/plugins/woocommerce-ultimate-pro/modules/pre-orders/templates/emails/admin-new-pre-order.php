...
printf( __( 'You have received a pre-order from %s. Their pre-order is as follows:', 'ultimatewoo-pro' ), $full_name ); ?></p>
...
printf( __( 'Order: %s', 'ultimatewoo-pro' ), $order->get_order_number() ); ?> (<?php printf( '<time datetime="%s">%s</time>', date_i18n( 'c', strtotime( $order_date ) ), date_i18n( wc_date_format(), strtotime( $order_date ) ) ); ?>)</h2>
