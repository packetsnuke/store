...
if ( $availability_date ) :
	printf( __( 'Your pre-order release date has been changed. The new release date is %s. Your order details are shown below for your reference.', 'ultimatewoo-pro' ), $availability_date );
else :
	echo __( 'Your pre-order release date has been changed. Your order details are shown below for your reference.', 'ultimatewoo-pro' ) . "\n\n";
endif;
