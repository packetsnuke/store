...
class WCOPC_Easy_Pricing_Tables_Template extends WCOPC_Template {
	...
	public function __construct() {
		...
		$this->label        = __( 'Easy Pricing Table', 'ultimatewoo-pro' );
		$this->description  = __( 'Include a pricing table creating with the Easy Pricing Table plugin. Best for creating highly customised pricing tables.', 'ultimatewoo-pro' );
...
?>
	<fieldset id="wcopc_easy_pricing_table_fields" style="margin: 1em 0;">
		<label for="wcopc_easy_pricing_table_id" style="width: 70px; display: inline-block;"><?php _e( 'Pricing Table:', 'ultimatewoo-pro' ); ?></label>
		...
		<?php else : ?>
			<span><?php _e( 'No pricing tables available.', 'ultimatewoo-pro' ); ?>
		<?php endif; ?>
	</fieldset>
<?php
	}
