...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.6.6', __( 'WooCommerce Customer/Order CSV Export', 'ultimatewoo-pro' ), __FILE__, 'init_woocommerce_customer_order_csv_export', array(
...
class WC_Customer_Order_CSV_Export extends SV_WC_Plugin {
	...
	public function add_admin_notices() {
		...
		$this->get_admin_notice_handler()->add_admin_notice(
			...
			sprintf( __( 'Thanks for installing the Customer/Order CSV Export plugin! To get started, please %1$sset your export format%2$s. ', 'ultimatewoo-pro' ), '<a href="' . $this->get_settings_url() . '">', '</a>' ),
	...
	public function get_plugin_name() {
		...
		return __( 'WooCommerce Customer/Order CSV Export', 'ultimatewoo-pro' );
	}
