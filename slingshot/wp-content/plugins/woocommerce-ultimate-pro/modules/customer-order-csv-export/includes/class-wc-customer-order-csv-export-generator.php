...
class WC_Customer_Order_CSV_Export_Generator {
	...
	private function get_customers_csv_row_data( $id, $order_id = null ) {
		...
		$customer_data = array(
			...
			'billing_full_name'   => ! empty( $user->billing_full_name ) ? $user->billing_full_name : sprintf( _x( '%1$s %2$s', 'full name', 'ultimatewoo-pro' ), $user->billing_first_name, $user->billing_last_name ),
			...
			'shipping_full_name'  => ! empty( $user->shipping_full_name ) ? $user->shipping_full_name : sprintf( _x( '%1$s %2$s', 'full name', 'ultimatewoo-pro' ), $user->shipping_first_name, $user->shipping_last_name ),
