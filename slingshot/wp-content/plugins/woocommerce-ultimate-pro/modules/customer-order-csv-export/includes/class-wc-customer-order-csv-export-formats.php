	...
	private function load_formats() {
		...
		$this->formats['orders']['legacy_single_column'] = array(
			...
			'columns' => array(
				...
				'order_date'           => __( 'Date', 'ultimatewoo-pro' ),
				'status'               => __( 'Order Status', 'ultimatewoo-pro' ),
				'shipping_total'       => __( 'Shipping', 'ultimatewoo-pro' ),
				'shipping_tax_total'   => __( 'Shipping Tax', 'ultimatewoo-pro' ),
				'fee_total'            => __( 'Fees', 'ultimatewoo-pro' ),
				'fee_tax_total'        => __( 'Fee Tax', 'ultimatewoo-pro' ),
				'tax_total'            => __( 'Tax', 'ultimatewoo-pro' ),
				'discount_total'       => __( 'Discount Total', 'ultimatewoo-pro' ),
				...
				'billing_first_name'   => __( 'Billing First Name', 'ultimatewoo-pro' ),
				'billing_last_name'    => __( 'Billing Last Name', 'ultimatewoo-pro' ),
				'billing_email'        => __( 'Billing Email', 'ultimatewoo-pro' ),
				'billing_phone'        => __( 'Billing Phone', 'ultimatewoo-pro' ),
				'billing_address_1'    => __( 'Billing Address 1', 'ultimatewoo-pro' ),
				'billing_address_2'    => __( 'Billing Address 2', 'ultimatewoo-pro' ),
				'billing_postcode'     => __( 'Billing Post code', 'ultimatewoo-pro' ),
				'billing_city'         => __( 'Billing City', 'ultimatewoo-pro' ),
				'billing_state'        => __( 'Billing State', 'ultimatewoo-pro' ),
				'billing_country'      => __( 'Billing Country', 'ultimatewoo-pro' ),
				'billing_company'      => __( 'Billing Company', 'ultimatewoo-pro' ),
				'shipping_first_name'  => __( 'Shipping First Name', 'ultimatewoo-pro' ),
				'shipping_last_name'   => __( 'Shipping Last Name', 'ultimatewoo-pro' ),
				'shipping_address_1'   => __( 'Shipping Address 1', 'ultimatewoo-pro' ),
				'shipping_address_2'   => __( 'Shipping Address 2', 'ultimatewoo-pro' ),
				'shipping_postcode'    => __( 'Shipping Post code', 'ultimatewoo-pro' ),
				'shipping_city'        => __( 'Shipping City', 'ultimatewoo-pro' ),
				'shipping_state'       => __( 'Shipping State', 'ultimatewoo-pro' ),
				'shipping_country'     => __( 'Shipping Country', 'ultimatewoo-pro' ),
				'shipping_company'     => __( 'Shipping Company', 'ultimatewoo-pro' ),
				'customer_note'        => __( 'Customer Note', 'ultimatewoo-pro' ),
				'order_items'          => __( 'Order Items', 'ultimatewoo-pro' ),
				'download_permissions' => __( 'Download Permissions Granted', 'ultimatewoo-pro' ),
				'order_notes'          => __( 'Order Notes', 'ultimatewoo-pro' ),
				'coupon_items'         => __( 'Coupons', 'ultimatewoo-pro' ),
			),
		);
		...
		$this->formats['orders']['legacy_one_row_per_item']['columns']  = SV_WC_Helper::array_insert_after( $this->formats['orders']['legacy_one_row_per_item']['columns'], 'customer_note', array(
			'line_item_sku'       => __( 'Item SKU', 'ultimatewoo-pro' ),
			'line_item_name'      => __( 'Item Name', 'ultimatewoo-pro' ),
			'line_item_variation' => __( 'Item Variation', 'ultimatewoo-pro' ),
			'line_item_amount'    => __( 'Item Amount', 'ultimatewoo-pro' ),
			'line_item_price'     => __( 'Row Price', 'ultimatewoo-pro' ),
		) );
		...
		$this->formats['customers']['legacy'] = array(
			...
			'enclosure' => '"',
			'columns'   => array(
				'customer_id'        => __( 'ID', 'ultimatewoo-pro' ),
				'billing_first_name' => __( 'First Name', 'ultimatewoo-pro' ),
				'billing_last_name'  => __( 'Last Name', 'ultimatewoo-pro' ),
				'billing_email'      => __( 'Email', 'ultimatewoo-pro' ),
				'billing_phone'      => __( 'Phone', 'ultimatewoo-pro' ),
				'billing_address_1'  => __( 'Address', 'ultimatewoo-pro' ),
				'billing_address_2'  => __( 'Address 2', 'ultimatewoo-pro' ),
				'billing_postcode'   => __( 'Post code', 'ultimatewoo-pro' ),
				'billing_city'       => __( 'City', 'ultimatewoo-pro' ),
				'billing_state'      => __( 'State', 'ultimatewoo-pro' ),
				'billing_country'    => __( 'Country', 'ultimatewoo-pro' ),
				'billing_company'    => __( 'Company', 'ultimatewoo-pro' ),
			),
		);
