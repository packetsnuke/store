	 ...
	 */
	 public function __construct( $args ) {
		...
		if ( ! $this->username ) {
			...
			throw new SV_WC_Plugin_Exception( __( 'FTP Username is blank.', 'ultimatewoo-pro' ) );
		}
		...
		if ( ! $this->server ) {
			...
			throw new SV_WC_Plugin_Exception( __( 'FTP Server is blank.', 'ultimatewoo-pro' ) );
		}

		// check for blank port
		if ( ! $this->port ) {

			throw new SV_WC_Plugin_Exception ( __( 'FTP Port is blank.', 'ultimatewoo-pro' ) );
		}
	}
