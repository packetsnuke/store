...
<html>
	...
	<body>
		<header>
			...
			<h1 class="title"><?php _e( 'Stock Report', 'ultimatewoo-pro' ); ?></h1>
		</header>
		<section>
		<table cellspacing="0" cellpadding="2">
			<thead>
				<tr>
					<?php if ( wc_product_sku_enabled() ) : ?>
						<th scope="col" style="text-align:left;"><?php _e( 'SKU', 'ultimatewoo-pro' ); ?></th>
					<?php endif; ?>
					<th scope="col" style="text-align:left;"><?php _e( 'Product', 'ultimatewoo-pro' ); ?></th>
					<th scope="col" style="text-align:left;"><?php _e( 'ID', 'ultimatewoo-pro' ); ?></th>
					<th scope="col" style="text-align:left;"><?php _e( 'Type', 'ultimatewoo-pro' ); ?></th>
					<th scope="col" style="text-align:left;"><?php _e( 'Unit Retail Price', 'ultimatewoo-pro' ); ?></th>
					<th scope="col" style="text-align:left;"><?php _e( 'Stock Qty', 'ultimatewoo-pro' ); ?></th>
				</tr>
			</thead>
			<tbody>
			<?php
