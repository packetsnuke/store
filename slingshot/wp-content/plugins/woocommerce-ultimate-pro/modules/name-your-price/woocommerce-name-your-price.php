...
class WC_Name_Your_Price {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'ultimatewoo-pro' ) );
	}
	...
	public function admin_notice() {
	    echo '<div class="error"><p>' . sprintf( __( 'WooCommerce Name Your Price requires at least WooCommerce %s in order to function. Please upgrade WooCommerce.', 'ultimatewoo-pro' ), $this->required_woo ) . '</p></div>';
	}
	...
	public function add_action_link( $links ) {
		$settings_link = '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=nyp' ). '" title="' . __( 'Go to the settings page', 'ultimatewoo-pro' ). '">'.__( 'Settings', 'ultimatewoo-pro' ).'</a>';
