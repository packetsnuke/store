...
class WC_NYP_Meta_Box_Product_Data {
	...
	public static function save_product_meta( $product ) {
		...
		if ( $suggested && $minimum && $minimum > $suggested ) {
			WC_Admin_Meta_Boxes::add_error( __( 'The minimum price should not be higher than the suggested price for Name Your Price products. Please review your prices.', 'ultimatewoo-pro' ) );
		}
	...
	public static function save_product_variation( $variation_id, $i ){
		...
		if ( $variation_suggested_price && $variation_min_price && $variation_min_price > $variation_suggested_price ) {
			WC_Admin_Meta_Boxes::add_error( __( 'The minimum price should not be higher than the suggested price for Name Your Price variations. Please review your prices.', 'ultimatewoo-pro' ) );
		}
