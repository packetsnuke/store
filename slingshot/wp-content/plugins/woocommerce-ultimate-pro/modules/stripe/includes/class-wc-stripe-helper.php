...
class WC_Stripe_Helper {
	...
	public static function get_localized_messages() {
		return apply_filters( 'wc_stripe_localized_messages', array(
			'invalid_number'           => __( 'The card number is not a valid credit card number.', 'ultimatewoo-pro' ),
			'invalid_expiry_month'     => __( 'The card\'s expiration month is invalid.', 'ultimatewoo-pro' ),
			'invalid_expiry_year'      => __( 'The card\'s expiration year is invalid.', 'ultimatewoo-pro' ),
			'invalid_cvc'              => __( 'The card\'s security code is invalid.', 'ultimatewoo-pro' ),
			'incorrect_number'         => __( 'The card number is incorrect.', 'ultimatewoo-pro' ),
			'incomplete_number'        => __( 'Your card number is incomplete.', 'ultimatewoo-pro' ),
			'incomplete_cvc'           => __( 'Your card\'s security code is incomplete.', 'ultimatewoo-pro' ),
			'incomplete_expiry'        => __( 'Your card\'s expiration date is incomplete.', 'ultimatewoo-pro' ),
			'expired_card'             => __( 'The card has expired.', 'ultimatewoo-pro' ),
			'incorrect_cvc'            => __( 'The card\'s security code is incorrect.', 'ultimatewoo-pro' ),
			'incorrect_zip'            => __( 'The card\'s zip code failed validation.', 'ultimatewoo-pro' ),
			'card_declined'            => __( 'The card was declined.', 'ultimatewoo-pro' ),
			'missing'                  => __( 'There is no card on a customer that is being charged.', 'ultimatewoo-pro' ),
			'processing_error'         => __( 'An error occurred while processing the card.', 'ultimatewoo-pro' ),
			'invalid_request_error'    => __( 'Could not find payment information. Please try with another payment method.', 'ultimatewoo-pro' ),
			'invalid_expiry_year_past' => __( 'Your card\'s expiration year is in the past', 'ultimatewoo-pro' ),
		) );
	}
