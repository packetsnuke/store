...
class WC_Gateway_Stripe_Sofort extends WC_Stripe_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title         = __( 'Stripe SOFORT', 'ultimatewoo-pro' );
		/* translators: link */
	...
	public function get_environment_warning() {
		if ( 'yes' === $this->enabled && ! in_array( get_woocommerce_currency(), $this->get_supported_currency() ) ) {
			$message = __( 'SOFORT is enabled - it requires store currency to be set to Euros.', 'ultimatewoo-pro' );
	...
	public function form() {
		...
		<fieldset id="wc-<?php echo esc_attr( $this->id ); ?>-form" class="wc-payment-form">
			...
			<label for="stripe-bank-country">
				<?php _e( 'Country origin of your bank.', 'ultimatewoo-pro' ); ?>
			</label>
			<br />
			<p class="form-row form-row-wide validate-required">
			<select id="stripe-bank-country" class="wc-enhanced-select" name="stripe_sofort_bank_country">
				<option value="-1"><?php esc_html_e( 'Choose Bank Country', 'ultimatewoo-pro' ); ?></option>
