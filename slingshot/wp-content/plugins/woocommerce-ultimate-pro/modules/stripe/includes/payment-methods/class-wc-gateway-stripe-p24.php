...
class WC_Gateway_Stripe_P24 extends WC_Stripe_Payment_Gateway {
	...
	public function __construct() {
		$this->id                   = 'stripe_p24';
		$this->method_title         = __( 'Stripe P24', 'ultimatewoo-pro' );
		/* translators: link */
	...
	public function get_environment_warning() {
		if ( 'yes' === $this->enabled && ! in_array( get_woocommerce_currency(), $this->get_supported_currency() ) ) {
			$message = __( 'P24 is enabled - it requires store currency to be set to Euros or Polish Zloty.', 'ultimatewoo-pro' );
