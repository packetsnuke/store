...
class WC_Gateway_Stripe_Alipay extends WC_Stripe_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title         = __( 'Stripe Alipay', 'ultimatewoo-pro' );
		/* translators: link */
	...
	public function get_environment_warning() {
		if (
			...
			$message = sprintf( __( 'Alipay is enabled - it requires store currency to be set to %s', 'ultimatewoo-pro' ), implode( ', ', $this->get_supported_currency() ) );
