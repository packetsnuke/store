...
return apply_filters( 'wc_stripe_alipay_settings',
	array(
		'geo_target' => array(
			'description' => __( 'Relevant Payer Geography: China', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'guide' => array(
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#alipay" target="_blank">Payment Method Guide</a>', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'activation' => array(
		...
		'enabled' => array(
			...
			'label'       => __( 'Enable Stripe Alipay', 'ultimatewoo-pro' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __( 'Alipay', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __( 'You will be redirected to Alipay.', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'webhook' => array(
