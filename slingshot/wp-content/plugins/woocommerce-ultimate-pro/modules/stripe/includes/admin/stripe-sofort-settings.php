...
return apply_filters( 'wc_stripe_sofort_settings',
	array(
		'geo_target' => array(
			'description' => __( 'Relevant Payer Geography: Germany, Austria', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'guide' => array(
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#sofort" target="_blank">Payment Method Guide</a>', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'activation' => array(
		...
		'enabled' => array(
			...
			'label'       => __( 'Enable Stripe SOFORT', 'ultimatewoo-pro' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __( 'SOFORT', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __( 'You will be redirected to SOFORT.', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'webhook' => array(
