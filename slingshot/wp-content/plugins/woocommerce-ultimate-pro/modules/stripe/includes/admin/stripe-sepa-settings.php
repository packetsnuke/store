...
return apply_filters( 'wc_stripe_sepa_settings',
	array(
		'geo_target' => array(
			'description' => __( 'Relevant Payer Geography: France, Germany, Spain, Belgium, Netherlands, Luxembourg, Italy, Portugal, Austria, Ireland', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'guide' => array(
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#sepa-direct-debit" target="_blank">Payment Method Guide</a>', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'activation' => array(
		...
		'enabled' => array(
			...
			'label'       => __( 'Enable Stripe SEPA Direct Debit', 'ultimatewoo-pro' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __( 'SEPA Direct Debit', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __( 'Mandate Information.', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'webhook' => array(
