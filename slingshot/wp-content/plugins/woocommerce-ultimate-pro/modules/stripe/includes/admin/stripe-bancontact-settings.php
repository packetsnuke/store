...
return apply_filters( 'wc_stripe_bancontact_settings',
	array(
		'geo_target' => array(
			'description' => __( 'Relevant Payer Geography: Belgium', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'guide' => array(
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#bancontact" target="_blank">Payment Method Guide</a>', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'activation' => array(
		...
		'enabled' => array(
			...
			'label'       => __( 'Enable Stripe Bancontact', 'ultimatewoo-pro' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __( 'Bancontact', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __( 'You will be redirected to Bancontact.', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'webhook' => array(
