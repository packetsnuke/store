...
return apply_filters( 'wc_stripe_bitcoin_settings',
	array(
		'geo_target' => array(
			'description' => __( 'Relevant Payer Geography: Global', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'guide' => array(
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#bitcoin" target="_blank">Payment Method Guide</a>', 'ultimatewoo-pro' ),
			'type'        => 'title',
		),
		'activation' => array(
		...
		'enabled' => array(
			...
			'label'       => __( 'Enable Stripe Bitcoin', 'ultimatewoo-pro' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __( 'Bitcoin', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __( 'Bitcoin payment information will be provided when you place the order.', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		),
		'webhook' => array(
