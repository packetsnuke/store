...
class WC_PCSVIS_System_Status_Tools {
	...
	public function tools( $tools ) {
		$tools['delete_products'] = array(
			...
			'desc'		=> __( 'This tool will delete all products allowing you to start fresh.', 'ultimatewoo-pro' ),
		...
		$tools['delete_variations'] = array(
			...
			'desc'		=> __( 'This tool will delete all variations allowing you to start fresh.', 'ultimatewoo-pro' ),
		...
		$tools['delete_orphaned_variations'] = array(
			...
			'desc'		=> __( 'This tool will delete variations which have no parent.', 'ultimatewoo-pro' ),
	...
	public function delete_products() {
		...
		echo '<div class="updated"><p>' . sprintf( __( '%d Products Deleted', 'ultimatewoo-pro' ), ( $result + $result2 ) ) . '</p></div>';
	}
	...
	public function delete_variations() {
		...
		echo '<div class="updated"><p>' . sprintf( __( '%d Variations Deleted', 'ultimatewoo-pro' ), $result ) . '</p></div>';
	}
