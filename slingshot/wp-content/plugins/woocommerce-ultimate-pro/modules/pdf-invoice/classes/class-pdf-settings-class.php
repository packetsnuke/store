<?php
        ...
        class WC_pdf_admin_settings {
            ...
            function pdf_invoice_admin_menu_item() {
                add_submenu_page('woocommerce', __( 'PDF Invoice', 'ultimatewoo-pro' ), __( 'PDF Invoice', 'ultimatewoo-pro' ), 'manage_woocommerce', 'woocommerce_pdf', array($this,'options_page') );
            }
            ...
            public function get_plugin_url() {
                return ULTIMATEWOO_MODULES_URL . 'pdf-invoice';
            }
            ...
            public static function options_page() {
                ...
                <div class="wrap woocommerce">
                    ...
                    <h2><?php _e( 'WooCommerce PDF Invoice' , 'ultimatewoo-pro' ) ?></h2>
                    <?php settings_errors(); ?>
                    <?php 
                    ...
                    <div class="notice notice-error">
                        <p><?php printf( __("A required PHP function is not installed, please contact your host and ask them to install <a href=\"%s\" target=\"_blank\">ICONV</a>" , 'ultimatewoo-pro' ), 'http://php.net/manual/en/book.iconv.php' ); ?></p>
                    </div>
                    <?php } ?>
                    ...
                    <h2 class="nav-tab-wrapper">
						<a href="?page=woocommerce_pdf&tab=display_settings" class="nav-tab <?php echo $active_tab == 'display_settings' ? 'nav-tab-active' : ''; ?>"><?php _e( 'PDF Settings' , 'ultimatewoo-pro' ) ?></a>
						<a href="?page=woocommerce_pdf&tab=display_debugging" class="nav-tab <?php echo $active_tab == 'display_debugging' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Debugging Information' , 'ultimatewoo-pro' ) ?></a>
					</h2>
                    <?php
                    ...
                    // Settings
                    ?>
                    <p><?php _e( 'Configure the WooCommerce PDF settings here, refer to the <a href="'.PDFDOCSURL.'" target="_blank">WooCommerce PDF Invoice docs</a> for more information' , 'ultimatewoo-pro' ) ?></p>
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[attach_multiple]"><?php _e('Choose which additional emails to attach the PDF to.', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('By default the PDF Invoice extension will only atach to the Completed Order Email, if you want to attach it to other emails sent by WooCommerce then make selections here(ctrl-click or cmd-click for multiple selections)', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[create_invoice]"><?php _e('When to create the invoice', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Do you want to create the invoice details when the order is paid for (processing) or wait until you have shipped (completed), from version 1.2.1 you can also create an invoice when the order status is On-Hold', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[link_thanks]"><?php _e('Show "Download Invoice" link on Thank You page?', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Add a link to download the invoice to the Thank You for your order page', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[paper_size]"><?php _e('Paper Size', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Set the paper size of your PDF invoice, this is only really used if your customer prints it out.', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[paper_orientation]"><?php _e('Paper Orientation', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Set the paper orientation of your PDF invoice, this is only really used if your customer prints it out.', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[logo_file]"><?php _e('PDF Logo', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php echo sprintf( __("Add a logo to your PDF, otherwise it will just use your WordPress title %s", 'ultimatewoo-pro' ), get_bloginfo( 'name' ) ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Copy the URL to your logo into here or upload using the button', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>

                                <button id="woocommerce_pdf_invoice_settings_logo_file_button" class="button new upload_pdf_logo" name="woocommerce_pdf_invoice_settings[logo_file]_button" type="text" /><?php _e('Upload Your Logo', 'ultimatewoo-pro' ); ?></button>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[enable_remote]"><?php _e('Remote Logo', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php echo sprintf( __("Allow remote images, if your logo is not hosted on your site then set this to 'YES'.", 'ultimatewoo-pro' ), get_bloginfo( 'name' ) ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                <p><?php _e('If this is set to Yes, PDF Invoice will access remote sites for images and CSS files as required.
                                    ...
                                    <br /><strong>Do not change this settings without understanding the consequences.</strong></p>', 'ultimatewoo-pro' ); ?>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[enable_subsetting]"><?php _e('Font Subsetting', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php echo sprintf( __("Enable font subsetting, which embeds only used characters into the file, set this to 'YES' and test to confirm the invoice looks correct.", 'ultimatewoo-pro' ), get_bloginfo( 'name' ) ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                <p><?php _e('Setting this option to yes will significantly reduce the PDF file size. You should check the invoice to confirm that all characters are displayed correctly.', 'ultimatewoo-pro' ); ?></p>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_company_name]"><?php _e('Company Name', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('The name of your company, this shows at the top of the invoice', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Your company name', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_company_details]"><?php _e('Company Information', 'ultimatewoo-pro' ); ?></label>
                            ...
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Your company contact info', 'ultimatewoo-pro' ); ?>" style="width: 350px;"><?php echo ( isset($woocommerce_pdf_invoice_options['pdf_company_details']) ? $woocommerce_pdf_invoice_options['pdf_company_details'] : '' ); ?></textarea>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_registered_name]"><?php _e('Registered Name', 'ultimatewoo-pro' ); ?></label>
                            ...
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('The legal name of your company', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_registered_address]"><?php _e('Registered Office', 'ultimatewoo-pro' ); ?></label>
                            ...
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('The legal registered address of your company', 'ultimatewoo-pro' ); ?>" style="width: 350px;"><?php echo ( isset($woocommerce_pdf_invoice_options['pdf_registered_address']) ? $woocommerce_pdf_invoice_options['pdf_registered_address'] : '' ); ?></textarea>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_company_number]"><?php _e('Company Number', 'ultimatewoo-pro' ); ?></label>
                            ...
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Government issued company ID', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_tax_number]"><?php _e('Tax Number', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('If your buisness is registered for tax purposes your tax office may have issued you with a number (in the UK this would be your VAT number)', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Govenment issued tax number if you have one', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[sequential]"><?php _e('Use Sequential Invoice Numbering', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('By default WooCommerce uses the post->ID as the order number so there will be gaps in the order number sequence. By setting this to Yes invoice numbers will be sequential.', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[annual_restart]"><?php _e('Reset Invoice Numbering to 1 at the start of each year', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Will reset the invoice number to 1 for the first order of the year.', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                            ...
                            <br /><?php _e('Use this option with caution, check with your local tax office if you are not sure if you need to use this.<br /><strong>You should include -{{year}} in the "Invoice number suffix" setting</strong>', 'ultimatewoo-pro' ); ?>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[start_number]"><?php _e('Number of first invoice if not 1', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('What number would you like on the first invoice? Once you have issued an invoice changing this will make no difference', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('What number would you like on the first invoice?', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[padding]"><?php _e('Enter a pattern for the invoice number, EG 000000', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Set the length of the number part of your invoice number. EG 000000 would give an invoice number like ABC-000492', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_prefix]"><?php _e('Invoice number prefix', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Use this field to add a prefix to your invoice numbers. If you want your invoice number to look like ABC-123 then add ABC- to this field', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Add an invoice number prefix', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_sufix]"><?php _e('Invoice number suffix', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Use this field to add a prefix to your invoice numbers. If you want your invoice number to look like 123-ABC then add -ABC to this field', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Add an invoice number prefix suffix', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_filename]"><?php _e('Invoice file name format', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Set the file name format for your PDF files. Bear in mind that your customer should be able to identify your invoice easily. Please review the documentation for accepted variables. Default is {{company}}-{{invoicenumber}}', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                                ...
                                placeholder="<?php _e('Invoice filename layout', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>                     
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_date]"><?php _e('Which date should the invoice use', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Do you want the invoice date to be the date of order or the date the order is completed.', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_date_format]"><?php _e('Invoice date format', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Set the invoice date format, see the docs for further information and examples.', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                            <input id="woocommerce_pdf_invoice_settings[pdf_date_format]" 
                                ...
                                placeholder="<?php _e('j F, Y', 'ultimatewoo-pro' ); ?>" style="width: 350px;"/>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_create_invoices_for_old]"><?php _e('Create invoices for past orders', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('If you have past orders that have been completed, do you want to create invoices for them?', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_termsid]"><?php _e('PDF Terms Page', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e('Set a terms page for your PDF invoices, if you set a terms page then an additional page will be added to the PDF. This terms pages uses a seperate template file so you can style the terms seperately', 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                            <select name="woocommerce_pdf_invoice_settings[pdf_termsid]" id="woocommerce_pdf_invoice_settings[pdf_termsid]" style="width: 350px;">
                            	<option value="0" <?php selected( $woocommerce_pdf_invoice_options['pdf_termsid'], 0 ); ?>><?php _e('Select PDF terms page if required', 'ultimatewoo-pro' ) ?></option>
                        ...
                        <tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="woocommerce_pdf_invoice_settings[pdf_creation]"><?php _e('PDF Creation Method', 'ultimatewoo-pro' ); ?></label>
                                <img class="help_tip" data-tip="<?php _e("If you have problems with PDFs not creating change this option to 'File only'", 'ultimatewoo-pro' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                            </th>
                            <td class="forminp forminp-number">
                    ...
                    <input type="submit" class="button-primary" value="<?php _e( 'Save Options', 'ultimatewoo-pro' ); ?>" />
                    </p>
