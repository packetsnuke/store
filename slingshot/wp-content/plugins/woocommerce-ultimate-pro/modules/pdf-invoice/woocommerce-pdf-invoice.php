...
*/
    ...
    define( 'PDFLANGUAGE', 'ultimatewoo-pro' );
    ...
    define( 'PDFPLUGINPATH', ULTIMATEWOO_MODULES_DIR . 'pdf-invoice/' );
    ...
    class WC_pdf_admin {
        ...
        public static function plugin_links( $links ) {
            ...
            $plugin_links = array(
                '<a href="' . PDFSUPPORTURL . '">' . __( 'Support', 'ultimatewoo-pro' ) . '</a>',
                '<a href="' . PDFDOCSURL . '">' . __( 'Docs', 'ultimatewoo-pro' ) . '</a>',
            );
        ...
        public function add_pdf_invoice_to_csv_export_column_headers( $column_headers ) { 
            ...
            $column_headers['invoice_num']  = __('Invoice_Number', 'ultimatewoo-pro');
            $column_headers['invoice_date'] = __('Invoice_Date', 'ultimatewoo-pro');
