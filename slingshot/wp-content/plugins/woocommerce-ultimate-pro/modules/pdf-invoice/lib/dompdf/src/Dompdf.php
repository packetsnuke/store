...
use CO_HTML5_Tokenizer;
use CO_HTML5_TreeBuilder;
    ...
    */
    ...
    public function loadHtml($str, $encoding = null)
    {
        ...
        if ($this->options->isHtml5ParserEnabled()) {
            $tokenizer = new CO_HTML5_Tokenizer($str);
            $tokenizer->parse();
            $doc = $tokenizer->save();
            ...
            $quirksmode = ($tokenizer->getTree()->getQuirksMode() > CO_HTML5_TreeBuilder::NO_QUIRKS);
        } else {
