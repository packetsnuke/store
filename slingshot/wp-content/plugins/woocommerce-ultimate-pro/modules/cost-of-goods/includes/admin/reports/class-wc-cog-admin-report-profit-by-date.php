	...
	public function get_chart_legend() {
		...
		return array(
			...
			array(
				...
				'title'            => sprintf( __( '%1$s net sales in this period', 'ultimatewoo-pro' ), '<strong>' . wc_price( $data->net_sales ) . '</strong>' ),
				'placeholder'      => __( 'This is the sum of the order totals after any refunds and excluding fees, taxes, and shipping (unless you have toggled the settings to include them)', 'ultimatewoo-pro' ),
			...
			array(
				...
				'title'            => sprintf( __( '%1$s total cost of goods in this period', 'ultimatewoo-pro' ), '<strong>' . wc_price( $data->total_cogs ) . '</strong>' ),
				'placeholder'      => __( 'This is the sum of the item cost of goods after any refunds', 'ultimatewoo-pro' ),
			...
			array(
				...
				'title'            => sprintf( __( '%1$s total profit in this period', 'ultimatewoo-pro' ), '<strong>' . wc_price( $data->total_profit ) . '</strong>' ),
				'placeholder'      => __( 'This is the sum of the order profit after any refunds', 'ultimatewoo-pro' ),
			...
			array(
				...
				'title' => sprintf( __( '%1$s orders placed', 'ultimatewoo-pro' ), '<strong>' . $data->total_orders . '</strong>' ),
			...
			array(
				...
				'title'            => sprintf( __( '%1$s average profit per order in this period', 'ultimatewoo-pro' ), '<strong>' . wc_price( $data->avg_profit ) . '</strong>' ),
				'placeholder'      => __( 'This is the average profit per order after any refunds', 'ultimatewoo-pro' ),
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						{
							label     : "<?php echo esc_js( __( 'Number of orders', 'ultimatewoo-pro' ) ) ?>",
						...
						{
							label     : "<?php echo esc_js( __( 'Net Sales amount', 'ultimatewoo-pro' ) ) ?>",
