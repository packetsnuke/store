...
class WC_COG_Admin_Report_Profit_by_Category extends WC_COG_Admin_Report {
	...
	public function get_chart_legend() {
		...
		foreach ( $this->category_ids as $category_id ) {
			...
			$legend[] = array(
				...
				'title'            => sprintf( __( '%1$s total profit in %2$s', 'ultimatewoo-pro' ), '<strong>' . wc_price( ( ! empty( $data->total_profit ) ? $data->total_profit : 0 ) ) . '</strong>', $category->name ),
	...
	public function get_chart_widgets() {
		...
		return array(
			array(
				'title'    => __( 'Categories', 'ultimatewoo-pro' ),
	...
	public function output_category_widget() {
		...
		<form method="GET">
			<div>
				<select multiple="multiple" data-placeholder="<?php _e( 'Select categories&hellip;', 'ultimatewoo-pro' ); ?>" class="wc-enhanced-select" id="category_ids" name="category_ids[]" style="width: 205px;">
					<?php
					$r                 = array();
					$r['pad_counts']   = 1;
					$r['hierarchical'] = 1;
				...
				<a href="#" class="select_none"><?php esc_html_e( 'None', 'ultimatewoo-pro' ); ?></a>
				<a href="#" class="select_all"><?php esc_html_e( 'All', 'ultimatewoo-pro' ); ?></a>
	...
	public function get_main_chart() {
		...
		if ( empty( $this->category_ids ) ) {
			...
			<div class="chart-container">
				<p class="chart-prompt"><?php _e( '&larr; Choose a category to view stats', 'ultimatewoo-pro' ); ?></p>
			</div>
			<?php
		}
