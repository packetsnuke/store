...
class WC_COG_Admin_Report_Product_Valuation extends WC_Report_Stock {
	...
	public function get_columns() {
		...
		$new_columns = array(
			'value_at_retail' => __( 'Value at Retail', 'ultimatewoo-pro' ),
			'value_at_cost'   => __( 'Value at Cost', 'ultimatewoo-pro' ),
		);
	...
	public function display_tablenav( $context ) {
		...
		$defaults = array(
			...
			'xaxes'    => __( 'Product', 'ultimatewoo-pro' ),
		);
		?>
		<form method="post">
			...
			<div class="wc-cog-product-valuation-progress hide">
				<p>
					<?php esc_html_e( 'Note: Product Valuation export is in progress, please do not refresh the page! When the export is complete, the download will start automatically.', 'ultimatewoo-pro' ); ?>
				</p>
			...
			echo $this->search_box( __( 'Search for a product', 'ultimatewoo-pro' ), 'wc-cog-product-valuation' ); ?>
		</form>
		<?php
	}
