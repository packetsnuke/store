...
class WC_COG_Admin_Products {
	...
	public function add_cost_field_to_simple_product() {
		...
		woocommerce_wp_text_input(
			array(
				...
				'label'     => sprintf( __( 'Cost of Good (%s)', 'ultimatewoo-pro' ), get_woocommerce_currency_symbol() ),
				'data_type' => 'price',
			)
		);
	}
	...
	public function add_cost_field_to_variable_product() {
		...
		woocommerce_wp_text_input(
			array(
				...
				'data_type'         => 'price',
				'desc_tip'          => true,
				'description'       => __( 'Default cost for product variations', 'ultimatewoo-pro' ),
			)
		);
	}
	...
	public function add_variable_product_bulk_edit_cost_action() {
		...
		$option_label = __( 'Set cost', 'ultimatewoo-pro' );
	...
	public function add_cost_field_to_product_variation( $loop, $variation_data, $variation ) {
		...
		<div>
			<p class="form-row form-row-first">
				<label><?php
					/* translators: Placeholder: %s - currency symbol */
					printf( esc_html__( 'Cost of Good: (%s)', 'ultimatewoo-pro' ), esc_html( get_woocommerce_currency_symbol() ) ); ?></label>
	...
	public function add_cost_field_bulk_edit() {
		...
		<div class="inline-edit-group">
			<label class="alignleft">
				<span class="title"><?php esc_html_e( 'Cost of Good', 'ultimatewoo-pro' ); ?></span>
			...
			<label class="change-input">
				<input type="text" name="_cost_of_good" class="text cost_of_good" placeholder="<?php esc_attr_e( 'Enter Cost:', 'ultimatewoo-pro' ); ?>" value="" />
			</label>
		</div>
		<?php
	}
	...
	public function render_quick_edit_cost_field() {
		?>
			<br class="clear" />
			<label class="alignleft">
				<span class="title"><?php esc_html_e( 'Cost', 'ultimatewoo-pro' ); ?></span>
				<span class="input-text-wrap">
	...
	public function product_list_table_cost_column_header( $existing_columns ) {
		...
		foreach ( $existing_columns as $key => $value ) {
			...
			if ( 'price' === $key ) {
				$columns['cost'] = __( 'Cost', 'ultimatewoo-pro' );
			}
		}
