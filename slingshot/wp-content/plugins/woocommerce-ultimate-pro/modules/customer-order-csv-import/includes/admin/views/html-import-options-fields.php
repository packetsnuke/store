...
<h3><?php esc_html_e( 'Options', 'ultimatewoo-pro' ); ?></h3>
...
<table class="form-table">
	...
	<tr>
		<th>
			<?php esc_html_e( 'Merge/update', 'ultimatewoo-pro' ); ?>
		</th>
		<td>
			<label>
				<input type="checkbox" value="1" name="options[merge]" id="wc-csv-import-suite-merge" class="js-wc-csv-import-suite-merge" />
				<?php esc_html_e( 'Update existing records if a match is found', 'ultimatewoo-pro' ); ?>
			</label>
		</td>
	</tr>
	...
	<tr style="display: none;"><!-- This advanced merge option is hidden by default -->
		...
		<td>
			<label>
				...
				<?php esc_html_e( 'Insert as new if a match is not found', 'ultimatewoo-pro' ); ?>
			</label>
		</td>
	</tr>
	...
	<tr>
		<th>
			<?php esc_html_e( 'Debug Mode', 'ultimatewoo-pro' ); ?>
		</th>
		<td>
			<label for="wc-csv-import-suite-debug-mode">
				...
				<?php esc_html_e( 'Enable logging for this import. Please leave this disabled unless you are experiencing issues with imports.', 'ultimatewoo-pro' ); ?>
			</label>
		</td>
	</tr>
	...
	<tr>
		<th>
			<label for="wc-csv-import-suite-delimiter"><?php _e( 'Fields are separated by', 'ultimatewoo-pro' ); ?></label>
		</th>
		<td>
