...
<div class="woocommerce">
	...
	<h3><?php esc_html_e( 'Where do you want to import data from?', 'ultimatewoo-pro' ); ?></h3>
	...
	<?php else : ?>
		...
		<form id="import-source-form" class="csv-import-suite-form" method="get">
			...
			<p class="submit">
				<input type="submit" class="button" value="<?php esc_attr_e( 'Next &raquo;', 'ultimatewoo-pro' ); ?>" />
			</p>
