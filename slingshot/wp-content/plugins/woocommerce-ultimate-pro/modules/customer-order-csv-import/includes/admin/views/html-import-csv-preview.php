...
<h3><?php esc_html_e( 'Preview', 'ultimatewoo-pro' ); ?></h3>
<p><?php esc_html_e( "Does the preview below look right? Each field should be in its own table cell. If it doesn't, simply adjust the delimiter until it looks right. If none of the options seem to work, make sure you are using a well-formatted CSV file.", 'ultimatewoo-pro' ); ?></p>
