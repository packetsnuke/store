...
<h3><?php esc_html_e( 'Map Fields', 'ultimatewoo-pro' ); ?></h3>
<p><?php esc_html_e( 'Here you can map your imported columns to WooCommerce data fields.', 'ultimatewoo-pro' ); ?></p>
...
<div class="woocommerce">
	...
	<form class="csv-import-suite-form" action="<?php echo esc_url( admin_url( '?import=' . esc_attr( $_GET['import'] ) . '&step=4' ) ); ?>" method="post">
		...
		<table class="widefat widefat_importer csv-import-suite-column-mapper">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Column Header', 'ultimatewoo-pro' ); ?></th>
					<th><?php esc_html_e( 'Map to', 'ultimatewoo-pro' ); ?></th>
					<th colspan="<?php echo esc_attr( $sample_size ); ?>"><?php esc_html_e( 'Example Column Values', 'ultimatewoo-pro' ); ?></th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td width="25%">
						<select name="options[mapping][<?php echo esc_attr( $field ); ?>]">
							<option value=""><?php esc_html_e( '-- Skip --', 'ultimatewoo-pro' ); ?></option>
		...
		<p class="submit">
			<button type="submit" class="button" name="options[dry_run]" value="1"><?php esc_html_e( 'Dry Run &raquo;', 'ultimatewoo-pro' ); ?></button>
			<button type="submit" class="button"><?php esc_attr_e( 'Start Import &raquo;', 'ultimatewoo-pro' ); ?></button>
		</p>
