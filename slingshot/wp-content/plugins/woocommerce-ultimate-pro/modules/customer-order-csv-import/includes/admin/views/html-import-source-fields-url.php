...
<h3><?php esc_html_e( 'Import data from URL or path', 'ultimatewoo-pro' ); ?></h3>
...
<table class="form-table">
	...
	<tr>
		<th>
			<label for="upload"><?php esc_html_e( 'Enter URL or path to file:', 'ultimatewoo-pro' ); ?></label>
		</th>
		<td>
			<input type="text" id="url" name="url" class="large-text" />
			<p class="description">
				<small><?php esc_html_e( 'Acceptable file types: CSV or tab-delimited text files.', 'ultimatewoo-pro' ); ?></small>
			</p>
		</td>
	</tr>
