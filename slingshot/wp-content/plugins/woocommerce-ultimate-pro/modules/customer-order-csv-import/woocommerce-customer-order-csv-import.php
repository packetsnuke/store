...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.6.4', __( 'WooCommerce Customer/Order/Coupon CSV Import', 'ultimatewoo-pro' ), __FILE__, 'init_woocommerce_csv_import_suite', array(
...
class WC_CSV_Import_Suite extends SV_WC_Plugin {
	...
	public function get_settings_link( $plugin_id = null ) {
		...
		if ( $settings_url ) {
			return sprintf( '<a href="%s">%s</a>', $settings_url, __( 'Import', 'ultimatewoo-pro' ) );
		}
	...
	*/
	...
	public function get_plugin_name() {
		return __( 'WooCommerce Customer/Order/Coupon CSV Import', 'ultimatewoo-pro' );
	}
