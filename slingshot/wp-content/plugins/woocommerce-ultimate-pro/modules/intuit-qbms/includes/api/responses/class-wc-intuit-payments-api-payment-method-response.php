 ...
 * @since 2.0.0
 */
class WC_Intuit_Payments_API_Payment_Method_Response extends WC_Intuit_Payments_API_Payment_Response implements SV_WC_Payment_Gateway_API_Create_Payment_Token_Response {
	...
	public function get_payment_token() {
		...
		return new SV_WC_Payment_Gateway_Payment_Token( $this->get_method_id(), $data );
	}
