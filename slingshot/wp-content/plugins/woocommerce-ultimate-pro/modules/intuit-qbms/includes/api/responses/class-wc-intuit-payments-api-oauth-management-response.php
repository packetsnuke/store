 ...
 * @since 2.0.0
 */
class WC_Intuit_Payments_API_oAuth_Management_Response extends SV_WC_API_JSON_Response {
	...
	public function get_token() {
		...
		return ! empty( $this->OAuthToken ) ? $this->OAuthToken : '';
	}
	...
	public function get_token_secret() {
		...
		return ! empty( $this->OAuthTokenSecret ) ? $this->OAuthTokenSecret : '';
	}
