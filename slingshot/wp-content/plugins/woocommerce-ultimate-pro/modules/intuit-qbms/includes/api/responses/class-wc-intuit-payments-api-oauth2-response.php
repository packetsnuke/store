 ...
 * @since 2.1.0
 */
class WC_Intuit_Payments_API_OAuth2_Response extends SV_WC_API_JSON_Response {
	...
	public function get_access_token_expiry() {
		...
		$expires_in = ! empty( $this->expires_in ) ? $this->expires_in : 3600;
	...
	public function get_api_errors() {
		...
		switch ( $error ) {
			...
			default:
				$message = __( 'Authentication error. Please try again.', 'ultimatewoo-pro' );
		}
