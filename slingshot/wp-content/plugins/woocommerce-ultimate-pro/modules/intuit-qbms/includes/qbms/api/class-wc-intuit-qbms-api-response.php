...
class WC_Intuit_QBMS_API_Response implements SV_WC_Payment_Gateway_API_Response {
	...
	public function get_connection_status_message() {
		...
		switch ( $this->get_connection_status_code() ) {
			case 0:    return __( 'Authentication successful', 'ultimatewoo-pro' );
			case 2000: return __( 'Application agent not found - the ticket provided is invalid or cancelled', 'ultimatewoo-pro' );
			case 2010: return __( 'Unauthorized', 'ultimatewoo-pro' );
			case 2020: return __( 'Session Authentication required', 'ultimatewoo-pro' );
			case 2040: return __( 'Internal error', 'ultimatewoo-pro' );

			default: return __( 'Unknown error', 'ultimatewoo-pro' );
		}
	}
	...
	public function get_user_message() {
		...
		$message_helper = new SV_WC_Payment_Gateway_API_Response_Message_Helper( 'woocommerce-gateway-intuit-payments' );
		$user_message = null;
