...
class WC_Gateway_Intuit_QBMS_eCheck extends WC_Gateway_Intuit_QBMS {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			wc_intuit_payments(),
			array(
				'method_title'       => __( 'Intuit QBMS eCheck', 'ultimatewoo-pro' ),
				'method_description' => __( 'Allow customers to securely pay using their checking accounts with Intuit QBMS.', 'ultimatewoo-pro' ),
				'supports'           => array(
