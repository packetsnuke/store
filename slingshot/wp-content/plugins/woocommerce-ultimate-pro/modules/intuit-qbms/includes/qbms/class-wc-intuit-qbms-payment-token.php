...
class WC_Intuit_QBMS_Payment_Token extends SV_WC_Payment_Gateway_Payment_Token {
	...
	private function get_card_type_from_token( $token ) {
		...
		switch ( $type_id ) {
			...
			case '01': return SV_WC_Payment_Gateway_Helper::CARD_TYPE_VISA;
			case '02': return SV_WC_Payment_Gateway_Helper::CARD_TYPE_MASTERCARD;
			case '03': return SV_WC_Payment_Gateway_Helper::CARD_TYPE_AMEX;
			case '04': return SV_WC_Payment_Gateway_Helper::CARD_TYPE_DISCOVER;
			case '05': return SV_WC_Payment_Gateway_Helper::CARD_TYPE_DINERSCLUB;
			case '06': return SV_WC_Payment_Gateway_Helper::CARD_TYPE_JCB;
