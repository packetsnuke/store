...
class WC_Gateway_Inuit_Payments_eCheck extends WC_Gateway_Inuit_Payments {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				'method_title' => __( 'Intuit Payments eCheck', 'ultimatewoo-pro' ),
				'supports'     => array(
	...
	protected function get_test_case_options() {
		...
		return array(
			'1.11' => __( 'Pending', 'ultimatewoo-pro' ),
			'3.33' => __( 'Declined', 'ultimatewoo-pro' ),
			'5.55' => __( 'Succeeded', 'ultimatewoo-pro' ),
		);
	}
