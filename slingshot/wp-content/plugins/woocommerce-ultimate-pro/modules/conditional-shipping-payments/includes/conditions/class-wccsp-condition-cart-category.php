	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( $data[ 'modifier' ] === 'in' && $contains_qualifying_products ) {
			...
			if ( count( $term_names ) == 1 ) {
				...
				return sprintf( __( 'remove all products in the &quot;%s&quot; category from your cart', 'ultimatewoo-pro' ), current( $term_names ) );
				...
				return sprintf( __( 'remove all products in the %s categories from your cart', 'ultimatewoo-pro' ), $string );
			}
