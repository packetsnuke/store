...
class WC_CSP_Condition_Customer extends WC_CSP_Condition {
	...
	public function __construct() {
		...
		$this->id                             = 'customer';
		$this->title                          = __( 'Customer', 'ultimatewoo-pro' );
	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( $data[ 'modifier' ] === 'in' && $identified_email ) {
			return __( 'use an authorized account', 'ultimatewoo-pro' );
	...
	public function get_admin_fields_html( $index, $condition_index, $condition_data ) {
		...
		<div class="condition_modifier">
			<select name="restriction[<?php echo $index; ?>][conditions][<?php echo $condition_index; ?>][modifier]">
				<option value="in" <?php selected( $modifier, 'in', true ) ?>><?php echo __( 'e-mail is', 'ultimatewoo-pro' ); ?></option>
				<option value="not-in" <?php selected( $modifier, 'not-in', true ) ?>><?php echo __( 'e-mail is not', 'ultimatewoo-pro' ); ?></option>
			</select>
		</div>
		<div class="condition_value">
			<textarea class="short" name="restriction[<?php echo $index; ?>][conditions][<?php echo $condition_index; ?>][value]" placeholder="<?php _e( 'List of e-mails separated by comma.', 'ultimatewoo-pro' ); ?>"><?php echo esc_textarea( $emails ) ?></textarea>
		</div><?php
	}
}
