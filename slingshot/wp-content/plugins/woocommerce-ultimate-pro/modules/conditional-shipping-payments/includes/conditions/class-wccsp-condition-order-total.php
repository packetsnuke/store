...
class WC_CSP_Condition_Order_Total extends WC_CSP_Condition {
	...
	public function __construct() {
		...
		$this->id                             = 'order_total';
		$this->title                          = __( 'Order Total', 'ultimatewoo-pro' );
	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( $data[ 'modifier' ] === 'min' && wc_format_decimal( $data[ 'value' ] ) <= $order_total ) {
			return sprintf( __( 'decrease your order total below %s', 'ultimatewoo-pro' ), wc_price( $data[ 'value' ] ) );
		}

		if ( $data[ 'modifier' ] === 'max' && wc_format_decimal( $data[ 'value' ] ) > $order_total ) {
			return sprintf( __( 'increase your order total above %s', 'ultimatewoo-pro' ), wc_price( $data[ 'value' ] ) );
		}
