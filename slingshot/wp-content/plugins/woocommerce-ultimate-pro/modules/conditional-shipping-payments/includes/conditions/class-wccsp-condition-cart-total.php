...
class WC_CSP_Condition_Cart_Total extends WC_CSP_Condition {
	...
	public function __construct() {
		...
		$this->id                             = 'cart_total';
		$this->title                          = __( 'Cart Total', 'ultimatewoo-pro' );
	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( $data[ 'modifier' ] === 'min' && wc_format_decimal( $data[ 'value' ] ) <= $cart_total ) {
			return sprintf( __( 'decrease your cart total below %s', 'ultimatewoo-pro' ), wc_price( $data[ 'value' ] ) );
		}

		if ( $data[ 'modifier' ] === 'max' && wc_format_decimal( $data[ 'value' ] ) > $cart_total ) {
			return sprintf( __( 'increase your cart total above %s', 'ultimatewoo-pro' ), wc_price( $data[ 'value' ] ) );
		}
