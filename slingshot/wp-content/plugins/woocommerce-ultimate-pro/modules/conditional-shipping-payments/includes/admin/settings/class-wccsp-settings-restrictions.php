...
class WC_Settings_Restrictions extends WC_Settings_Page {
	...
	public function __construct() {
		...
		$this->label = __( 'Restrictions', 'ultimatewoo-pro' );
	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_csp_settings', array(
			...
			array(
				'title' => __( 'Restrictions', 'ultimatewoo-pro' ),
				'type'  => 'title',
				'desc'  => __( 'Use Restrictions to conditionally disable Payment Gateways, Shipping Methods and Shipping Countries or States.', 'ultimatewoo-pro' ),
			...
			array(
				'title' => __( 'Debug Options', 'ultimatewoo-pro' ),
				'type'  => 'title',
				'desc'  => __( 'Use the following options to temporarily disable all defined Restrictions, for example if you need to troubleshoot your payment and shipping settings.', 'ultimatewoo-pro' ),
				'id'    => 'wccsp_restrictions_debug'
			),

			array(
				'title'         => __( 'Disable Global Restrictions', 'ultimatewoo-pro' ),
				'desc'          => __( 'Disable all global restrictions', 'ultimatewoo-pro' ),
				'id'            => 'wccsp_restrictions_disable_global',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => 'start',
				'desc_tip'      => __( 'Disable all restrictions created in the tab sections above.', 'ultimatewoo-pro' ),
			),

			array(
				'title'         => __( 'Disable Product Restrictions', 'ultimatewoo-pro' ),
				'desc'          => __( 'Disable all restrictions defined at product level', 'ultimatewoo-pro' ),
				'id'            => 'wccsp_restrictions_disable_product',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => 'start',
				'desc_tip'      => __( 'Disable all restrictions created from the <strong>Product Data > Restrictions</strong> tab in product pages. Product level restrictions are associated with specific products.', 'ultimatewoo-pro' ),
			),
	...
	public function restrictions_overview() {
		...
		?>
		<tr valign="top">
			<th scope="row" class="titledesc"><?php _e( 'Restrictions Overview', 'ultimatewoo-pro' ) ?></th>
			<td class="forminp">
				<table class="wc_shipping wc_restrictions_overview widefat wp-list-table" cellspacing="0">
					<thead>
						<tr>
							<th class="name"><?php _e( 'Restriction Type', 'ultimatewoo-pro' ); ?></th>
							<th class="status"><?php _e( 'Active Rules', 'ultimatewoo-pro' ); ?></th>
							<th class="summary"><?php _e( 'Summary', 'ultimatewoo-pro' ); ?></th>
						</tr>
					</thead>
					<tbody>
