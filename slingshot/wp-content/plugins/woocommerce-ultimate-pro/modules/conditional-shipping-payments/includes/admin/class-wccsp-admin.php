...
class WC_CSP_Admin {
	...
	public function product_data_tabs( $tabs ) {
		...
		$tabs[ 'csp_restrictions' ] = array(
			'label'  => __( 'Restrictions', 'ultimatewoo-pro' ),
			...
			<div class="options_group">
				...
				<p class="toolbar">
					...
					<select name="_restriction_type" class="restriction_type">
						<option value=""><?php _e( 'Add restriction&hellip;', 'ultimatewoo-pro' ); ?></option>
						<?php
					...
					<button type="button" class="button add_restriction"><?php _e( 'Add', 'ultimatewoo-pro' ); ?></button>
	...
	public function ajax_add_checkout_restriction() {
		...
		if ( $applied_count === 0 || ( $applied_count > 0 && WC_CSP()->restrictions->get_restriction( $restriction_id )->supports_multiple() ) ) {
			...
			$errors[] = __( 'This restriction is already defined and cannot be added again. Only restrictions that support multiple rule definitions can be added more than once.', 'ultimatewoo-pro' );
		}
