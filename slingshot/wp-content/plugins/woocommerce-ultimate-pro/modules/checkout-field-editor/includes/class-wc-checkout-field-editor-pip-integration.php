...
class WC_Checkout_Field_Editor_PIP_Integration {
	...
	public function add_settings( $settings ) {
		return array_merge( $settings, array(
			// Section start
			array(
				'name' => __( 'Checkout Fields Editor', 'ultimatewoo-pro' ),
				'type' => 'title',
			),
			...
			array(
				...
				'name'     => __( 'Custom Checkout Fields', 'ultimatewoo-pro' ),
				'desc_tip' => __( 'Select which document types should display custom checkout fields.', 'ultimatewoo-pro' ),
				'type'     => 'multiselect',
