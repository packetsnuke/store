...
public function email() {
	...
	public function get_age_text($time = '') {
		...
		else
		{
			...
			if($number_days > 1)
				$days_label = __("Days", 'ultimatewoo-pro');
			else
				$days_label = __("Day", 'ultimatewoo-pro');

			if($number_hours > 1)
				$hours_label = __("Hours", 'ultimatewoo-pro');
			else
				$hours_label = __("Hour", 'ultimatewoo-pro');

			if($number_minutes > 1)
				$minutes_label = __("Minutes", 'ultimatewoo-pro');
			else
				$minutes_label = __("Minute", 'ultimatewoo-pro');

			if($number_seconds > 1)
				$seconds_label = __("Seconds", 'ultimatewoo-pro');
			else
				$seconds_label = __("Second", 'ultimatewoo-pro');
	...
	public function print_cart_actions() {
		...
		if(empty($actions)) {
			echo "<span style='color:lightgray;'>". __("No Actions Available", 'ultimatewoo-pro') ."</span>";
		}
		else
		{
			//Print the actions
