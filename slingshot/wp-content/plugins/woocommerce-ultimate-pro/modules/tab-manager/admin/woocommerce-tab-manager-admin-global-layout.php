...
function wc_tab_manager_render_layout_page() {
	...
	<form action="admin-post.php" method="post">
		<div class="wrap woocommerce">
			<?php if ( isset( $_GET['result'] ) ) : /* show any action messages */ ?>
				<div id="message" class="updated">
					<?php
					$message = sprintf( __( 'Tabs layout %s', 'ultimatewoo-pro' ), $_GET['result'] );
					?>
			...
			<div class="postbox" id="woocommerce-product-data">
				<h3 class="hndle"><span><?php esc_html_e( 'Default Tab Layout', 'ultimatewoo-pro' ); ?></span></h3>
				<div class="inside">
		...
		<p class="submit">
			...
			<input type="submit" name="save" value="<?php esc_attr_e( 'Save Changes', 'ultimatewoo-pro' ); ?>" class="button-primary" />
		</p>
	</form>
