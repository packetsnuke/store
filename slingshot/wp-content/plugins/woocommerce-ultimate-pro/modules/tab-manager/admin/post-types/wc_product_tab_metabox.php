...
class WC_Tab_Manager_Categories_Metabox {
	...
	public function render_meta_box_content( $post ) {
		...
		if ( $post->post_parent ) {
			?><p><?php esc_html_e( 'Product-level tabs will always be shown on their assigned product.', 'ultimatewoo-pro' ); ?></p><?php
			return;
		}
		...
		?>
		<p class="form-field"><label for="product_categories"><?php _e( 'Product Categories', 'ultimatewoo-pro' ); ?></label>

			<?php echo wc_help_tip( __( 'Select categories to restrict the display of this tab to certain products.', 'ultimatewoo-pro' ) ); ?>
			...
			<select
				...
				multiple="multiple"
				data-placeholder="<?php esc_attr_e( 'Any category', 'ultimatewoo-pro' ); ?>">
