				...
				<?php foreach ( $table['bookings'] as $booking ) : ?>
					...
					<tr>
						...
						<td class="booking-cancel">
							...
							<a href="<?php echo esc_url( $booking->get_cancel_url() ); ?>" class="button cancel"><?php esc_html_e( 'Cancel', 'ultimatewoo-pro' ); ?></a>
							<?php endif; ?>
						</td>
					</tr>
				<?php endforeach; ?>
...
<?php else : ?>
	<div class="woocommerce-Message woocommerce-Message--info woocommerce-info">
		<a class="woocommerce-Button button" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
			<?php esc_html_e( 'Go Shop', 'ultimatewoo-pro' ) ?>
		</a>
		<?php esc_html_e( 'No bookings available yet.', 'ultimatewoo-pro' ); ?>
	</div>
<?php endif; ?>
