...
class WC_Bookings {
	...
	public function __construct() {
		...
		define( 'WC_BOOKINGS_TEMPLATE_PATH', ULTIMATEWOO_MODULES_DIR . '/bookings/templates/' );
		define( 'WC_BOOKINGS_PLUGIN_URL', untrailingslashit( ULTIMATEWOO_MODULES_URL . '/bookings' ) );
...
KEY resource_id (resource_id)
	...
	public function init_post_types() {
		register_post_type( 'bookable_person',
			apply_filters( 'woocommerce_register_post_type_bookable_person',
				array(
					'label'        => __( 'Person Type', 'ultimatewoo-pro' ),
					'public'       => false,
					'hierarchical' => false,
					'supports'     => false,
				)
		...
		register_post_type( 'bookable_resource',
			apply_filters( 'woocommerce_register_post_type_bookable_resource',
				array(
					'label'  => __( 'Resources', 'ultimatewoo-pro' ),
					'labels' => array(
							'name'               => __( 'Bookable resources', 'ultimatewoo-pro' ),
							'singular_name'      => __( 'Bookable resource', 'ultimatewoo-pro' ),
							'add_new'            => __( 'Add Resource', 'ultimatewoo-pro' ),
							'add_new_item'       => __( 'Add New Resource', 'ultimatewoo-pro' ),
							'edit'               => __( 'Edit', 'ultimatewoo-pro' ),
							'edit_item'          => __( 'Edit Resource', 'ultimatewoo-pro' ),
							'new_item'           => __( 'New Resource', 'ultimatewoo-pro' ),
							'view'               => __( 'View Resource', 'ultimatewoo-pro' ),
							'view_item'          => __( 'View Resource', 'ultimatewoo-pro' ),
							'search_items'       => __( 'Search Resource', 'ultimatewoo-pro' ),
							'not_found'          => __( 'No Resource found', 'ultimatewoo-pro' ),
							'not_found_in_trash' => __( 'No Resource found in trash', 'ultimatewoo-pro' ),
							'parent'             => __( 'Parent Resources', 'ultimatewoo-pro' ),
							'menu_name'          => _x( 'Resources', 'Admin menu name', 'ultimatewoo-pro' ),
							'all_items'          => __( 'Resources', 'ultimatewoo-pro' ),
						),
					'description' 			=> __( 'Bookable resources are bookable within a bookings product.', 'ultimatewoo-pro' ),
					'public' 				=> false,
					'show_ui' 				=> true,
		...
		register_post_type( 'wc_booking',
			apply_filters( 'woocommerce_register_post_type_wc_booking',
				array(
					'label'                      => __( 'Booking', 'ultimatewoo-pro' ),
					'labels'                     => array(
							'name'               => __( 'Bookings', 'ultimatewoo-pro' ),
							'singular_name'      => __( 'Booking', 'ultimatewoo-pro' ),
							'add_new'            => __( 'Add Booking', 'ultimatewoo-pro' ),
							'add_new_item'       => __( 'Add New Booking', 'ultimatewoo-pro' ),
							'edit'               => __( 'Edit', 'ultimatewoo-pro' ),
							'edit_item'          => __( 'Edit Booking', 'ultimatewoo-pro' ),
							'new_item'           => __( 'New Booking', 'ultimatewoo-pro' ),
							'view'               => __( 'View Booking', 'ultimatewoo-pro' ),
							'view_item'          => __( 'View Booking', 'ultimatewoo-pro' ),
							'search_items'       => __( 'Search Bookings', 'ultimatewoo-pro' ),
							'not_found'          => __( 'No Bookings found', 'ultimatewoo-pro' ),
							'not_found_in_trash' => __( 'No Bookings found in trash', 'ultimatewoo-pro' ),
							'parent'             => __( 'Parent Bookings', 'ultimatewoo-pro' ),
							'menu_name'          => _x( 'Bookings', 'Admin menu name', 'ultimatewoo-pro' ),
							'all_items'          => __( 'All Bookings', 'ultimatewoo-pro' ),
						),
					'description'                => __( 'This is where bookings are stored.', 'ultimatewoo-pro' ),
					'public'                     => false,
					'show_ui'                    => true,
					'capability_type'            => 'product',
					'map_meta_cap'               => true,
		...
		register_post_status( 'complete', array(
			'label'                     => '<span class="status-complete tips" data-tip="' . _x( 'Complete', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'Complete', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Complete <span class="count">(%s)</span>', 'Complete <span class="count">(%s)</span>', 'ultimatewoo-pro' ),
		) );
		register_post_status( 'paid', array(
			'label'                     => '<span class="status-paid tips" data-tip="' . _x( 'Paid &amp; Confirmed', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'Paid &amp; Confirmed', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Paid &amp; Confirmed <span class="count">(%s)</span>', 'Paid &amp; Confirmed <span class="count">(%s)</span>', 'ultimatewoo-pro' ),
		) );
		register_post_status( 'confirmed', array(
			'label'                     => '<span class="status-confirmed tips" data-tip="' . _x( 'Confirmed', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'Confirmed', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Confirmed <span class="count">(%s)</span>', 'Confirmed <span class="count">(%s)</span>', 'ultimatewoo-pro' ),
		) );
		register_post_status( 'unpaid', array(
			'label'                     => '<span class="status-unpaid tips" data-tip="' . _x( 'Un-paid', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'Un-paid', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
			'public'                    => true,
			'exclude_from_search'       => true,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Un-paid <span class="count">(%s)</span>', 'Un-paid <span class="count">(%s)</span>', 'ultimatewoo-pro' ),
		) );
		register_post_status( 'pending-confirmation', array(
			'label'                     => '<span class="status-pending tips" data-tip="' . _x( 'Pending Confirmation', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'Pending Confirmation', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Pending Confirmation <span class="count">(%s)</span>', 'Pending Confirmation <span class="count">(%s)</span>', 'ultimatewoo-pro' ),
		) );
		register_post_status( 'cancelled', array(
			'label'                     => '<span class="status-cancelled tips" data-tip="' . _x( 'Cancelled', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'Cancelled', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Cancelled <span class="count">(%s)</span>', 'Cancelled <span class="count">(%s)</span>', 'ultimatewoo-pro' ),
		) );
		register_post_status( 'in-cart', array(
			'label'                     => '<span class="status-incart tips" data-tip="' . _x( 'In Cart', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'In Cart', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
			'public'                    => false,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => false,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'In Cart <span class="count">(%s)</span>', 'In Cart <span class="count">(%s)</span>', 'ultimatewoo-pro' ),
		) );
		...
		if ( class_exists( 'WC_Deposits' ) && is_admin()
			...
			register_post_status( 'wc-partial-payment', array(
				'label'                     => '<span class="status-partial-payment tips" data-tip="' . _x( 'Partially Paid', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '">' . _x( 'Partially Paid', 'ultimatewoo-pro', 'ultimatewoo-pro' ) . '</span>',
				'public'                    => true,
				'exclude_from_search'       => false,
				'show_in_admin_all_list'    => true,
				'show_in_admin_status_list' => true,
	...
	public function init_bookings_settings( $settings ) {
		...
		$bookings_settings = array(
			array(
				'title'   => __( 'Enable Bookings Timezone calculation', 'ultimatewoo-pro' ),
				'desc'    => __( 'Schedule Bookings events, such as reminder emails and auto-completions of bookings, using your site’s configured timezone.', 'ultimatewoo-pro' ),
	...
	public function plugin_row_meta( $links, $file ) {
		if ( plugin_basename( WC_BOOKINGS_MAIN_FILE ) == $file ) {
			$row_meta = array(
				'docs'		=> '<a href="' . esc_url( apply_filters( 'woocommerce_bookings_docs_url', 'https://docs.woocommerce.com/documentation/plugins/woocommerce/woocommerce-extensions/woocommerce-bookings/' ) ) . '" title="' . esc_attr( __( 'View Documentation', 'ultimatewoo-pro' ) ) . '">' . __( 'Docs', 'ultimatewoo-pro' ) . '</a>',
				'support'	=> '<a href="' . esc_url( apply_filters( 'woocommerce_bookings_support_url', 'https://woocommerce.com/my-account/tickets/' ) ) . '" title="' . esc_attr( __( 'Visit Premium Customer Support', 'ultimatewoo-pro' ) ) . '">' . __( 'Premium Support', 'ultimatewoo-pro' ) . '</a>',
			);
