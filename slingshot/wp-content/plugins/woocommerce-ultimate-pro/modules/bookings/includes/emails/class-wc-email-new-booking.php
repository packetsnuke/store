...
class WC_Email_New_Booking extends WC_Email {
	...
	public function __construct() {
		...
		$this->id                   = 'new_booking';
		$this->title                = __( 'New Booking', 'ultimatewoo-pro' );
		$this->description          = __( 'New booking emails are sent to the admin when a new booking is created and paid. This email is also received when a Pending confirmation booking is created.', 'ultimatewoo-pro' );

		$this->heading              = __( 'New booking', 'ultimatewoo-pro' );
		$this->heading_confirmation = __( 'Confirm booking', 'ultimatewoo-pro' );
		$this->subject              = __( '[{blogname}] New booking for {product_title} (Order {order_number}) - {order_date}', 'ultimatewoo-pro' );
		$this->subject_confirmation = __( '[{blogname}] A new booking for {product_title} (Order {order_number}) is awaiting your approval - {order_date}', 'ultimatewoo-pro' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'subject_confirmation' => array(
				'title'         => __( 'Subject (Pending confirmation)', 'ultimatewoo-pro' ),
				'type'          => 'text',
				'description'   => sprintf( __( 'This controls the email subject line for Pending confirmation bookings. Leave blank to use the default subject: <code>%s</code>.', 'ultimatewoo-pro' ), $this->subject_confirmation ),
				'placeholder'   => '',
				'default'       => ''
			),
			'heading' => array(
			...
			'heading_confirmation' => array(
				'title'         => __( 'Email Heading (Pending confirmation)', 'ultimatewoo-pro' ),
				'type'          => 'text',
				'description'   => sprintf( __( 'This controls the main heading contained within the email notification for Pending confirmation bookings. Leave blank to use the default heading: <code>%s</code>.', 'ultimatewoo-pro' ), $this->heading_confirmation ),
				'placeholder'   => '',
				'default'       => ''
			),
			'email_type' => array(
