<div class="wrap woocommerce">
	<h2><?php _e( 'Bookings by month', 'ultimatewoo-pro' ); ?></h2>
	...
	<form method="get" id="mainform" enctype="multipart/form-data" class="wc_bookings_calendar_form">
		...
		<div class="tablenav">
			...
			<div class="views">
				<a class="day" href="<?php echo esc_url( add_query_arg( 'view', 'day' ) ); ?>"><?php _e( 'Day View', 'ultimatewoo-pro' ); ?></a>
			</div>
			...
			<thead>
				<tr>
					<?php for ( $ii = get_option( 'start_of_week', 1 ); $ii < get_option( 'start_of_week', 1 ) + 7; $ii ++ ) : ?>
						<th><?php echo date_i18n( _x( 'l', 'date format', 'ultimatewoo-pro' ), strtotime( "next sunday +{$ii} day" ) ); ?></th>
					<?php endfor; ?>
				</tr>
			</thead>
			<tbody>
