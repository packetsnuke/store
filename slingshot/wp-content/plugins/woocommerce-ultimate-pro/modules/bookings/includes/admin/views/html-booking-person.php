...
<div class="woocommerce_booking_person wc-metabox closed">
	<h3>
		<button type="button" class="unlink_booking_person button" rel="<?php echo esc_attr( $person_type->get_id() ); ?>"><?php _e( 'Unlink', 'ultimatewoo-pro' ); ?></button>
	...
	<table cellpadding="0" cellspacing="0" class="wc-metabox-content">
		<tbody>
			<tr>
				<td>
					<label><?php _e( 'Person Type Name', 'ultimatewoo-pro' ); ?>:</label>
					<input type="text" class="person_name" name="person_name[<?php echo $loop; ?>]" value="<?php echo esc_attr( $person_type->get_name( 'edit' ) ); ?>" placeholder="<?php _e( 'Name', 'ultimatewoo-pro' ) . $loop; ?>" />
				</td>
				<td>
					<label><?php _e( 'Base Cost', 'ultimatewoo-pro' ); ?>:</label>
				...
				<td>
					<label><?php _e( 'Block Cost', 'ultimatewoo-pro' ); ?>:</label>
			...
			<tr>
				<td>
					<label><?php _e( 'Description', 'ultimatewoo-pro' ); ?>:</label>
