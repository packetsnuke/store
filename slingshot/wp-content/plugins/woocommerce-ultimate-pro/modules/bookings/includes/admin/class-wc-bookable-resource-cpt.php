...
class WC_Bookable_Resource_CPT {
	...
	public function enter_title_here( $text, $post ) {
		if ( 'bookable_resource' === $post->post_type ) {
			return __( 'Bookable resource name', 'ultimatewoo-pro' );
		}
		return $text;
	}
	...
	public function edit_columns( $existing_columns ) {
		...
		$columns                     = array();
		$columns['resource_name']    = __( 'Name', 'ultimatewoo-pro' );
		$columns['parents']          = __( 'Parent products', 'ultimatewoo-pro' );
		$columns['resource_actions'] = __( 'Actions', 'ultimatewoo-pro' );
	...
	public function custom_columns( $column ) {
		...
		switch ( $column ) {
			...
			case 'parents' :
				...
				echo $parent_posts ? implode( ', ', $parent_posts ) : __( 'N/A', 'ultimatewoo-pro' );
			break;
