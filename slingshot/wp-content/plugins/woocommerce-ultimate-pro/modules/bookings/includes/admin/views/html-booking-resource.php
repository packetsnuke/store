...
<div class="woocommerce_booking_resource wc-metabox closed">
	<h3>
		<button type="button" class="remove_booking_resource button" rel="<?php echo esc_attr( absint( $resource->get_id() ) ); ?>"><?php _e( 'Remove', 'ultimatewoo-pro' ); ?></button>

		<a href="<?php echo admin_url( 'post.php?post=' . absint( $resource->get_id() ) . '&action=edit' ); ?>" target="_blank" class="edit_resource"><?php _e( 'Edit resource', 'ultimatewoo-pro' ); ?> &rarr;</a>
