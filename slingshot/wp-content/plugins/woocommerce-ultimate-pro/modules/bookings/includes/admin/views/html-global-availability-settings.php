...
if ( ! empty( $_POST['bookings_availability_submitted'] ) ) {
	...
	echo '<div class="updated"><p>' . __( 'Settings saved', 'ultimatewoo-pro' ) . '</p></div>';
}
?>
...
<form method="post" action="" id="bookings_settings">
	...
	<div id="poststuff">
		<div class="postbox">
			<h3 class="hndle"><?php _e( 'Global availability', 'ultimatewoo-pro' ); ?></h3>
			<div class="inside">
				<p class=""><?php _e( 'The availability rules you define here will affect all bookable products in your store.', 'ultimatewoo-pro' ); ?></p>
	...
	<p class="submit">
		<input type="submit" name="Submit" class="button-primary" value="<?php esc_attr_e( 'Save Changes', 'ultimatewoo-pro' ); ?>" />
	</p>
</form>