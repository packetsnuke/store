	...
	<form method="POST">
		<table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label><?php _e( 'Booking Data', 'ultimatewoo-pro' ); ?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">&nbsp;</th>
					<td>
						<input type="submit" name="create_booking_2" class="button-primary" value="<?php _e( 'Create Booking', 'ultimatewoo-pro' ); ?>" />
