...
class WC_Bookings_Admin {
	...
	public function bookings_debug_tools( $tools ) {
		$bookings_tools = array(
			'clean_person_types' => array(
				'name'     => __( 'Clean unused Person Types from DB', 'ultimatewoo-pro' ),
				'button'   => __( 'Clean Person Types', 'ultimatewoo-pro' ),
				'desc'     => __( 'This tool will clean the person types that are not used by any booking or a product.', 'ultimatewoo-pro' ),
	...
	public function register_tab( $tabs ) {
		...
		$tabs['bookings_availability'] = array(
			'label'  => __( 'Availability', 'ultimatewoo-pro' ),
		...
		$tabs['bookings_pricing'] = array(
			'label'  => __( 'Costs', 'ultimatewoo-pro' ),
	...
	public function post_updated_messages( $messages ) {
		$messages['wc_booking'] = array(
			...
			1  => __( 'Booking updated.', 'ultimatewoo-pro' ),
			2  => __( 'Custom field updated.', 'ultimatewoo-pro' ),
			3  => __( 'Custom field deleted.', 'ultimatewoo-pro' ),
			4  => __( 'Booking updated.', 'ultimatewoo-pro' ),
			5  => '',
			6  => __( 'Booking updated.', 'ultimatewoo-pro' ),
			7  => __( 'Booking saved.', 'ultimatewoo-pro' ),
			8  => __( 'Booking submitted.', 'ultimatewoo-pro' ),
			9  => '',
			10 => '',
		);
		return $messages;
	...
	public function booking_display( $item_id, $item, $product ) {
		...
		wc_get_template( 'order/admin/booking-display.php', array( 'booking_ids' => $booking_ids ), 'ultimatewoo-pro', WC_BOOKINGS_TEMPLATE_PATH );
	}
	...
	public function product_type_selector( $types ) {
		$types['booking'] = __( 'Bookable product', 'ultimatewoo-pro' );
		return $types;
	}
	...
	public function styles_and_scripts() {
		...
		$params = array(
			'i18n_remove_person'     => esc_js( __( 'Are you sure you want to remove this person type?', 'ultimatewoo-pro' ) ),
			'nonce_unlink_person'    => wp_create_nonce( 'unlink-bookable-person' ),
			'nonce_add_person'       => wp_create_nonce( 'add-bookable-person' ),
			'i18n_remove_resource'   => esc_js( __( 'Are you sure you want to remove this resource?', 'ultimatewoo-pro' ) ),
			'nonce_delete_resource'  => wp_create_nonce( 'delete-bookable-resource' ),
			'nonce_add_resource'     => wp_create_nonce( 'add-bookable-resource' ),
			'i18n_minutes'           => esc_js( __( 'minutes', 'ultimatewoo-pro' ) ),
			'i18n_hours'             => esc_js( __( 'hours', 'ultimatewoo-pro' ) ),
			'i18n_days'              => esc_js( __( 'days', 'ultimatewoo-pro' ) ),
			'i18n_new_resource_name' => esc_js( __( 'Enter a name for the new resource', 'ultimatewoo-pro' ) ),
	...
	public function booking_product_type_options( $options ) {
		return array_merge( $options, array(
			'wc_booking_has_persons' => array(
				...
				'label'         => __( 'Has persons', 'ultimatewoo-pro' ),
				'description'   => __( 'Enable this if this bookable product can be booked by a customer defined number of persons.', 'ultimatewoo-pro' ),
				'default'       => 'no',
			),
			'wc_booking_has_resources' => array(
				'id'            => '_wc_booking_has_resources',
				'wrapper_class' => 'show_if_booking',
				'label'         => __( 'Has resources', 'ultimatewoo-pro' ),
				'description'   => __( 'Enable this if this bookable product has multiple bookable resources, for example room types or instructors.', 'ultimatewoo-pro' ),
				'default'       => 'no',
			),
		) );
	}
