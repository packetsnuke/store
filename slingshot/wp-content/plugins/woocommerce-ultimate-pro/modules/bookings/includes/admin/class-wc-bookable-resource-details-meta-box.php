...
class WC_Bookable_Resource_Details_Meta_Box {
	...
	public function __construct() {
		...
		$this->title      = __( 'Resource details', 'ultimatewoo-pro' );
		$this->context    = 'normal';
		$this->priority   = 'high';
				...
				<div class="options_group">
					<?php
						woocommerce_wp_text_input( array(
							'id'                => '_wc_booking_qty',
							'label'             => __( 'Available Quantity', 'ultimatewoo-pro' ),
							'description'       => __( 'The quantity of this resource available at any given time.', 'ultimatewoo-pro' ),
								...
								<tr>
									<th colspan="6">
										<a href="#" class="button add_row" data-row="<?php
											...
											$html = ob_get_clean();
											echo esc_attr( $html );
										?>"><?php esc_html_e( 'Add Range', 'ultimatewoo-pro' ); ?></a>
