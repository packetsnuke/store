...
class WC_Braintree_API_Response_Message_Helper extends SV_WC_Payment_Gateway_API_Response_Message_Helper {
	...
	public function get_user_message( $message_id ) {
		...
		switch ( $message_id ) {
			...
			case 'paypal_closed':
				$message = __( 'Sorry, we cannot process your transaction. The PayPal account is either locked or closed. Please use a different account or a different payment method.', 'ultimatewoo-pro' );
				break;
