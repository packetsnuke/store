...
class WooCommerce_Order_Barcodes_Settings {
	...
	private function settings_fields () {
		...
		$type_options = array(
			'code39'		=> __( 'Code 39', 'ultimatewoo-pro' ),
			'code93'		=> __( 'Code 93', 'ultimatewoo-pro' ),
			'code128' 		=> __( 'Code 128', 'ultimatewoo-pro' ),
			'datamatrix'	=> __( 'Data Matrix', 'ultimatewoo-pro' ),
			'qr' 			=> __( 'QR Code', 'ultimatewoo-pro' ),
		);

		// Register settings fields
		$settings = array(
			array( 'title'	=> __( 'Order Barcodes', 'ultimatewoo-pro' ), 'type' => 'title', 'desc' => '', 'id' => 'order_barcodes' ),

			array(
				'title' 	=> __( 'Enable Barcodes', 'ultimatewoo-pro' ),
				'desc' 		=> __( 'This will enable unique barcode generation for each order.', 'ultimatewoo-pro' ),
			...
			array(
				'title' 	=> __( 'Barcode Type', 'ultimatewoo-pro' ),
				'desc' 		=> __( 'This is the type of barcode that will be generated for your orders - changing this will only affect future orders.', 'ultimatewoo-pro' ),
	...
	public function colour_settings () {
		?><tr valign="top" class="wc_order_barcodes_colours">
		    ...
		    <td class="forminp"><?php
	    		...
	    		$wc_settings_general->color_picker( __( 'Foreground', 'ultimatewoo-pro' ), 'wc_order_barcodes_colours_foreground', $colours['foreground'], __( 'Barcode image and text colour', 'ultimatewoo-pro' ) );
	    		$wc_settings_general->color_picker( __( 'Background', 'ultimatewoo-pro' ), 'wc_order_barcodes_colours_background', $colours['background'], __( 'Barcode background colour', 'ultimatewoo-pro' ) );
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="' . esc_url( admin_url( 'admin.php?page=wc-settings&tab=general' ) ) . '">' . __( 'Settings', 'ultimatewoo-pro' ) . '</a>';
