<tr valign="top" id="packing_options">
	<th scope="row" class="titledesc"><?php _e( 'Box Sizes', 'ultimatewoo-pro' ); ?></th>
	<td class="forminp">
		<style type="text/css">
		...
		<table class="fedex_boxes widefat">
			<thead>
				<tr>
					...
					<th><?php _e( 'Length', 'ultimatewoo-pro' ); ?></th>
					<th><?php _e( 'Width', 'ultimatewoo-pro' ); ?></th>
					<th><?php _e( 'Height', 'ultimatewoo-pro' ); ?></th>
			...
			<tfoot>
				<tr>
					...
					<th colspan="6">
						<small class="description"><?php _e( 'Items will be packed into these boxes depending based on item dimensions and volume. Dimensions will be passed to FedEx and used for packing. Items not fitting into boxes will be packed individually.', 'ultimatewoo-pro' ); ?></small>
					</th>
				</tr>
			</tfoot>
			<tbody id="rates">
