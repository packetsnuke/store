...
<p><?php _e( 'The following photo collection(s) has been added to your account:', 'ultimatewoo-pro' ); ?></p>
...
<p><?php echo sprintf( __( 'You can view your collections on the %s page.', 'ultimatewoo-pro' ), '<a href="' . get_permalink( wc_get_page_id( 'myaccount' ) ) . '">' . __( 'My Account', 'ultimatewoo-pro' ) . '</a>' ); ?></p>
