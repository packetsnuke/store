...
echo __( 'The following photo collection(s) has been added to your account:', 'ultimatewoo-pro' ) . "\n\n";
...
echo sprintf( __( 'You can view your collections on the My Account page: %s', 'ultimatewoo-pro' ), get_permalink( wc_get_page_id( 'myaccount' ) ) ) . "\n\n";
