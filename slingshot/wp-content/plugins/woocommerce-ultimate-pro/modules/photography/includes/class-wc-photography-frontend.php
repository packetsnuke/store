...
class WC_Photography_Frontend {
	...
	public function frontend_scripts() {
		...
		wp_enqueue_style( 'wc-photography-frontend', $photography_assets_path . 'css/frontend.css', array(), WC_Photography::VERSION, 'all' );
		...
		if ( is_tax( 'images_collections' ) ) {
			...
			wp_enqueue_script( 'wc-photography-collections', $photography_assets_path . 'js/frontend/collections' . $suffix . '.js', array( 'jquery' ), WC_Photography::VERSION, true );
		}

		if ( is_account_page() ) {
			$current_user = wp_get_current_user();

			wp_enqueue_script( 'wc-photography-my-collections', $photography_assets_path . 'js/frontend/my-collections' . $suffix . '.js', array( 'jquery' ), WC_Photography::VERSION, true );
			wp_localize_script(
