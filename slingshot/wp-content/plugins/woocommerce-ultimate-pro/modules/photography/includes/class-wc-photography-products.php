...
class WC_Photography_Products {
	...
	public function product_type( $types ) {
		$types['photography'] = __( 'Photograph', 'ultimatewoo-pro' );
	...
	public function add_to_order() {
		if ( is_tax( 'images_collections' ) ) {
			...
			if ( ! $was_added_to_cart && ! $quantity_set ) {
				wc_add_notice( __( 'Please choose the quantity of items you wish to add to your order&hellip;', 'ultimatewoo-pro' ), 'error' );
	...
	public function validate_before_add_to_cart( $valid, $product_id ) {
		...
		if ( 'photography' == $product_type->name ) {
			...
			wc_add_notice( __( 'You don\'t have permission to purchase this photo!', 'ultimatewoo-pro' ), 'error' );
			return false;
		}
