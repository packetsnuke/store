...
class WC_Photography_Admin {
	...
	public function admin_menu() {
		add_menu_page(
			__( 'Photography', 'ultimatewoo-pro' ),
			__( 'Photography', 'ultimatewoo-pro' ),
			'manage_photography',
			'wc-photography',
			'__return_false',
		...
		add_submenu_page(
			'wc-photography',
			__( 'Collections', 'ultimatewoo-pro' ),
			__( 'Collections', 'ultimatewoo-pro' ),
			'manage_photography',
		...
		add_submenu_page(
			'wc-photography',
			__( 'Add Photographs', 'ultimatewoo-pro' ),
			__( 'Add Photographs', 'ultimatewoo-pro' ),
			'manage_photography',
		...
		add_submenu_page(
			'wc-photography',
			__( 'Photography Settings', 'ultimatewoo-pro' ),
	...
	public function screen_ids( $screen_ids ) {
		$prefix       = sanitize_title( __( 'Photography', 'ultimatewoo-pro' ) );
	...
	public function get_plupload_args() {
		$args = array(
			...
			'filters'             => array(
				array(
					'title'      => __( 'Allowed Files', 'ultimatewoo-pro' ),
	...
	public function enqueue_scripts() {
		$screen        = get_current_screen();
		$screen_prefix = sanitize_title( __( 'Photography', 'ultimatewoo-pro' ) );
		...
		if ( $screen->id === $screen_prefix . '_page_wc-photography-batch-upload' ) {
			...
			wp_localize_script(
				...
				array(
					...
					'search_placeholder'       => __( 'Search for a collection&hellip;', 'ultimatewoo-pro' ),
					'loading'                  => __( 'Loading&hellip;', 'ultimatewoo-pro' ),
					'collection_error'         => __( 'An error occurred while creating the collection! Please try again.', 'ultimatewoo-pro' ),
					'edit_success_message'     => __( 'Photographs edited successfully!', 'ultimatewoo-pro' ),
		...
		if ( 'images_collections' == $screen->taxonomy ) {
			...
			wp_localize_script(
				...
				array(
					'upload_title' => __( 'Choose an image', 'ultimatewoo-pro' ),
					'upload_use'   => __( 'Use image', 'ultimatewoo-pro' ),
