...
class WC_Email_Photography_New_Collection extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'New Photography Collection', 'ultimatewoo-pro' );
		$this->description    = __( 'This email is sent to customers when you assign a collection to their account.', 'ultimatewoo-pro' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'heading' => array(
				...
				'type'        => 'text',
				'description' => sprintf( __( 'This controls the main heading contained within the email. Leave blank to use the default heading: <code>%s</code>.', 'ultimatewoo-pro' ), $this->heading ),
				'placeholder' => '',
				'default'     => ''
			),
			'email_type' => array(
