...
class WC_Store_Catalog_PDF_Download_Frontend {
	...
	public function __construct() {
		...
		$this->link_label = get_option( 'wc_store_catalog_pdf_download_link_label', __( 'Download Catalog', 'ultimatewoo-pro' ) );
	...
	public function load_scripts_styles() {
		...
		wp_enqueue_style( 'wc-store-catalog-pdf-download-style', ULTIMATEWOO_MODULES_URL . 'pdf-catalog/assets/css/frontend-styles.css' );

		wp_enqueue_script( 'wc-store-catalog-pdf-download-js', ULTIMATEWOO_MODULES_URL . 'pdf-catalog/assets/js/frontend' . $suffix . '.js' );
