...
if ( is_woocommerce_active() ) {
	...
	function plugin_action_links( $actions ) {
		...
		$custom_actions['docs'] = sprintf( '<a href="%s">%s</a>', 'https://docs.woocommerce.com/document/wc-brands/', __( 'Docs', 'ultimatewoo-pro' ) );

		// support url
		$custom_actions['support'] = sprintf( '<a href="%s">%s</a>', 'https://support.woocommerce.com/', __( 'Support', 'ultimatewoo-pro' ) );

		// changelog link
		$custom_actions['changelog'] = sprintf( '<a href="%s" target="_blank">%s</a>', 'https://www.woocommerce.com/changelogs/woocommerce-brands/changelog.txt', __( 'Changelog', 'ultimatewoo-pro' ) );
