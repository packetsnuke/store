...
class WC_Brands {
	...
	public function post_type_link( $permalink, $post ) {
		...
		if ( empty( $terms ) ) {
			...
			$product_brand = _x( 'uncategorized', 'slug', 'ultimatewoo-pro' );
		} else {
	...
	public function add_coupon_error_message( $err, $err_code, $coupon_obj ) {
		if ( self::E_WC_COUPON_EXCLUDED_BRANDS == $err_code ) {
			...
			$err = sprintf( __( 'Sorry, this coupon is not applicable to the brands: %s.', 'ultimatewoo-pro' ), implode( ', ', array_unique( $brands ) ) );
		}
		return $err;
	}
	...
	public static function init_taxonomy() {
		...
		register_taxonomy( 'product_brand',
			...
			apply_filters( 'register_taxonomy_product_brand', array(
				...
				'label'                 => __( 'Brands', 'ultimatewoo-pro'),
				'labels'                => array(
						'name'              => __( 'Brands', 'ultimatewoo-pro' ),
						'singular_name'     => __( 'Brand', 'ultimatewoo-pro' ),
						'search_items'      => __( 'Search Brands', 'ultimatewoo-pro' ),
						'all_items'         => __( 'All Brands', 'ultimatewoo-pro' ),
						'parent_item'       => __( 'Parent Brand', 'ultimatewoo-pro' ),
						'parent_item_colon' => __( 'Parent Brand:', 'ultimatewoo-pro' ),
						'edit_item'         => __( 'Edit Brand', 'ultimatewoo-pro' ),
						'update_item'       => __( 'Update Brand', 'ultimatewoo-pro' ),
						'add_new_item'      => __( 'Add New Brand', 'ultimatewoo-pro' ),
						'new_item_name'     => __( 'New Brand Name', 'ultimatewoo-pro' )
				),
				...
				'rewrite' => array( 'slug' => $category_base . __( 'brand', 'ultimatewoo-pro' ), 'with_front' => false, 'hierarchical' => true )
			) )
		);
	}
