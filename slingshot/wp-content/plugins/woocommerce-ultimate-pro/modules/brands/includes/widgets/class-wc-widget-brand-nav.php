...
class WC_Widget_Brand_Nav extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Shows brands in a widget which lets you narrow down the list of products when viewing products.', 'ultimatewoo-pro' );
		$this->widget_id          = 'woocommerce_brand_nav';
		$this->widget_name        = __('WooCommerce Brand Layered Nav', 'ultimatewoo-pro' );
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( empty( $new_instance['title'] ) )
			$new_instance['title'] = __( 'Brands', 'ultimatewoo-pro' );
	...
	protected function layered_nav_dropdown( $terms, $taxonomy ) {
		...
		if ( $taxonomy !== $this->get_current_taxonomy() ) {
			...
			echo '<option value="">' . __( 'Any Brand', 'ultimatewoo-pro' ) . '</option>';
