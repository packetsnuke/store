...
class WC_Widget_Brand_Description extends WP_Widget {
	...
	function __construct() {
		...
		$this->woo_widget_name        = __('WooCommerce Brand Description', 'ultimatewoo-pro' );
		$this->woo_widget_description = __( 'When viewing a brand archive, show the current brands description.', 'ultimatewoo-pro' );
