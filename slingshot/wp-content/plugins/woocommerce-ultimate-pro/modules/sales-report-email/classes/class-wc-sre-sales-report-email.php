...
class WC_SRE_Sales_Report_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title       = __( 'Sales Reports', 'ultimatewoo-pro' );
		$this->description = __( 'The Sales Report Emails plugin extends WooCommerce by emailing you a daily, weekly or monthly sales report.', 'ultimatewoo-pro' );
	...
	private function init() {
		...
		// Subject & heading
		$this->subject = __( 'Sales Report of {site_title}', 'ultimatewoo-pro' );
		$this->heading = __( 'Your {interval} report of {site_title}', 'ultimatewoo-pro' );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'recipients' => array(
				'title'       => __( 'Recipients', 'ultimatewoo-pro' ),
				'type'        => 'text',
				'description' => __( 'The email addresses reports are sent to, separated by commas.', 'ultimatewoo-pro' ),
				'default'     => '',
			),
			'interval'   => array(
				'title'       => __( 'Interval', 'ultimatewoo-pro' ),
				'type'        => 'select',
				'options'     => array(
					'daily'   => __( 'Daily', 'ultimatewoo-pro' ),
					'weekly'  => __( 'Weekly', 'ultimatewoo-pro' ),
					'monthly' => __( 'Monthly', 'ultimatewoo-pro' )
				),
				'description' => __( 'The frequency of which reports should be sent.', 'ultimatewoo-pro' ),
			),

			// Send time
			'send_time' => array(
				'title' 	  => __( 'Send Email At', 'ultimatewoo-pro' ),
				'type' 		  => 'select',
				'description' => __( 'Choose the time of day to send out the sales report (based on the interval above).', 'ultimatewoo-pro' ),
				'default' 	  => '03:00',
