...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php echo esc_html_x( 'Quantity', 'table headings in notification email', 'ultimatewoo-pro' ); ?></th>
				<th class="product-total"><?php echo esc_html_x( 'Totals', 'table headings in notification email', 'ultimatewoo-pro' ); ?></th>
			</tr>
		</thead>
		<tfoot>
		<?php
	...
	<div id="payment">
		<?php $pay_order_button_text = apply_filters( 'woocommerce_change_payment_button_text', _x( 'Change Payment Method', 'text on button on checkout page', 'ultimatewoo-pro' ) );
		...
		<div class="woocommerce-error">
			<p> <?php esc_html_e( 'Sorry, it seems no payment gateways support changing the recurring payment method. Please contact us if you require assistance or to make alternate arrangements.', 'ultimatewoo-pro' ); ?></p>
		</div>
				<?php } ?>
