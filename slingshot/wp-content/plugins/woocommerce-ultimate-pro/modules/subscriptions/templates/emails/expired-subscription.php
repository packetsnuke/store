...
<p>
	...
	printf( esc_html__( 'A subscription belonging to %1$s has expired. Their subscription\'s details are as follows:', 'ultimatewoo-pro' ), esc_html( $subscription->get_formatted_billing_full_name() ) );
	?>
</p>
...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		<tr>
			...
			<th class="td" scope="col" style="text-align:left;"><?php echo esc_html_x( 'End Date', 'table headings in notification email', 'ultimatewoo-pro' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<tr>
