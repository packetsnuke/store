...
<p>
	...
	echo esc_html( sprintf( _x( 'The automatic recurring payment for order #%d from %s has failed. The payment will be retried %3$s.', 'In customer renewal invoice email', 'ultimatewoo-pro' ), $order->get_order_number(), $order->get_formatted_billing_full_name(), strtolower( wcs_get_human_time_diff( $retry->get_time() ) ) ) );
	?>
</p>
<p><?php esc_html_e( 'The renewal order is as follows:', 'ultimatewoo-pro' ); ?></p>
