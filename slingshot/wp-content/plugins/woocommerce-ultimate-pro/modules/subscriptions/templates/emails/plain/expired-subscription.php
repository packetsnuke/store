...
printf( __( 'A subscription belonging to %1$s has expired. Their subscription\'s details are as follows:', 'ultimatewoo-pro' ), $subscription->get_formatted_billing_full_name() );
...
if ( ! empty( $end_time ) ) {
	...
	echo sprintf( __( 'End Date: %s', 'ultimatewoo-pro' ), date_i18n( wc_date_format(), $end_time ) ) . "\n";
}
