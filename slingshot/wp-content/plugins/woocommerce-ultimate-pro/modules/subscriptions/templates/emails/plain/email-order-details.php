...
if ( 'order' == $order_type ) {
	...
	echo sprintf( __( 'Order date: %s', 'ultimatewoo-pro' ), wcs_format_datetime( wcs_get_objects_property( $order, 'date_created' ) ) ) . "\n";
} else {
	echo sprintf( __( 'Subscription Number: %s', 'ultimatewoo-pro' ), $order->get_order_number() ) . "\n";
}
