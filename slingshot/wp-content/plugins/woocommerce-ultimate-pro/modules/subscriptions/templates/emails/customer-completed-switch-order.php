...
<p>
	...
	printf( esc_html__( 'Hi there. You have successfully changed your subscription items on %s. Your new order and subscription details are shown below for your reference:', 'ultimatewoo-pro' ), esc_html( get_option( 'blogname' ) ) );
	?>
</p>
...
<h2><?php echo esc_html__( 'New Subscription Details', 'ultimatewoo-pro' ); ?></h2>
