...
<tr class="variable_subscription_pricing show_if_variable-subscription">
	<td colspan="2">
		...
		woocommerce_wp_text_input( array(
			...
			// translators: placeholder is a currency symbol / code
			'label'         => sprintf( __( 'Subscription Price (%s)', 'ultimatewoo-pro' ), get_woocommerce_currency_symbol() ),
		...
		woocommerce_wp_select( array(
			...
			'label'         => __( 'Subscription Periods', 'ultimatewoo-pro' ),
		...
		woocommerce_wp_select( array(
			...
			'label'         => __( 'Billing Period', 'ultimatewoo-pro' ),
			'value'         => $subscription_period,
			'description'   => _x( 'for', 'Edit product screen, between the Billing Period and Subscription Length dropdowns', 'ultimatewoo-pro' ),
		...
		woocommerce_wp_select( array(
			...
			'label'         => __( 'Subscription Length', 'ultimatewoo-pro' ),
...
?>	</td>
	<td colspan="1" class="show_if_variable-subscription">
		<label><?php esc_html_e( 'Free Trial', 'ultimatewoo-pro' ); ?></label>
<?php
		// Trial Length
		woocommerce_wp_text_input( array(
			...
			'label'         => __( 'Free Trial', 'ultimatewoo-pro' ),
			'placeholder'   => _x( 'e.g. 3', 'example number of days / weeks / months', 'ultimatewoo-pro' ),
		...
		woocommerce_wp_select( array(
			...
			'label'         => __( 'Subscription Trial Period', 'ultimatewoo-pro' ),
			...
			'description'   => sprintf( _x( 'An optional period of time to wait before charging the first recurring payment. Any sign up fee will still be charged at the outset of the subscription. %s', 'Trial period dropdown\'s description in pricing fields', 'ultimatewoo-pro' ), self::get_trial_period_validation_message() ),
			'desc_tip'      => true,
