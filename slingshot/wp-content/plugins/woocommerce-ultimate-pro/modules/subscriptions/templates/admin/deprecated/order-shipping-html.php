...
<div class="total_row shipping_row" data-order_item_id="<?php echo esc_attr( $item_id ); ?>">
	<p class="wide">
		<input type="text" name="recurring_shipping_method_title[<?php echo $item_id ? esc_attr( $item_id ) : 'new][]'; ?>]" placeholder="<?php esc_attr_e( 'Label', 'ultimatewoo-pro' ); ?>" value="<?php echo esc_attr( $shipping_title ); ?>" class="first" />
	...
	<p class="first">
		<select name="recurring_shipping_method[<?php echo $item_id ? esc_attr( $item_id ) : 'new][]'; ?>]" class="first">
			<optgroup label="<?php esc_html_e( 'Shipping Method', 'ultimatewoo-pro' ); ?>">
				<option value=""><?php echo esc_html_x( 'N/A', 'no information about something', 'ultimatewoo-pro' ); ?></option>
				<?php
				$found_method 	= false;
				...
				if ( ! $found_method && ! empty( $chosen_method ) ) {
					echo '<option value="' . esc_attr( $chosen_method ) . '" selected="selected">' . esc_html__( 'Other', 'ultimatewoo-pro' ) . '</option>';
				} else {
					echo '<option value="other">' . esc_html__( 'Other', 'ultimatewoo-pro' ) . '</option>';
				}
				?>
			</optgroup>
		</select>
