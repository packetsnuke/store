...
class WCS_Retry_Post_Store extends WCS_Retry_Store {
	...
	public function init() {
		register_post_type( self::$post_type, array(
			'description'  => __( 'Payment retry posts store details about the automatic retry of failed renewal payments.', 'ultimatewoo-pro' ),
			'public'       => false,
			'map_meta_cap' => true,
			'hierarchical' => false,
			...
			'ep_mask'      => EP_NONE,
			'labels'       => array(
					'name'               => _x( 'Renewal Payment Retries', 'Post type name', 'ultimatewoo-pro' ),
					'singular_name'      => __( 'Renewal Payment Retry', 'ultimatewoo-pro' ),
					'menu_name'          => _x( 'Renewal Payment Retries', 'Admin menu name', 'ultimatewoo-pro' ),
					'add_new'            => __( 'Add', 'ultimatewoo-pro' ),
					'add_new_item'       => __( 'Add New Retry', 'ultimatewoo-pro' ),
					'edit'               => __( 'Edit', 'ultimatewoo-pro' ),
					'edit_item'          => __( 'Edit Retry', 'ultimatewoo-pro' ),
					'new_item'           => __( 'New Retry', 'ultimatewoo-pro' ),
					'view'               => __( 'View Retry', 'ultimatewoo-pro' ),
					'view_item'          => __( 'View Retry', 'ultimatewoo-pro' ),
					'search_items'       => __( 'Search Renewal Payment Retries', 'ultimatewoo-pro' ),
					'not_found'          => __( 'No retries found', 'ultimatewoo-pro' ),
					'not_found_in_trash' => __( 'No retries found in trash', 'ultimatewoo-pro' ),
				),
			)
	 	);
	}
