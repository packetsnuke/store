...
class WCS_Webhooks {
	...
	public static function add_topics_admin_menu( $topics ) {
		...
		$front_end_topics = array(
			'subscription.created'  => __( ' Subscription Created', 'ultimatewoo-pro' ),
			'subscription.updated'  => __( ' Subscription Updated', 'ultimatewoo-pro' ),
			'subscription.deleted'  => __( ' Subscription Deleted', 'ultimatewoo-pro' ),
			'subscription.switched' => __( ' Subscription Switched', 'ultimatewoo-pro' ),
		);
