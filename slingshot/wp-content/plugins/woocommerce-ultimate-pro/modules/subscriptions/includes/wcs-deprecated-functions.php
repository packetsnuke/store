...
function wcs_get_subscription_from_key( $subscription_key ) {
	...
	if ( ! is_object( $subscription ) ) {
		...
		throw new InvalidArgumentException( sprintf( __( 'Could not get subscription. Most likely the subscription key does not refer to a subscription. The key was: "%s".', 'ultimatewoo-pro' ), $subscription_key ) );
	}
