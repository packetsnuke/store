...
class WCS_Email_Expired_Subscription extends WC_Email {
	...
	function __construct() {
		...
		$this->title       = __( 'Expired Subscription', 'ultimatewoo-pro' );
		$this->description = __( 'Expired Subscription emails are sent when a customer\'s subscription expires.', 'ultimatewoo-pro' );

		$this->heading     = __( 'Subscription Expired', 'ultimatewoo-pro' );
		// translators: placeholder is {blogname}, a variable that will be substituted when email is sent out
		$this->subject     = sprintf( _x( '[%s] Subscription Expired', 'default email subject for expired emails sent to the admin', 'ultimatewoo-pro' ), '{blogname}' );
