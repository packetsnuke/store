...
class WCS_Email_Completed_Switch_Order extends WC_Email_Customer_Completed_Order {
	...
	function __construct() {
		...
		$this->title          = __( 'Subscription Switch Complete', 'ultimatewoo-pro' );
		$this->description    = __( 'Subscription switch complete emails are sent to the customer when a subscription is switched successfully.', 'ultimatewoo-pro' );
		$this->customer_email = true;

		$this->heading        = __( 'Your subscription change is complete', 'ultimatewoo-pro' );
		$this->subject        = __( 'Your {blogname} subscription change from {order_date} is complete', 'ultimatewoo-pro' );
		...
		// Other settings
		$this->heading_downloadable = $this->get_option( 'heading_downloadable', __( 'Your subscription change is complete - download your files', 'ultimatewoo-pro' ) );
		$this->subject_downloadable = $this->get_option( 'subject_downloadable', __( 'Your {blogname} subscription change from {order_date} is complete - download your files', 'ultimatewoo-pro' ) );
