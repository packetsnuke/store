...
class WCS_Email_New_Renewal_Order extends WC_Email_New_Order {
	...
	function __construct() {
		...
		$this->title          = __( 'New Renewal Order', 'ultimatewoo-pro' );
		$this->description    = __( 'New renewal order emails are sent when a subscription renewal payment is processed.', 'ultimatewoo-pro' );

		$this->heading        = __( 'New subscription renewal order', 'ultimatewoo-pro' );
		$this->subject        = __( '[{blogname}] New subscription renewal order ({order_number}) - {order_date}', 'ultimatewoo-pro' );
