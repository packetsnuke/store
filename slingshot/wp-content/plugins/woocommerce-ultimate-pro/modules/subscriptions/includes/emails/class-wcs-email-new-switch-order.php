...
class WCS_Email_New_Switch_Order extends WC_Email_New_Order {
	...
	function __construct() {
		...
		$this->title          = __( 'Subscription Switched', 'ultimatewoo-pro' );
		$this->description    = __( 'Subscription switched emails are sent when a customer switches a subscription.', 'ultimatewoo-pro' );

		$this->heading        = __( 'Subscription Switched', 'ultimatewoo-pro' );
		$this->subject        = __( '[{blogname}] Subscription Switched ({order_number}) - {order_date}', 'ultimatewoo-pro' );
