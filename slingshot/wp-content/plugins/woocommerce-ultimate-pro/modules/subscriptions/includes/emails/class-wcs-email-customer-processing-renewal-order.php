...
class WCS_Email_Processing_Renewal_Order extends WC_Email_Customer_Processing_Order {
	...
	function __construct() {
		...
		$this->title          = __( 'Processing Renewal order', 'ultimatewoo-pro' );
		$this->description    = __( 'This is an order notification sent to the customer after payment for a subscription renewal order is completed. It contains the renewal order details.', 'ultimatewoo-pro' );
		$this->customer_email = true;

		$this->heading        = __( 'Thank you for your order', 'ultimatewoo-pro' );
		$this->subject        = __( 'Your {blogname} renewal order receipt from {order_date}', 'ultimatewoo-pro' );
