...
class WCS_Email_Customer_Renewal_Invoice extends WC_Email_Customer_Invoice {
	...
	function __construct() {
		...
		$this->subject        = __( 'Invoice for renewal order {order_number} from {order_date}', 'ultimatewoo-pro' );
		$this->heading        = __( 'Invoice for renewal order {order_number}', 'ultimatewoo-pro' );
