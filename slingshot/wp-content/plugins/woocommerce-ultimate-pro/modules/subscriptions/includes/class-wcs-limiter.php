...
class WCS_Limiter {
	...
	public static function admin_edit_product_fields() {
		...
		woocommerce_wp_select( array(
			...
			'label'       => __( 'Limit subscription', 'ultimatewoo-pro' ),
			// translators: placeholders are opening and closing link tags
			'description' => sprintf( __( 'Only allow a customer to have one subscription to this product. %sLearn more%s.', 'ultimatewoo-pro' ), '<a href="http://docs.woocommerce.com/document/subscriptions/store-manager-guide/#limit-subscription">', '</a>' ),
			'options'     => array(
				'no'      => __( 'Do not limit', 'ultimatewoo-pro' ),
				'active'  => __( 'Limit to one active subscription', 'ultimatewoo-pro' ),
				'any'     => __( 'Limit to one of any status', 'ultimatewoo-pro' ),
			),
		) );
		echo '</div>';
