...
class WC_Report_Retention_Rate extends WC_Admin_Report {
	...
	public function get_main_chart() {
		...
		switch ( $this->report_data->interval_period ) {
			case 'day':
				$x_axes_label = _x( 'Number of days after sign-up', 'X axis label on retention rate graph', 'ultimatewoo-pro' );
				break;
			case 'week':
				$x_axes_label = _x( 'Number of weeks after sign-up', 'X axis label on retention rate graph', 'ultimatewoo-pro' );
				break;
			case 'month':
				$x_axes_label = _x( 'Number of months after sign-up', 'X axis label on retention rate graph', 'ultimatewoo-pro' );
				break;
		}
					...
					main_chart = jQuery.plot(
						...
						series,
						{
							...
							yaxes: [ {
								...
								tickDecimals: 0,
								color: '#d4d9dc',
								axisLabel: "<?php echo esc_js( __( 'Unended Subscription Count', 'ultimatewoo-pro' ) ); ?>",
								axisLabelPadding: 18,
								font: {
									color: "#aaa"
								}
