...
class WC_Report_Subscription_By_Product extends WP_List_Table {
	...
	public function __construct() {
		parent::__construct( array(
			'singular'  => __( 'Product', 'ultimatewoo-pro' ),
			'plural'    => __( 'Products', 'ultimatewoo-pro' ),
			'ajax'      => false,
		) );
	}
	...
	public function no_items() {
		esc_html_e( 'No products found.', 'ultimatewoo-pro' );
	}
	...
	public function get_columns() {
		...
		$columns = array(
			'product_name'            => __( 'Subscription Product', 'ultimatewoo-pro' ),
			'subscription_count'      => sprintf( __( 'Subscription Count %s', 'ultimatewoo-pro' ), wcs_help_tip( __( 'The number of subscriptions that include this product as a line item and have a status other than pending or trashed.', 'ultimatewoo-pro' ) ) ),
			'average_recurring_total' => sprintf( __( 'Average Recurring Line Total %s', 'ultimatewoo-pro' ), wcs_help_tip( __( 'The average line total for this product on each subscription.', 'ultimatewoo-pro' ) ) ),
			'average_lifetime_value'  => sprintf( __( 'Average Lifetime Value %s', 'ultimatewoo-pro' ), wcs_help_tip( __( 'The average line total on all orders for this product line item.', 'ultimatewoo-pro' ) ) ),
		);
	 			...
	 			jQuery.plot(
					...
					],
					{
						...
						series: {
							...
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . esc_js( __( 'subscriptions', 'ultimatewoo-pro' ) ); ?>",
						},
						legend: {
							show: true,
