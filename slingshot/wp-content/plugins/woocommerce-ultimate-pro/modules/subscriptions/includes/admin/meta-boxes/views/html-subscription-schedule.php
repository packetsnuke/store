...
<div class="wc-metaboxes-wrapper">
	...
	<div id="billing-schedule">
		...
		<div class="billing-schedule-edit wcs-date-input"><?php
			...
			echo woocommerce_wp_select( array(
				...
				'label'       => __( 'Recurring:', 'ultimatewoo-pro' ),
		...
		<?php else : ?>
		<strong><?php esc_html_e( 'Recurring:', 'ultimatewoo-pro' ); ?></strong>
	...
	<?php endforeach; ?>
	<p><?php esc_html_e( 'Timezone:', 'ultimatewoo-pro' ); ?> <span id="wcs-timezone"><?php esc_html_e( 'Error: unable to find timezone of your browser.', 'ultimatewoo-pro' ); ?></span></p>
</div>
