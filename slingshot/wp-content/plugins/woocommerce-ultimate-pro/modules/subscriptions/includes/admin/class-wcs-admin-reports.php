	...
	public static function initialize_reports( $reports ) {
		...
		$reports['subscriptions'] = array(
			...
			'reports' => array(
				'subscription_events_by_date' => array(
					'title'       => __( 'Subscription Events by Date', 'ultimatewoo-pro' ),
					'description' => '',
					'hide_title'  => true,
					'callback'    => array( 'WC_Admin_Reports', 'get_report' ),
				),
				'upcoming_recurring_revenue' => array(
					'title'       => __( 'Upcoming Recurring Revenue', 'ultimatewoo-pro' ),
					'description' => '',
					'hide_title'  => true,
					'callback'    => array( 'WC_Admin_Reports', 'get_report' ),
				),
				'retention_rate' => array(
					'title'       => __( 'Retention Rate', 'ultimatewoo-pro' ),
					'description' => '',
					'hide_title'  => true,
					'callback'    => array( 'WC_Admin_Reports', 'get_report' ),
				),
				'subscription_by_product' => array(
					'title'       => __( 'Subscriptions by Product', 'ultimatewoo-pro' ),
					'description' => '',
					'hide_title'  => true,
					'callback'    => array( 'WC_Admin_Reports', 'get_report' ),
				),
				'subscription_by_customer' => array(
					'title'       => __( 'Subscriptions by Customer', 'ultimatewoo-pro' ),
					'description' => '',
					'hide_title'  => true,
					'callback'    => array( 'WC_Admin_Reports', 'get_report' ),
				),
		...
		if ( WCS_Retry_Manager::is_retry_enabled() ) {
			$reports['subscriptions']['reports']['subscription_payment_retry'] = array(
				'title'       => __( 'Failed Payment Retries', 'ultimatewoo-pro' ),
				'description' => '',
				'hide_title'  => true,
				'callback'    => array( 'WC_Admin_Reports', 'get_report' ),
			);
