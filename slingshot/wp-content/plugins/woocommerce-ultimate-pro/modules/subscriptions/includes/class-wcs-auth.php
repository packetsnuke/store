...
class WCS_Auth {
	...
	public function get_permissions_in_scope( $permissions, $scope ) {
		...
		switch ( $scope ) {
			case 'read' :
				$permissions[] = __( 'View subscriptions', 'ultimatewoo-pro' );
			break;
			case 'write' :
				$permissions[] = __( 'Create subscriptions', 'ultimatewoo-pro' );
			break;
			case 'read_write' :
				$permissions[] = __( 'View and manage subscriptions', 'ultimatewoo-pro' );
			break;
		}
