...
function woocommerce_bulk_variations_add_to_cart_message( $count ) {
	...
	if ( get_option( 'woocommerce_cart_redirect_after_add' ) == 'yes' ) :
		...
		$message   = sprintf( '<a href="%s" class="button">%s</a> %s', $return_to, __( 'Continue Shopping &rarr;', 'ultimatewoo-pro' ), sprintf( __( '%s products successfully added to your cart.', 'ultimatewoo-pro' ), $count ) );
	else :
		$message = sprintf( '<a href="%s" class="button">%s</a> %s', get_permalink( wc_get_page_id( 'cart' ) ), __( 'View Cart &rarr;', 'woocommerce' ), sprintf( __( '%s products successfully added to your cart.', 'ultimatewoo-pro' ), $count ) );
	endif;
