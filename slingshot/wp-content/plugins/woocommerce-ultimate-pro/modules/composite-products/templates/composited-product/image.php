...
?><div class="composited_product_images"><?php
	...
	if ( has_post_thumbnail( $product_id ) ) {
		...
		$html .= sprintf( '<a href="%1$s" class="placeholder_image zoom" data-rel="%3$s"><img class="wp-post-image" src="%1$s" alt="%2$s"/></a>', wc_placeholder_img_src(), __( 'Product placeholder image', 'ultimatewoo-pro' ), $image_rel );
		$html .= '</figure>';
	}
