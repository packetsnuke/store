...
class WC_CP_Meta_Box_Product_Data {
									...
									foreach ( $scenario_data[ 'component_data' ][ $component_id ] as $product_id_in_scenario ) {
										...
										if ( $product_id_in_scenario == -1 ) {
											...
											if ( $product_in_scenario->get_type() === 'variation' ) {
												...
												$selections_in_scenario[ $product_id_in_scenario ] = sprintf( _x( '%s &ndash; Any Variation', 'any product variation', 'ultimatewoo-pro' ), WC_CP_Helpers::get_product_title( $product_in_scenario ) );
											} else {
		...
		<div class="component_selection_details">
			<div class="form-field">
				...
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Title', 'ultimatewoo-pro' ); ?>
				...
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Description', 'ultimatewoo-pro' ); ?>
				...
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Thumbnail', 'ultimatewoo-pro' ); ?>
				...
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Price', 'ultimatewoo-pro' ); ?>
		...
		<div class="component_subtotal_visibility">
			<div class="form-field">
				...
				<div class="component_subtotal_visibility_option">
					...
					<span class="labelspan"><?php echo __( 'Composite', 'ultimatewoo-pro' ); ?>
				...
				<div class="component_subtotal_visibility_option">
					...
					<span class="labelspan"><?php echo __( 'Cart/checkout', 'ultimatewoo-pro' ); ?>
				...
				<div class="component_subtotal_visibility_option">
					...
					<span class="labelspan"><?php echo __( 'Order details', 'ultimatewoo-pro' ); ?>
			...
			<div class="form-field">
				...
				if ( ! empty( $component_options ) ) {
					...
					if ( false === $use_ajax ) {
						...
						?><select id="group_default_<?php echo $id; ?>" name="bto_data[<?php echo $id; ?>][default_id]" class="wc-product-search" style="width: 75%;" data-allow_clear="true" data-action="woocommerce_json_search_products_in_component" data-limit="100" data-include="<?php echo esc_attr( json_encode( array( 'composite_id' => $product_id, 'component_id' => $component_id ) ) ); ?>" data-placeholder="<?php echo  __( 'Search for a product&hellip;', 'ultimatewoo-pro' ); ?>">
							<option value=""><?php echo __( 'No default option&hellip;', 'ultimatewoo-pro' ); ?></option><?php
	...
	public static function composite_pricing_options() {
		...
		woocommerce_wp_checkbox( array(
			...
			'label'         => __( 'Hide Price', 'ultimatewoo-pro' ),
			'value'         => $composite_product_object->get_hide_shop_price( 'edit' ) ? 'yes' : 'no',
			'description'   => __( 'Disable all internal price calculations and hide the Composite price displayed in the shop catalog and product summary.', 'ultimatewoo-pro' ),
			'desc_tip'      => true
		) );
	}
	...
	public static function process_composite_data( $product ) {
		...
		if ( $product->is_type( 'composite' ) ) {
			...
			if ( ! defined( 'WC_CP_UPDATING' ) ) {
				...
				self::add_notice( __( 'Your changes have not been saved &ndash; please wait for the <strong>WooCommerce Composite Products Data Update</strong> routine to complete before creating new composite products or making changes to existing ones.', 'ultimatewoo-pro' ), 'error' );
			}
		}
	}
		...
		if ( isset( $posted_composite_data[ 'bto_data' ] ) ) {
			...
			foreach ( $posted_composite_data[ 'bto_data' ] as $row_id => $post_data ) {
				...
				if ( ! empty( $post_data[ 'title' ] ) ) {
					...
					$composite_data[ $group_id ][ 'title' ] = __( 'Untitled Component', 'ultimatewoo-pro' );
