...
class WC_Email_Customizer_Admin {
	...
	public function email_settings( $settings ) {
		...
		$customizer_settings[] = array(
			'title' => __( 'Customize!', 'ultimatewoo-pro' ),
			'desc'  => __( 'Customize Emails', 'ultimatewoo-pro' ),
	...
	public function send_email() {
		...
		$email_heading = __( 'HTML Email Template!', 'ultimatewoo-pro' );
		...
		$subject = wp_specialchars_decode( get_bloginfo( 'name' ), ENT_QUOTES ) . ' ' . __( 'Test Email Customizer Preview', 'ultimatewoo-pro' );

		$headers = array();

		$headers[] = sprintf( __( '%s', 'ultimatewoo-pro' ) . ' ' . wp_specialchars_decode( get_bloginfo( 'name' ), ENT_QUOTES ) . ' <' . $send_to_email . '>', 'From:' ) . PHP_EOL;
