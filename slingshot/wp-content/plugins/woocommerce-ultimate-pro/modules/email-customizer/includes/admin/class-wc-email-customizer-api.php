...
class WC_Email_Customizer_API {
	...
	public function email_footer_text( $text ) {
		return get_option( 'woocommerce_email_footer_text', __( 'WooCommece Email Customizer - Powered by WooCommerce and WordPress', 'ultimatewoo-pro' ) );
	}
	...
	public function enqueue_customizer_control_script() {
		...
		$localized_vars = array(
			...
			'error'              => __( 'Error, Try again!', 'ultimatewoo-pro' ),
			'success'            => __( 'Email Sent!', 'ultimatewoo-pro' ),
			'saveFirst'          => __( 'Please click on save/publish before sending the test email', 'ultimatewoo-pro' ),
		);
