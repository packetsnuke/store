...
if ( ! class_exists( 'WC_Email_Customizer' ) ) :
	...
	class WC_Email_Customizer {
		...
		public function __construct() {
			...
			define( 'WC_EMAIL_CUSTOMIZER_VERSION', '1.1.6' );
			define( 'WC_EMAIL_CUSTOMIZER_PATH', ULTIMATEWOO_MODULES_DIR . '/email-customizer' );
			define( 'WC_EMAIL_CUSTOMIZER_PLUGIN_URL', ULTIMATEWOO_MODULES_URL . '/email-customizer' );
		...
		public function load_plugin_textdomain() {
			$locale = apply_filters( 'wc_email_customizer_plugin_locale', get_locale(), 'ultimatewoo-pro' );
		...
		public function woocommerce_missing_notice() {
			echo '<div class="error"><p>' . sprintf( __( 'WooCommerce Email Customizer Plugin requires WooCommerce to be installed and active. You can download %s here.', 'ultimatewoo-pro' ), '<a href="http://www.woothemes.com/woocommerce/" target="_blank">WooCommerce</a>' ) . '</p></div>';
