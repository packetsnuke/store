...
define( 'WC_SHIPPING_UPS_VERSION', '3.2.7' );
...
class WC_Shipping_UPS_Init {
	...
	public function plugin_links( $links ) {
		$plugin_links = array(
			...
			'<a href="http://wcdocs.woothemes.com/user-guide/ups/">' . __( 'Docs', 'ultimatewoo-pro' ) . '</a>',
		);
	...
	public function wc_deactivated() {
		echo '<div class="error"><p>' . sprintf( __( 'WooCommerce UPS Shipping requires %s to be installed and active.', 'ultimatewoo-pro' ), '<a href="http://www.woothemes.com/woocommerce/" target="_blank">WooCommerce</a>' ) . '</p></div>';
	}
	...
	public function upgrade_notice() {
		...
		<div class="notice notice-success is-dismissible wc-ups-notice">
			<p><?php echo sprintf( __( 'UPS now supports shipping zones. The zone settings were added to a new UPS method on the "Rest of the World" Zone. See the zones %1$shere%2$s ', 'ultimatewoo-pro' ), '<a href="' . $zones_admin_url . '">', '</a>' ); ?></p>
		</div>
