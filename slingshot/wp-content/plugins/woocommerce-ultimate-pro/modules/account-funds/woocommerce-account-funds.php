...
if ( is_woocommerce_active() ) {
	...
	define( 'WC_ACCOUNT_FUNDS_VERSION', '2.1.6' );
	...
	class WC_Account_Funds {
		...
		public function plugin_action_links( $actions ) {
			return array_merge( array(
				'docs'      => sprintf( '<a href="%s">%s</a>', 'https://docs.woocommerce.com/document/account-funds/', __( 'Docs', 'ultimatewoo-pro' ) ),
				'support'   => sprintf( '<a href="%s">%s</a>', 'https://support.woocommerce.com/', __( 'Support', 'ultimatewoo-pro' ) ),
				'changelog' => sprintf( '<a href="%s" target="_blank">%s</a>', 'https://woocommerce.com/changelogs/woocommerce-account-funds/changelog.txt', __( 'Changelog', 'ultimatewoo-pro' ) )
			), $actions );
		}
