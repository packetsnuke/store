...
class WC_Account_Funds_Email_Account_Funds_Increase extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Account Funds Increase', 'ultimatewoo-pro' );
		$this->description    = __( 'This email is sent to the customer when account funds are manually increased.', 'ultimatewoo-pro' );

		$this->heading        = __( 'Your Account Funds Have Increased', 'ultimatewoo-pro' );
		$this->subject        = __( 'Account Funds Increase', 'ultimatewoo-pro' );
