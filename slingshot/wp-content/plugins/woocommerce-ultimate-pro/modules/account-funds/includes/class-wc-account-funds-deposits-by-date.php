...
class WC_Report_Deposits_By_Date extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		switch ( $this->chart_groupby ) {
			case 'day' :
				$average_deposits_title = sprintf( __( '%s average daily deposits', 'ultimatewoo-pro' ), '<strong>' . wc_price( $data->average_deposits ) . '</strong>' );
			break;
			case 'month' :
			default :
				$average_deposits_title = sprintf( __( '%s average monthly deposits', 'ultimatewoo-pro' ), '<strong>' . wc_price( $data->average_deposits ) . '</strong>' );
			break;
		}

		$legend[] = array(
			'title'            => sprintf( __( '%s total deposits in this period', 'ultimatewoo-pro' ), '<strong>' . wc_price( $data->deposit_amount ) . '</strong>' ),
			'placeholder'      => __( 'This is the sum of the order totals after any refunds and including shipping and taxes.', 'ultimatewoo-pro' ),
		...
		$legend[] = array(
			'title' => sprintf( __( '%s deposits made', 'ultimatewoo-pro' ), '<strong>' . absint( $data->deposit_count ) . '</strong>' ),
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						{
							label: "<?php echo esc_js( __( 'Number of deposits made', 'ultimatewoo-pro' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Average sales amount', 'ultimatewoo-pro' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Deposits amount', 'ultimatewoo-pro' ) ) ?>",
