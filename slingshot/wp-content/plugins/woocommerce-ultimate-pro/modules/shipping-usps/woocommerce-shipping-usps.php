...
if ( is_woocommerce_active() ) {
	...
	class WC_USPS {
		...
		public function plugin_action_links( $links ) {
			$plugin_links = array(
				'<a href="' . admin_url( 'admin.php?page=wc-settings&tab=shipping&section=usps' ) . '">' . __( 'Settings', 'ultimatewoo-pro' ) . '</a>',
				'<a href="http://support.woothemes.com/">' . __( 'Support', 'ultimatewoo-pro' ) . '</a>',
				'<a href="http://docs.woothemes.com/document/usps-shipping/">' . __( 'Docs', 'ultimatewoo-pro' ) . '</a>',
			);
		...
		public function upgrade_notice() {
			...
			<div class="notice notice-success is-dismissible wc-usps-notice">
				<p><?php echo sprintf( __( 'USPS now supports shipping zones. The zone settings were added to a new USPS method on the "Rest of the World" Zone. See the zones %1$shere%2$s ', 'ultimatewoo-pro' ), '<a href="' . $zones_admin_url . '">','</a>' ); ?></p>
			</div>
