		...
		<table class="usps_boxes widefat">
			<thead>
				<tr>
					...
					<th><?php _e( 'L', 'ultimatewoo-pro' ); ?> (in)</th>
					<th><?php _e( 'W', 'ultimatewoo-pro' ); ?> (in)</th>
					<th><?php _e( 'H', 'ultimatewoo-pro' ); ?> (in)</th>
					<th><?php _e( 'Inner L', 'ultimatewoo-pro' ); ?> (in)</th>
					<th><?php _e( 'Inner W', 'ultimatewoo-pro' ); ?> (in)</th>
					<th><?php _e( 'Inner H', 'ultimatewoo-pro' ); ?> (in)</th>
					<th><?php _e( 'Weight of Box', 'ultimatewoo-pro' ); ?> (lbs)</th>
					<th><?php _e( 'Max Weight', 'ultimatewoo-pro' ); ?> (lbs)</th>
					<th><?php _e( 'Letter', 'ultimatewoo-pro' ); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
					...
					<th colspan="8">
						<small class="description"><?php esc_html_e( 'Note: If you are using regional rates, A1, A2, B1, and B2 sizes will be defined for you.', 'ultimatewoo-pro' ); ?></small>
					</th>
				</tr>
			</tfoot>
			<tbody id="rates">
