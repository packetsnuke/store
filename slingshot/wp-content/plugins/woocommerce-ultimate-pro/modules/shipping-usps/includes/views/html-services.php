<tr valign="top" id="service_options">
	<th scope="row" class="titledesc"><?php esc_html_e( 'Services', 'ultimatewoo-pro' ); ?></th>
	<td class="forminp">
		<table class="usps_services widefat">
			<thead>
				<th class="sort">&nbsp;</th>
				<th><?php esc_html_e( 'Name', 'ultimatewoo-pro' ); ?></th>
				<th><?php esc_html_e( 'Service(s)', 'ultimatewoo-pro' ); ?></th>
				<th><?php printf( __( 'Price Adjustment (%s)', 'ultimatewoo-pro' ), get_woocommerce_currency_symbol() ); ?></th>
				<th><?php esc_html_e( 'Price Adjustment (%)', 'ultimatewoo-pro' ); ?></th>
			</thead>
			<tbody>
				<?php
					$sort = 0;
