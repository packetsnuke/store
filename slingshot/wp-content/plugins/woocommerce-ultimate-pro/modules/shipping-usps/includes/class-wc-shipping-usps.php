...
class WC_Shipping_USPS extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_description = __( 'The USPS extension obtains rates dynamically from the USPS API during cart/checkout.', 'ultimatewoo-pro' );
	...
	public function init_form_fields() {
		...
		$this->instance_form_fields = array(
			...
			'flat_rates' => array(
				...
				'type'        => 'title',
				'description' => __( 'These are USPS flat rate boxes services. They are not calculated using the USPS API.', 'ultimatewoo-pro' ),
			),
			...
			'flat_rate_express_title' => array(
				'title'       => __( 'Express Flat Rate Title', 'ultimatewoo-pro' ),
				'type'        => 'text',
				'description' => '',
				'default'     => '',
			...
			'flat_rate_priority_title' => array(
				'title'       => __( 'Priority Flat Rate Title', 'ultimatewoo-pro' ),
				'type'        => 'text',
				'description' => '',
				'default'     => '',
			...
			'standard_rates' => array(
				...
				'type'        => 'title',
				'description' => __( 'These are standard service rates pulled from the USPS API.', 'ultimatewoo-pro' ),
			),
			'enable_standard_services' => array(
				'title'       => __( 'Enable API Rates', 'ultimatewoo-pro' ),
				'label'       => __( 'Retrieve Standard Service rates from the USPS API', 'ultimatewoo-pro' ),
				'type'        => 'checkbox',
				'default'     => 'no',
				'desc_tip'    => true,
			...
			'origin' => array(
				'title'       => __( 'Origin Postcode (required)', 'ultimatewoo-pro' ),
				'type'        => 'text',
