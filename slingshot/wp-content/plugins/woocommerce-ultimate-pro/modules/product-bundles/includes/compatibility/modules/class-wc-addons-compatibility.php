	...
	public static function display_addons_disable_option( $loop, $product_id, $item_data, $post_id ) {
		...
		?><div class="disable_addons">
			<div class="form-field">
				<label for="disable_addons"><?php echo __( 'Disable Add-Ons', 'ultimatewoo-pro' ) ?></label>
				...
				<?php echo WC_PB_Core_Compatibility::wc_help_tip( __( 'Check this option to disable any Product Add-Ons associated with this bundled product.', 'ultimatewoo-pro' ) ); ?>
			</div>
		</div><?php
	}
