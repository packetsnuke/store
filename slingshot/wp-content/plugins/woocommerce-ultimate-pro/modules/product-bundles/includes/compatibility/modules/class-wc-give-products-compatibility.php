...
class WC_PB_Give_Products_Compatibility {
	...
	public static function init() {
		...
		if ( WC_PB_Core_Compatibility::is_wc_version_gte_2_7() ) {
			...
			add_action( 'woocommerce_order_given', array( __CLASS__, 'add_bundle_product_to_order_legacy' ) );
		}
	}
	...
	/**
	 * Legacy version of 'WC_PB_Give_Products_Compatibility::add_bundle_product_to_order()'.
	 *
	 * @since  5.2.0
	 *
	 * @param  int  $order_id
	 */
	public static function add_bundle_product_to_order_legacy( $order_id ) {
		...
		if ( $order_contains_bundle ) {
			self::regenerate_download_permissions_legacy( $order_id );
		}
	}
	...
	/**
	 * Legacy version of 'WC_PB_Give_Products_Compatibility::regenerate_download_permissions()'.
	 *
	 * @since  5.2.0
	 *
	 * @param  int  $order_id
	 */
	public static function regenerate_download_permissions_legacy( $order_id ) {
