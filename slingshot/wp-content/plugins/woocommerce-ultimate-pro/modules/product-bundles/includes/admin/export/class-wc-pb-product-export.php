...
class WC_PB_Product_Export {
	...
	public static function add_columns( $columns ) {
		...
		$columns[ 'wc_pb_bundled_items' ]             = __( 'Bundled Items (JSON-encoded)', 'ultimatewoo-pro' );
		$columns[ 'wc_pb_layout' ]                    = __( 'Bundle Layout', 'ultimatewoo-pro' );
		$columns[ 'wc_pb_editable_in_cart' ]          = __( 'Bundle Cart Editing', 'ultimatewoo-pro' );
		$columns[ 'wc_pb_sold_individually_context' ] = __( 'Bundle Sold Individually', 'ultimatewoo-pro' );
