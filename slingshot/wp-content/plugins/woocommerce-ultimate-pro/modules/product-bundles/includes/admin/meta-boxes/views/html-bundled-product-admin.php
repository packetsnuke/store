...
?><div class="wc-bundled-item wc-metabox <?php echo $toggle; ?>" rel="<?php echo $loop; ?>">
	<h3>
		...
		<div class="handle">
			<?php
				echo false !== $item_id ? ( '<small class="item-id" title="' . __( 'Bundled item ID', 'ultimatewoo-pro' ) . '">' . sprintf( _x( 'ID: %s', 'bundled product identifier', 'ultimatewoo-pro' ), $item_id ) . '</small>' ) : '';
			?>
