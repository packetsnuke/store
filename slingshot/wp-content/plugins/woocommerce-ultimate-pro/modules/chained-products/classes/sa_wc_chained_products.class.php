...
class SA_WC_Chained_Products {
	...
	public function __construct() {
		...
		self::$text_domain = 'ultimatewoo-pro';
	...
	public function enqueue_chained_products_js_css() {
		...
		wp_register_style( 'woocommerce_chained_products_css', ULTIMATEWOO_MODULES_URL . '/chained-products/assets/css/chained-products-admin.css' );
