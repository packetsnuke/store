...
echo sprintf( __( 'Order date: %s', 'ultimatewoo-pro' ), date_i18n( wc_date_format(), $order_timestamp ) ) . "\n";
...
echo esc_html__( 'Your details', 'ultimatewoo-pro' ) . "\n\n";

if ( $billing_email = SV_WC_Order_Compatibility::get_prop( $order, 'billing_email' ) ) {
	echo esc_html__( 'Email:', 'ultimatewoo-pro' ); echo $billing_email . "\n";
}

if ( $billing_phone = SV_WC_Order_Compatibility::get_prop( $order, 'billing_phone' ) ) {
	echo esc_html__( 'Tel:', 'ultimatewoo-pro' ); ?> <?php echo $billing_phone . "\n";
}
