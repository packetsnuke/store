	...
	public function __construct( $id, array $args ) {
		...
		switch ( $this->type ) {
			...
			case 'customer':
				...
				$this->heading           = __( 'Order has been updated', 'ultimatewoo-pro' );
				$this->subject           = __( 'Regarding your {site_title} order from {order_date}', 'ultimatewoo-pro' );
				$this->default_body_text = __( 'Your order is now {order_status}. Order details are shown below for your reference:', 'ultimatewoo-pro' );

				if ( ! $this->recipient ) {
					$this->recipient = __( 'Customer', 'ultimatewoo-pro' );
				}
			...
			case 'admin':
				...
				$this->heading           = __( 'Order has been updated', 'ultimatewoo-pro' );
				$this->subject           = __( '[{site_title}] Customer order ({order_number}) updated', 'ultimatewoo-pro' );
				$this->default_body_text = __( 'This order is now {order_status}. Order details are as follows:', 'ultimatewoo-pro' );
	...
	public function init_form_fields() {
		...
		$form_fields = array(
			...
			'body_text' => array(
				...
				'type'        => 'textarea',
				'description' => __( 'Optional email body text. You can use the following placeholders: <code>{order_date}, {order_number}, {order_status}, {billing_first_name}, {billing_last_name}, {billing_company}, {blogname}, {site_title}</code>', 'ultimatewoo-pro' ),
				'placeholder' => '',
