...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.6.4', __( 'WooCommerce Measurement Price Calculator', 'ultimatewoo-pro' ), __FILE__, 'init_woocommerce_measurement_price_calculator', array(
...
class WC_Measurement_Price_Calculator extends SV_WC_Plugin {
	...
	public function get_plugin_name() {
		return __( 'WooCommerce Measurement Price Calculator', 'ultimatewoo-pro' );
	}
