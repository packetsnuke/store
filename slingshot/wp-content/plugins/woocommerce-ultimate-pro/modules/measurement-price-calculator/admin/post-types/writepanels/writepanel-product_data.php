...
function wc_price_calculator_product_options_dimensions() {
	...
	woocommerce_wp_text_input( array( 'id' => '_area', 'label' => __( 'Area', 'ultimatewoo-pro' ) . ' (' . get_option( 'woocommerce_area_unit' ) . ')', 'description' => __( 'Overrides the area calculated from the width/length dimensions for the Measurements Price Calculator.', 'ultimatewoo-pro' ) ) );

	woocommerce_wp_text_input( array( 'id' => '_volume', 'label' => __( 'Volume', 'ultimatewoo-pro' ) . ' (' . get_option( 'woocommerce_volume_unit' ) . ')', 'description' => __( 'Overrides the volume calculated from the width/length/height dimensions for the Measurements Price Calculator.', 'ultimatewoo-pro' ) ) );
}
...
function wc_measurement_price_calculator_product_minimum_price() {
	...
	woocommerce_wp_text_input(
		array(
			...
			'label'             => sprintf( __( 'Minimum Price (%s)', 'ultimatewoo-pro' ), get_woocommerce_currency_symbol() ),
			'type'              => 'number',
