...
function wc_price_calculator_product_after_variable_attributes( $loop, $variation_data, $variation_post ) {
	...
	?>
		<p class="form-row form-row-first hide_if_variation_virtual">
			<label>
				<?php echo esc_html( 'Area', 'ultimatewoo-pro' ) . ' (' . esc_html( get_option( 'woocommerce_area_unit' ) ) . '):'; ?>
				<?php echo wc_help_tip( __( 'Overrides the area calculated from the width/length dimensions for the Measurements Price Calculator.', 'ultimatewoo-pro' ) ); ?>
			</label>
		...
		<p class="form-row form-row-last hide_if_variation_virtual">
			<label>
				<?php echo esc_html( 'Volume', 'ultimatewoo-pro' ) . ' (' . esc_html( get_option( 'woocommerce_volume_unit' ) ) . '):'; ?>
				<?php echo wc_help_tip( __( 'Overrides the volume calculated from the width/length/height dimensions for the Measurements Price Calculator.', 'ultimatewoo-pro' ) ); ?>
			</label>
