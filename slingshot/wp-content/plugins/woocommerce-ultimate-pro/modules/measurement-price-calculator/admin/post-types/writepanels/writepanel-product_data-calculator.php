...
function wc_price_calculator_product_rates_panel_tab() {
	echo '<li class="measurement_tab hide_if_grouped"><a href="#measurement_product_data"><span>' . __( 'Measurement', 'ultimatewoo-pro' ) . '</span></a></li>';
}
...
function wc_price_calculator_product_rates_panel_content() {
	...
	<div id="measurement_product_data" class="panel woocommerce_options_panel">
		...
		<div class="measurement-subnav">
			<a class="active" href="#calculator-settings"><?php esc_html_e( 'Calculator Settings', 'ultimatewoo-pro' ); ?></a> |
			<a class="wc-measurement-price-calculator-pricing-table" href="#calculator-pricing-table"><?php esc_html_e( 'Pricing Table', 'ultimatewoo-pro' ); ?></a>
		</div>
		<hr/>
		<?php
		...
		$calculator_options = array(
			...
			'area-surface'     => __( 'Surface Area 2(LW + LH + WH)', 'ultimatewoo-pro' ),
		...
		woocommerce_wp_select( array(
			...
			'label'       => __( 'Measurement', 'ultimatewoo-pro' ),
			'options'     => $calculator_options,
			'description' => __( 'Select the product measurement to calculate quantity by or define pricing within.', 'ultimatewoo-pro' ),
			'desc_tip'    => true,
		) );

		echo '<p id="area-dimension_description" class="measurement_description" style="display:none;">' .   __( "Use this measurement to have the customer prompted for a length and width to calculate the area required.  When pricing is disabled (no custom dimensions) this calculator uses the product area attribute or otherwise the length and width attributes to determine the product area.", 'ultimatewoo-pro' ) . '</p>';
		echo '<p id="area-linear_description" class="measurement_description" style="display:none;">' .      __( "Use this measurement to have the customer prompted for a length and width to calculate the linear distance (L * 2 + W * 2).", 'ultimatewoo-pro' ) . '</p>';
		echo '<p id="area-surface_description" class="measurement_description" style="display:none;">' .     __( "Use this measurement to have the customer prompted for a length, width and height to calculate the surface area 2 * (L * W + W * H + L * H).", 'ultimatewoo-pro' ) . '</p>';
		echo '<p id="volume-dimension_description" class="measurement_description" style="display:none;">' . __( "Use this measurement to have the customer prompted for a length, width and height to calculate the volume required.  When pricing is disabled (no custom dimensions) this calculator uses the product volume attribute or otherwise the length, width and height attributes to determine the product volume.", 'ultimatewoo-pro' ) . '</p>';
		...
		echo '<div id="dimension_measurements" class="measurement_fields">';
			woocommerce_wp_checkbox( array(
				...
				'label'         => __( 'Show Product Price Per Unit', 'ultimatewoo-pro' ),
				'description'   => __( 'Check this box to display product pricing per unit on the frontend', 'ultimatewoo-pro' ),
			) );
			echo '<div id="_measurement_dimension_pricing_fields" class="_measurement_pricing_fields" style="display:none;">';
				woocommerce_wp_text_input( array(
					...
					'label'       => __( 'Pricing Label', 'ultimatewoo-pro' ),
					'description' => __( 'Label to display next to the product price (defaults to pricing unit)', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_select( array(
					...
					'label'       => __( 'Pricing Unit', 'ultimatewoo-pro' ),
					'options'     => $measurement_units['dimension'],
					'description' => __( 'Unit to define pricing in', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_checkbox( array(
					...
					'label'         => __( 'Calculated Price', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define product pricing per unit and allow customers to provide custom measurements', 'ultimatewoo-pro' ),
				) );
				woocommerce_wp_checkbox( array(
					...
					'label'         => __( 'Calculated Weight', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define the product weight per unit and calculate the item weight based on the product dimension', 'ultimatewoo-pro' ),
				) );
				woocommerce_wp_checkbox( array(
					...
					'label'         => __( 'Calculated Inventory', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define inventory per unit and calculate inventory based on the product dimension', 'ultimatewoo-pro' ),
				) );
			...
			wc_measurement_price_calculator_wp_radio( array(
				...
				'label'       => __( 'Length', 'ultimatewoo-pro' ),
				'description' => __( 'Select to display the product length in the price calculator', 'ultimatewoo-pro' ),
			) );
			echo '<div id="_measurement_dimension_length_fields" style="display:none;">';
				woocommerce_wp_text_input( array(
					...
					'label'       => __( 'Length Label', 'ultimatewoo-pro' ),
					'description' => __( 'Length input field label to display on the frontend', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_select( array(
					'id'          => '_measurement_dimension_length_unit',
					'value'       => $settings['dimension']['length']['unit'] ,
					'label'       => __( 'Length Unit', 'ultimatewoo-pro' ),
					'options'     => $measurement_units['dimension'],
					'description' => __( 'The frontend length input field unit', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_checkbox( array(
					'id'          => '_measurement_dimension_length_editable',
					'value'       => $settings['dimension']['length']['editable'],
					'label'       => __( 'Length Editable', 'ultimatewoo-pro' ),
					'class'       => 'checkbox _measurement_editable',
					'description' => __( 'Check this box to allow the needed length to be entered by the customer', 'ultimatewoo-pro' ),
				) );
				wc_measurement_price_calculator_attributes_inputs( array(
					'measurement'   => 'dimension',
					'input_name'    => 'length',
					'input_label'   => __( 'Length', 'ultimatewoo-pro' ),
					'settings'      => $settings,
				...
				woocommerce_wp_text_input( array(
					...
					'label'         => __( 'Length Options', 'ultimatewoo-pro' ),
					'description'   => __( 'Use a single number to set a fixed value for this field on the frontend, or a comma-separated list of numbers to create a select box for the customer to choose between.  Example: 1/8, .5, 2', 'ultimatewoo-pro' ),
					'desc_tip'      => true,
				) );
			echo '</div>';
			echo '<hr/>';
			...
			wc_measurement_price_calculator_wp_radio( array(
				...
				'class'       => 'checkbox _measurement_dimension',
				'label'       => __( 'Width', 'ultimatewoo-pro' ),
				'description' => __( 'Select to display the product width in the price calculator', 'ultimatewoo-pro' ),
			) );
			echo '<div id="_measurement_dimension_width_fields" style="display:none;">';
				woocommerce_wp_text_input( array(
					...
					'label'       => __( 'Width Label', 'ultimatewoo-pro' ),
					'description' => __( 'Width input field label to display on the frontend', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_select( array(
					'id'          => '_measurement_dimension_width_unit',
					'value'       => $settings['dimension']['width']['unit'],
					'label'       => __( 'Width Unit', 'ultimatewoo-pro' ),
					'options'     => $measurement_units['dimension'],
					'description' => __( 'The frontend width input field unit', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_checkbox( array(
					'id'          => '_measurement_dimension_width_editable',
					'value'       => $settings['dimension']['width']['editable'],
					'label'       => __( 'Width Editable', 'ultimatewoo-pro' ),
					'class'       => 'checkbox _measurement_editable',
					'description' => __( 'Check this box to allow the needed width to be entered by the customer', 'ultimatewoo-pro' ),
				) );
				wc_measurement_price_calculator_attributes_inputs( array(
					'measurement'   => 'dimension',
					'input_name'    => 'width',
					'input_label'   => __( 'Width', 'ultimatewoo-pro' ),
					'settings'      => $settings,
				...
				woocommerce_wp_text_input( array(
					...
					'wrapper_class' => '_measurement_pricing_calculator_fields',
					'label'         => __( 'Width Options', 'ultimatewoo-pro' ),
					'description'   => __( 'Use a single number to set a fixed value for this field on the frontend, or a comma-separated list of numbers to create a select box for the customer to choose between.  Example: 1/8, .5, 2', 'ultimatewoo-pro' ),
					'desc_tip'      => true,
				) );
			echo '</div>';
			...
			wc_measurement_price_calculator_wp_radio( array(
				...
				'class'       => 'checkbox _measurement_dimension',
				'label'       => __( 'Height', 'ultimatewoo-pro' ),
				'description' => __( 'Select to display the product height in the price calculator', 'ultimatewoo-pro' ),
			) );
			echo '<div id="_measurement_dimension_height_fields" style="display:none;">';
				woocommerce_wp_text_input( array(
					...
					'label'       => __( 'Height Label', 'ultimatewoo-pro' ),
					'description' => __( 'Height input field label to display on the frontend', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_select( array(
					'id'          => '_measurement_dimension_height_unit',
					'value'       => $settings['dimension']['height']['unit'],
					'label'       => __( 'Height Unit', 'ultimatewoo-pro' ),
					'options'     => $measurement_units['dimension'],
					'description' => __( 'The frontend height input field unit', 'ultimatewoo-pro' ),
					'desc_tip'    => true,
				) );
				woocommerce_wp_checkbox( array(
					'id'          => '_measurement_dimension_height_editable',
					'value'       => $settings['dimension']['height']['editable'],
					'label'       => __( 'Height Editable', 'ultimatewoo-pro' ),
					'class'       => 'checkbox _measurement_editable',
					'description' => __( 'Check this box to allow the needed height to be entered by the customer', 'ultimatewoo-pro' ),
				) );
				wc_measurement_price_calculator_attributes_inputs( array(
					'measurement'   => 'dimension',
					'input_name'    => 'height',
					'input_label'   => __( 'Height', 'ultimatewoo-pro' ),
					'settings'      => $settings,
				...
				woocommerce_wp_text_input( array(
					...
					'wrapper_class' => '_measurement_pricing_calculator_fields',
					'label'         => __( 'Height Options', 'ultimatewoo-pro' ),
					'description'   => __( 'Use a single number to set a fixed value for this field on the frontend, or a comma-separated list of numbers to create a select box for the customer to choose between.  Example: 1/8, .5, 2', 'ultimatewoo-pro' ),
					'desc_tip'      => true,
				) );
			echo '</div>';
		...
		echo '<div id="area_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_area_pricing_fields" class="_measurement_pricing_fields" style="display:none;">';
				...
				woocommerce_wp_checkbox( array(
					...
					'wrapper_class' => $pricing_weight_wrapper_class . ' _measurement_pricing_calculator_fields',
					'label'         => __( 'Calculated Weight', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define the product weight per unit and calculate the item weight based on the product area', 'ultimatewoo-pro' ),
				) );
				woocommerce_wp_checkbox( array(
					...
					'wrapper_class' => 'stock_fields _measurement_pricing_calculator_fields',
					'label'         => __( 'Calculated Inventory', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define inventory per unit and calculate inventory based on the product area', 'ultimatewoo-pro' ),
				) );
			...
			woocommerce_wp_text_input( array(
				...
				'label'       => __( 'Area Label', 'ultimatewoo-pro' ),
				'description' => __( 'Area input field label to display on the frontend', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_select( array(
				'id'          => '_measurement_area_unit',
				'value'       => $settings['area']['area']['unit'],
				'label'       => __( 'Area Unit', 'ultimatewoo-pro' ),
				'options'     => $measurement_units['area'],
				'description' => __( 'The frontend area input field unit', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_checkbox( array(
				'id'          => '_measurement_area_editable',
				'value'       => $settings['area']['area']['editable'],
				'label'       => __( 'Editable', 'ultimatewoo-pro' ),
				'class'       => 'checkbox _measurement_editable',
				'description' => __( 'Check this box to allow the needed measurement to be entered by the customer', 'ultimatewoo-pro' ),
			) );
			wc_measurement_price_calculator_attributes_inputs( array(
				'measurement'   => 'area',
				'input_name'    => 'area',
				'input_label'   => __( 'Area', 'ultimatewoo-pro' ),
				'settings'      => $settings,
			...
			woocommerce_wp_text_input( array(
				...
				'wrapper_class' => '_measurement_pricing_calculator_fields',
				'label'         => __( 'Area Options', 'ultimatewoo-pro' ),
				'description'   => __( 'Use a single number to set a fixed value for this field on the frontend, or a comma-separated list of numbers to create a select box for the customer to choose between.  Example: 1/8, .5, 2', 'ultimatewoo-pro' ),
				'desc_tip'      => true,
			) );
		echo '</div>';
		...
		echo '<div id="volume_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_volume_pricing_fields" class="_measurement_pricing_fields" style="display:none;">';
				...
				woocommerce_wp_checkbox( array(
					...
					'wrapper_class' => $pricing_weight_wrapper_class . ' _measurement_pricing_calculator_fields',
					'label'         => __( 'Calculated Weight', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define the product weight per unit and calculate the item weight based on the product volume', 'ultimatewoo-pro' ),
				) );
				woocommerce_wp_checkbox( array(
					...
					'wrapper_class' => 'stock_fields _measurement_pricing_calculator_fields',
					'label'         => __( 'Calculated Inventory', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define inventory per unit and calculate inventory based on the product volume', 'ultimatewoo-pro' ),
				) );
			...
			woocommerce_wp_text_input( array(
				...
				'label'       => __( 'Volume Label', 'ultimatewoo-pro' ),
				'description' => __( 'Volume input field label to display on the frontend', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_select( array(
				'id'          => '_measurement_volume_unit',
				'value'       => $settings['volume']['volume']['unit'],
				'label'       => __( 'Volume Unit', 'ultimatewoo-pro' ),
				'options'     => $measurement_units['volume'],
				'description' => __( 'The frontend volume input field unit', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_checkbox( array(
			...
			wc_measurement_price_calculator_attributes_inputs( array(
				'measurement'   => 'volume',
				'input_name'    => 'volume',
				'input_label'   => __( 'Volume', 'ultimatewoo-pro' ),
				'settings'      => $settings,
			...
			woocommerce_wp_text_input( array(
				...
				'wrapper_class' => '_measurement_pricing_calculator_fields',
				'label'         => __( 'Volume Options', 'ultimatewoo-pro' ),
				'description'   => __( 'Use a single number to set a fixed value for this field on the frontend, or a comma-separated list of numbers to create a select box for the customer to choose between.  Example: 1/8, .5, 2', 'ultimatewoo-pro' ),
				'desc_tip'      => true,
			) );
		echo '</div>';
		...
		echo '<div id="weight_measurements" class="measurement_fields">';
			...
			echo '<div id="_measurement_weight_pricing_fields" class="_measurement_pricing_fields" style="display:none;">';
				...
				woocommerce_wp_checkbox( array(
					...
					'wrapper_class' => $pricing_weight_wrapper_class . ' _measurement_pricing_calculator_fields',
					'label'         => __( 'Calculated Weight', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to use the customer-configured product weight as the item weight', 'ultimatewoo-pro' ),
				) );
				woocommerce_wp_checkbox( array(
					...
					'wrapper_class' => 'stock_fields _measurement_pricing_calculator_fields',
					'label'         => __( 'Calculated Inventory', 'ultimatewoo-pro' ),
					'description'   => __( 'Check this box to define inventory per unit and calculate inventory based on the product weight', 'ultimatewoo-pro' ),
				) );
			...
			woocommerce_wp_text_input( array(
				...
				'label'       => __( 'Weight Label', 'ultimatewoo-pro' ),
				'description' => __( 'Weight input field label to display on the frontend', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_select( array(
				'id'          => '_measurement_weight_unit',
				'value'       => $settings['weight']['weight']['unit'],
				'label'       => __( 'Weight Unit', 'ultimatewoo-pro' ),
				'options'     => $measurement_units['weight'],
				'description' => __( 'The frontend weight input field unit', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_checkbox( array(
			...
			wc_measurement_price_calculator_attributes_inputs( array(
				'measurement'   => 'weight',
				'input_name'    => 'weight',
				'input_label'   => __( 'Weight', 'ultimatewoo-pro' ),
				'settings'      => $settings,
			...
			woocommerce_wp_text_input( array(
				...
				'wrapper_class' => '_measurement_pricing_calculator_fields',
				'label'         => __( 'Weight Options', 'ultimatewoo-pro' ),
				'description'   => __( 'Use a single number to set a fixed value for this field on the frontend, or a comma-separated list of numbers to create a select box for the customer to choose between.  Example: 1/8, .5, 2', 'ultimatewoo-pro' ),
				'desc_tip'      => true,
			) );
		echo '</div>';
		...
		echo '<div id="wall-dimension_measurements" class="measurement_fields">';
			...
			woocommerce_wp_text_input( array(
				...
				'label'       => __( 'Length Label', 'ultimatewoo-pro' ),
				'description' => __( 'Wall length input field label to display on the frontend', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_select( array(
				...
				'label'       => __( 'Length Unit', 'ultimatewoo-pro' ),
				'options'     => $measurement_units['dimension'],
				'description' => __( 'The frontend wall length input field unit', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			wc_measurement_price_calculator_attributes_inputs( array(
			...
			woocommerce_wp_text_input( array(
				...
				'label'       => __( 'Height Label', 'ultimatewoo-pro' ),
				'description' => __( 'Room wall height input field label to display on the frontend', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			woocommerce_wp_select( array(
				...
				'label'       => __( 'Height Unit', 'ultimatewoo-pro' ),
				'options'     => $measurement_units['dimension'],
				'description' => __( 'The frontend room wall height input field unit', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
			) );
			wc_measurement_price_calculator_attributes_inputs( array(
				'measurement'   => 'wall-dimension',
