...
class WC_Wishlists_Settings_Admin {
	...
	public function __construct() {
		...
		$this->settings_tabs = array(
			'wc_wishlists' => __( 'Wishlists', 'ultimatewoo-pro' )
		);
	...
	function settings_tab_action() {
		 ...
		 * Future place of the email alerts settings
		  $links = array(
		  'main' => '<a href="' . $main_url . '" class="#class#">' . __('Wishlist Options', 'ultimatewoo-pro') . '</a>',
		  'email' => '<a href="' . $email_url . '" class="#class#">' . __('Wishlist Email Options', 'ultimatewoo-pro') . '</a>'
		  );
		 */
	...
	function init_form_fields() {
		...
		$this->fields['wc_wishlists_main'] = apply_filters( 'woocommerce_wishlists_options_settings_fields', array(
				array(
					'name' => __( 'Wishlist Options', 'ultimatewoo-pro' ),
					'type' => 'title',
					'desc' => '',
					'id'   => 'wc_wishlists_options'
				),
				array(
					'name'    => __( 'Allow Guests to Create Lists', 'ultimatewoo-pro' ),
				...
				array(
					'name'    => __( 'Automatically Create Lists', 'ultimatewoo-pro' ),
					'desc'    => __( '<br />If set to automatic, a list with a generic title will be used.  If set to no, guests and users will be required to fill out a brief form and give the list a name before it will be created.', 'ultimatewoo-pro' ),
				...
				array(
					'name'    => __( 'Message for Guests', 'ultimatewoo-pro' ),
					'desc'    => __( 'Only appears when Allow Guest to Create Lists is false ', 'ultimatewoo-pro' ),
					'id'      => 'wc_wishlist_guest_disabled_message',
					'css'     => 'width:100%;height:75px',
					'type'    => 'textarea',
					'default' => __( 'Please login or register for an account to create a wishlist', 'ultimatewoo-pro' ),
					'std'     => __( 'Please login or register for an account to create a wishlist', 'ultimatewoo-pro' )
				),
				array(
					'name'    => __( 'Redirect to Wishlist', 'ultimatewoo-pro' ),
					'desc'    => '',
				...
				array(
					'name'    => __( 'Button / Link Type', 'ultimatewoo-pro' ),
					'desc'    => '',
				...
				array(
					'name'    => __( 'Icon ', 'ultimatewoo-pro' ),
					'desc'    => __( 'Only appears when button/link type is set to link', 'ultimatewoo-pro' ),
					'id'      => 'wc_wishlist_icon',
					'type'    => 'select',
					'std'     => 'present',
					'default' => 'present',
				...
				array(
					'name'    => __( 'Button / Link Text', 'ultimatewoo-pro' ),
					'type'    => 'text',
					'desc'    => '',
					'css'     => '',
					'default' => __( 'Add to wishlist', 'ultimatewoo-pro' ),
					'std'     => __( 'Add to wishlist', 'ultimatewoo-pro' ),
					'id'      => 'wc_wishlist_button_text'
				),
				array(
					'name'    => __( 'Cart Label', 'ultimatewoo-pro' ),
					'type'    => 'text',
					'desc'    => '',
					'css'     => '',
					'default' => __( 'From Wishlist', 'ultimatewoo-pro' ),
					'std'     => __( 'From Wishlist', 'ultimatewoo-pro' ),
					'id'      => 'wc_wishlists_cart_label'
				),
				array( 'type' => 'sectionend', 'id' => 'wc_wishlists_options' ),
				array(
					'name' => __( 'Wishlist Processing Options', 'ultimatewoo-pro' ),
					'type' => 'title',
					'desc' => __( 'Choose behaivor after an item has been ordered from a wishlist', 'ultimatewoo-pro' ),
					'id'   => 'wc_wishlists_processing_options'
				),
				array(
					'name'    => __( 'Automatic Removal ', 'ultimatewoo-pro' ),
					'desc'    => __( 'Automatically remove items from a wishlist?', 'ultimatewoo-pro' ),
				...
				array(
					'name'    => __( 'Automatic Removal on Status ', 'ultimatewoo-pro' ),
					'desc'    => __( 'Choose the status the order must reach for the item to be removed from the list', 'ultimatewoo-pro' ),
				...
				array(
					'name' => __( 'Wishlist Sharing Options', 'ultimatewoo-pro' ),
					'type' => 'title',
					'desc' => '',
					'id'   => 'wc_wishlists_sharing_options'
				),
				array(
					'name'          => __( 'Social Options', 'ultimatewoo-pro' ),
					'desc'          => __( 'Facebook', 'ultimatewoo-pro' ),
				...
				array(
					'desc'          => __( 'Twitter', 'ultimatewoo-pro' ),
				...
				array(
					'desc'          => __( 'Pinterest', 'ultimatewoo-pro' ),
				...
				array(
					'name' => __( 'Wishlist Style Options', 'ultimatewoo-pro' ),
					'type' => 'title',
					'desc' => '',
					'id'   => 'wc_wishlists_style_options'
				),
				array(
					'name'    => __( 'Custom Buttons', 'ultimatewoo-pro' ),
					'desc'    => __( 'Enable Custom Wishlist Button Colors', 'ultimatewoo-pro' ),
				...
				array(
					'name'    => __( 'Custom CSS', 'ultimatewoo-pro' ),
					'class'   => 'wide',
					'css'     => 'width:100%;min-height:100px',
					'desc'    => __( 'Enter in any custom styles you would like here.', 'ultimatewoo-pro' ),
				...
				array(
					'name' => __( 'Wishlist Page Options', 'ultimatewoo-pro' ),
					'type' => 'title',
				...
				array(
					'name'     => __( 'My Lists Page', 'ultimatewoo-pro' ),
					'desc'     => sprintf( __( 'This is where users will view their lists. Page contents: [wc_wishlists_my_archive]', 'ultimatewoo-pro' ), '<a target="_blank" href="options-permalink.php">', '</a>' ),
				...
				array(
					'name'     => __( 'Create a List', 'ultimatewoo-pro' ),
					'desc'     => sprintf( __( 'This is where users will create new lists. Page contents: [wc_wishlists_create]', 'ultimatewoo-pro' ), '<a target="_blank" href="options-permalink.php">', '</a>' ),
				...
				array(
					'name'     => __( 'Edit a List', 'ultimatewoo-pro' ),
					'desc'     => sprintf( __( 'This is where users will edit their list. Page contents: [wc_wishlists_edit]', 'ultimatewoo-pro' ), '<a target="_blank" href="options-permalink.php">', '</a>' ),
				...
				array(
					'name'     => __( 'Find a List', 'ultimatewoo-pro' ),
					'desc'     => sprintf( __( 'This is where you can search for lists. Page contents: [wc_wishlists_search]', 'ultimatewoo-pro' ), '<a target="_blank" href="options-permalink.php">', '</a>' ),
				...
				array(
					'name'     => __( 'View a List', 'ultimatewoo-pro' ),
					'desc'     => sprintf( __( 'This is where public and protected lists are viewed. Page contents: [wc_wishlists_single]', 'ultimatewoo-pro' ), '<a target="_blank" href="options-permalink.php">', '</a>' ),
				...
				array(
					'name' => __( 'Wishlist Notification Options', 'ultimatewoo-pro' ),
					'type' => 'title',
					'desc' => __( 'Automatically send notifications to wishlist owners when a price reduction occurs', 'ultimatewoo-pro' ),
					'id'   => 'wc_wishlists_notification_options'
				),
				array(
					'name'    => __( 'Send Notifications', 'ultimatewoo-pro' ),
					'desc'    => '',
	...
	function init_email_fields() {
		 ...
		 * Future place for email subscription settings. 
		  ...
		  array(
		  'name' => __('Email Templates', 'ultimatewoo-pro'),
		  'type' => 'title',
		  'desc' => '',
		  'id' => 'wc_wishlists_email_templates'
		  ),
		  array(
		  'name' => __('Subject', 'ultimatewoo-pro'),
		  'type' => 'text',
		  'desc' => '',
		  'css' => 'width:50%;',
		  'default' => __('A wishlist has been shared with you', 'ultimatewoo-pro'),
		  'id' => 'wc_wishlist_sharing_email_subject'
		  ),
		  array(
		  'name' => __('Email Body', 'ultimatewoo-pro'),
	...
	public function wishlist_styles_setting() {
        ...
        <tr valign="top" class="woocommerce_frontend_css_colors">
            ...
            <td class="forminp"><?php
				...
				// Show inputs
				$this->frontend_css_color_picker( __( 'Button', 'ultimatewoo-pro' ), 'wishlist_frontend_button_css_colors', $colors['primary'], __( 'Choose the color for the background of the button when link type is set to button.', 'ultimatewoo-pro' ) );
				?>
				...
				// Show inputs
				$this->frontend_css_color_picker( __( 'Text', 'ultimatewoo-pro' ), 'wishlist_frontend_link_css_colors', $colors['link'], __( 'Choose the color for the font of the button when link type is set to button.', 'ultimatewoo-pro' ) );
				?>
