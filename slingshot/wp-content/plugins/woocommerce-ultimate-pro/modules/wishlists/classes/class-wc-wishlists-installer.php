...
class WC_Wishlists_Installer {
	...
	private static function _do_install() {
		$root = self::create_page( 'my-lists', __( 'Wishlists', 'ultimatewoo-pro' ), '[wc_wishlists_my_archive]', 0 );

		self::create_page( 'create-a-list', __( 'Create a List', 'ultimatewoo-pro' ), '[wc_wishlists_create]', $root );
		self::create_page( 'view-a-list', __( 'View a List', 'ultimatewoo-pro' ), '[wc_wishlists_single ]', $root );
		self::create_page( 'find-a-list', __( 'Find a List', 'ultimatewoo-pro' ), '[wc_wishlists_search]', $root );
		self::create_page( 'edit-my-list', __( 'Manage List', 'ultimatewoo-pro' ), '[wc_wishlists_edit]', $root );
