...
class WC_Wishlists_Admin_Controller {
	...
	public function on_admin_menu() {
		add_submenu_page( 'edit.php?post_type=wishlist', __( 'Notifications', 'ultimatewoo-pro' ), __( 'Notifications', 'ultimatewoo-pro' ), 'manage_woocommerce', 'wc-wishlist-admin-notifications', array(
			$this,
