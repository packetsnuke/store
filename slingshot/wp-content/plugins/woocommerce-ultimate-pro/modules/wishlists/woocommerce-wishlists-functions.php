...
function woocommerce_wishlists_nav( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) :
        ...
        <nav id="<?php echo $html_id; ?>" class="navigation" role="navigation">
            <div class="nav-previous alignleft"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older lists', 'ultimatewoo-pro' ) ); ?></div>
            <div class="nav-next alignright"><?php previous_posts_link( __( 'Newer lists <span class="meta-nav">&rarr;</span>', 'ultimatewoo-pro' ) ); ?></div>
			...
			foreach ( $email_forms as $wishlist ) {
                ...
                <div class="wl-modal hide" id="share-via-email-<?php echo $wishlist->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display:none;z-index:9999;">
                    <div class="wl-modal-header">
                        ...
                        <h1 id="myModalLabel"><?php _e( 'Share this list via e-mail ', 'ultimatewoo-pro' ); ?></h1>
                    </div>
                    <div class="wl-modal-body">
                        <form id="share-via-email-<?php echo $wishlist->id; ?>-form" action="" method="POST">
                            <p class="form-row form-row-wide" class="wishlist_name">
                                <label for="wishlist_email_from"><?php _e( 'Your name:', 'ultimatewoo-pro' ); ?></label>
                            ...
                            <p class="form-row form-row-wide">
                                <label for="wishlist_email_to"><?php _e( 'To:', 'ultimatewoo-pro' ); ?></label>
                                <textarea class="wl-em-to" name="wishlist_email_to" rows="2" placeholder="<?php _e( 'Type in e-mail addresses: jo@example.com, jan@example.com.', 'ultimatewoo-pro' ); ?>"></textarea>
                            </p>
                            <p class="form-row form-row-wide">
                                <label for="wishlist_content"><?php _e( 'Add a note:', 'ultimatewoo-pro' ); ?></label>
                    ...
                    <div class="wl-modal-footer">
                        <button class="button alt share-via-email-button" data-form="share-via-email-<?php echo $wishlist->id; ?>-form" aria-hidden="true"><?php _e( 'Send email', 'ultimatewoo-pro' ); ?></button>
                    </div>
                </div>
