...
class WoocommerceGpfCommon {
	...
	function __construct() {
		...
		$this->product_fields = array(
			'availability' => array(
				'desc'        => __( 'Availability', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'What status to send for in stock items. Out of stock products will always show as "Out of stock" irrespective of this setting.', 'ultimatewoo-pro' ),
			...
			'is_bundle' => array(
				'desc'        => __( 'Bundle indicator (is_bundle)', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'Allows you to indicate whether a product is a "bundle" of products.', 'ultimatewoo-pro' ),
				'callback'    => 'render_is_bundle',
				'feed_types'  => array( 'google' ),
			),

			'availability_date' => array(
				'desc'        => __( 'Availability date', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'If you are accepting orders for products that are available for preorder, use this attribute to indicate when the product becomes available for delivery.', 'ultimatewoo-pro' ),
				'callback'    => 'render_availability_date',
				'feed_types'  => array( 'google' ),
			 ),

			'condition' => array(
				'desc'        => __( 'Condition', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'Condition or state of items', 'ultimatewoo-pro' ),
			...
			'brand' => array(
				'desc'            => __( 'Brand', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Brand of the items', 'ultimatewoo-pro' ),
				'can_default'     => true,
			...
			'mpn' => array(
				'desc'            => __( 'Manufacturer Part Number (MPN)', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'This code uniquely identifies the product to its manufacturer', 'ultimatewoo-pro' ),
				'feed_types'      => array( 'google', 'bing' ),
				'can_prepopulate' => true,
				'google_len'      => 70,
				'max_values'      => 1,
			...
			'product_type' => array(
				'desc'            => __( 'Product Type', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Your category of the items', 'ultimatewoo-pro' ),
			...
			'google_product_category' => array(
				'desc'        => __( 'Google Product Category', 'ultimatewoo-pro' ),
				'full_desc'   => __( "Google's category of the item", 'ultimatewoo-pro' ),
				'callback'    => 'render_product_type',
				'can_default' => true,
				'feed_types'  => array( 'google' ),
				'google_len'  => 750,
			...
			'gtin' => array(
				'desc'            => __( 'Global Trade Item Number (GTIN)', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Global Trade Item Numbers (GTINs) for your items. These identifiers include UPC (in North America), EAN (in Europe), JAN (in Japan), and ISBN (for books)', 'ultimatewoo-pro' ),
				'feed_types'      => array( 'google' ),
				'can_prepopulate' => true,
				'google_len'      => 50,
				'multiple'        => true,
			...
			'gender' => array(
				'desc'        => __( 'Gender', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'Target gender for the item', 'ultimatewoo-pro' ),
			...
			'age_group' => array(
				'desc'        => __( 'Age Group', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'Target age group for the item', 'ultimatewoo-pro' ),
			...
			'color' => array(
				'desc'            => __( 'Colour', 'ultimatewoo-pro' ),
				'full_desc'       => __( "Item's Colour", 'ultimatewoo-pro' ),
				'feed_types'      => array( 'google' ),
				'can_prepopulate' => true,
				'google_len'      => 100,
			),
			...
			'size' => array(
				'desc'            => __( 'Size', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Size of the items', 'ultimatewoo-pro' ),
				'feed_types'      => array( 'google' ),
				'can_prepopulate' => true,
				'google_len'      => 100,
			),
			...
			'size_type' => array(
				'desc'        => __( 'Size type', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'Size type of the items', 'ultimatewoo-pro' ),
				'feed_types'  => array( 'google' ),
				'can_default' => true,
			...
			'size_system' => array(
				'desc'        => __( 'Size system', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'Size system', 'ultimatewoo-pro' ),
				'feed_types'  => array( 'google' ),
				'can_default' => true,
			...
			'material' => array(
				'desc'            => __( 'Material', 'ultimatewoo-pro' ),
				'full_desc'       => __( "Item's material", 'ultimatewoo-pro' ),
				'feed_types'      => array( 'google' ),
				'can_prepopulate' => true,
				'google_len'      => 200,
			),
			...
			'pattern' => array(
				'desc'            => __( 'Pattern', 'ultimatewoo-pro' ),
				'full_desc'       => __( "Item's pattern", 'ultimatewoo-pro' ),
				'feed_types'      => array( 'google' ),
				'can_prepopulate' => true,
				'google_len'      => 100,
			),
			...
			'identifier_exists' => array(
				'desc'        => __( 'Identifier exists flag', 'ultimatewoo-pro' ),
				'full_desc'   => __( "Whether to include 'Identifier exists - false' when products don't have the relevant identifiers", 'ultimatewoo-pro' ),
			...
			'adwords_grouping' => array(
				'desc'        => __( 'Adwords grouping filter', 'ultimatewoo-pro' ),
				'full_desc'   => __( 'Used to group products in an arbitrary way. It can be used for Product Filters to limit a campaign to a group of products or Product Targets, to bid differently for a group of products. This is a required field if the advertiser wants to bid differently to different sub-sets of products in the CPC or CPA % version. It can only hold one value.', 'ultimatewoo-pro' ),
				'can_default' => true,
				'feed_types'  => array( 'google' ),
			),

			'adwords_labels' => array(
				'desc'            => __( 'Adwords labels', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Very similar to adwords_grouping, but it will only work on CPC. You can enter multiple values here, separating them with a comma (,). e.g. "widget,box".', 'ultimatewoo-pro' ),
				'can_default'     => true,
				'can_prepopulate' => true,
				'feed_types'      => array( 'google' ),
				'multiple'        => true,
			...
			'bing_category' => array(
				'desc'        => __( 'Bing Category', 'ultimatewoo-pro' ),
				'full_desc'   => __( "Bing's category of the item", 'ultimatewoo-pro' ),
			...
			'delivery_label' => array(
				'desc'            => __( 'Delivery label', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'You can use this to control which shipping rules from your Merchant Centre account are applied to this product.', 'ultimatewoo-pro' ),
				'can_default'     => true,
				'can_prepopulate' => true,
			...
			'custom_label_0' => array(
				'desc'            => __( 'Custom label 0', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Can be used to segment your products when setting up shopping campaigns in Adwords.', 'ultimatewoo-pro' ),
				'can_default'     => true,
				'callback'        => 'render_textfield',
				'can_prepopulate' => true,
				'feed_types'      => array( 'google', 'bing' ),
			...
			'custom_label_1' => array(
				'desc'            => __( 'Custom label 1', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Can be used to segment your products when setting up shopping campaigns in Adwords.', 'ultimatewoo-pro' ),
				'can_default'     => true,
				'callback'        => 'render_textfield',
				'can_prepopulate' => true,
			...
			'custom_label_2' => array(
				'desc'            => __( 'Custom label 2', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Can be used to segment your products when setting up shopping campaigns in Adwords.', 'ultimatewoo-pro' ),
				'can_default'     => true,
				'callback'        => 'render_textfield',
				'can_prepopulate' => true,
			...
			'custom_label_3' => array(
				'desc'            => __( 'Custom label 3', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Can be used to segment your products when setting up shopping campaigns in Adwords.', 'ultimatewoo-pro' ),
				'can_default'     => true,
				'callback'        => 'render_textfield',
				'can_prepopulate' => true,
			...
			'custom_label_4' => array(
				'desc'            => __( 'Custom label 4', 'ultimatewoo-pro' ),
				'full_desc'       => __( 'Can be used to segment your products when setting up shopping campaigns in Adwords.', 'ultimatewoo-pro' ),
				'can_default'     => true,
				'callback'        => 'render_textfield',
				'can_prepopulate' => true,
			...
			'promotion_id' => array(
				'desc'            => __( 'Promotion ID', 'ultimatewoo-pro' ),
