...
class WC_Social_Login_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$options = array(
			...
			'description' => __( 'Display social login buttons.', 'ultimatewoo-pro' ),
		);

		// instantiate the widget
		parent::__construct( 'WC_Social_Login_Widget', __( 'WooCommerce Social Login', 'ultimatewoo-pro' ), $options );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'ultimatewoo-pro' ) ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'return_url' ) ); ?>"><?php esc_html_e( 'Return URL', 'ultimatewoo-pro' ) ?>:</label>
