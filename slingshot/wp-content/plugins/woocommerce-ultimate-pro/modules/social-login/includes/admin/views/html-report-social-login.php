	...
	<table class="wp-list-table widefat fixed social-registrations">
		<thead>
			<tr>
				...
				<th><?php /* translators: The number of registrations for a provider */ esc_html_e( 'Registrations', 'ultimatewoo-pro' ); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			jQuery.plot(
				...
				],
				{
					...
					series: {
							...
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . /* translators: Number of linked accounts for a provider. A number will be prepended to this string. Example: 5 linked accounts */ esc_attr__( 'linked accounts', 'ultimatewoo-pro' ); ?>"
					},
					legend: {
							show: false
					}
