...
class WC_Social_Login_Admin {
	...
	public function add_admin_report( $reports ) {
		...
		if ( isset( $reports['customers'] ) ) {
			...
			$reports['customers']['reports']['social_login'] = array(
				...
				'title'       => __( 'Social Registration', 'ultimatewoo-pro' ),
				'description' => '',
				'hide_title'  => true,
	...
	public function render_user_social_profiles( $user ) {
		...
		?>
		<h3><?php esc_html_e( 'Connected Social Profiles', 'ultimatewoo-pro' ) ?></h3>
		<table class="form-table">
			<tr>
				<th><label><?php esc_html_e( 'Social Profiles', 'ultimatewoo-pro' ); ?></label></th>
				<td>
					<?php
	...
	public function add_user_columns( $columns ) {
		return SV_WC_Helper::array_insert_after( $columns, 'email', array( 'wc_social_login_profiles' => __( 'Social Profiles', 'ultimatewoo-pro' ) ) );
	}
