...
abstract class WC_Social_Login_Provider extends WC_Settings_API {
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'enabled' => array(
				...
				'label'   => sprintf( __( 'Enable %s', 'ultimatewoo-pro' ), $this->get_title() ),
				'default' => 'no',
			),
			...
			'id' => array(
				...
				'title'       => _x( 'Client ID', 'Social Login provider app identifier', 'ultimatewoo-pro' ),
				'type'        => 'text',
				'description' => __( 'Your app ID', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
				'default'     => '',
			),
			...
			'secret' => array(
				...
				'type'        => 'password',
				'description' => __( 'Your app secret', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
				'default'     => '',
			),

			'login_button_text' => array(
				'title'       => __( 'Login Button Text', 'ultimatewoo-pro' ),
				'type'        => 'text',
				'description' => __( 'Controls the text displayed on the login button.', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
				'default'     => $this->get_default_login_button_text(),
			),

			'link_button_text' => array(
				'title'       => _x( 'Link Button Text', 'noun', 'ultimatewoo-pro' ),
				'type'        => 'text',
				'description' => __( 'Controls the text displayed on the link account button.', 'ultimatewoo-pro' ),
				'desc_tip'    => true,
	...
	public function unlink_account() {
		...
		if ( ! wp_verify_nonce( $_GET['_wpnonce'], 'unlink' ) ) {
			wp_die( esc_html__( 'Oops, you took too long, please try again.', 'ultimatewoo-pro' ), 'Error' );
		}
