...
class WC_Social_Login_Provider_Disqus extends WC_Social_Login_Provider {
	...
	public function __construct( $base_auth_path ) {
		...
		$this->id                = 'disqus';
		$this->title             = __( 'Disqus', 'ultimatewoo-pro' );
		$this->color             = '#2e9fff';
	...
	public function get_description() {
		...
		$description = sprintf( __( 'Need help setting up and configuring Disqus? %1$sRead the docs%2$s', 'ultimatewoo-pro' ), '<a href="http://docs.woocommerce.com/document/woocommerce-social-login-create-social-apps#disqus">', '</a>');
	...
	public function init_form_fields() {
		...
		$this->form_fields['id']['title']     = __( 'API Key', 'ultimatewoo-pro' );
		$this->form_fields['secret']['title'] = __( 'API Secret', 'ultimatewoo-pro' );
	}
	...
	public function get_default_login_button_text() {
		return __( 'Log in with Disqus', 'ultimatewoo-pro' );
	}
	...
	public function get_default_link_button_text() {
		return __( 'Link your account to Disqus', 'ultimatewoo-pro' );
	}
	...
	public function get_notices() {
		return array(
			'account_linked'         => __( 'Your Disqus account is now linked to your account.', 'ultimatewoo-pro' ),
			'account_unlinked'       => __( 'Disqus was successfully unlinked from your account.', 'ultimatewoo-pro' ),
			'account_already_linked' => __( 'This Disqus account is already linked to another user account.', 'ultimatewoo-pro' ),
			'account_already_exists' => __( 'A user account using the same email address as this Disqus account already exists.', 'ultimatewoo-pro' ),
		);
	}
