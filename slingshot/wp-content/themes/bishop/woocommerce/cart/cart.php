...
<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" class="col-sm-8 clearfix cart-page">
	...
	<div class="cart-list">
							...
							<td class="product-remove">
								<?php
									echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
										'<a href="%s" title="%s"><span class="remove fa fa-times"></span></a>',
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<h3 class="head"><?php esc_html_e( 'Coupon:', 'woocommerce' ); ?></h3>
				<table class="shop_table coupon" cellspacing="0">
					<tr>
						<td>
							<input name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" />
