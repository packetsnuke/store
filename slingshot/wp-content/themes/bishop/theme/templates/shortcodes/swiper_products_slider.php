                                        ...
                                        <div class="swiper-product-informations item-<?php echo $num_items_to_display ?> <?php echo $have_sidebar ?>">
                                                ...
                                                <span class="product-title">
                                                    <a href="<?php the_permalink() ?>">
                                                        <?php
                                                        $post_title = property_exists( 'WC_Product', 'post' ) ? $product->post->post_title : get_post_field( 'post_title', $product->get_id() );
                                            ...
                                            <?php if ( yit_get_option( 'shop-enable' ) == 'no' || yit_get_option( 'shop-add-to-cart' ) == 'no' ) { ?>
                                                <span class="product-view-details">
                                                    <a href="<?php echo get_permalink( $product->get_id() ); ?>" class="btn <?php echo $button ?>"><?php _e( 'View Details', 'yit' ); ?></a>
                                                </span>
                                            <?php } else { ?>
