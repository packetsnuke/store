...
class YIT_Newsletter{
    ...
    public function register_scripts_for_panel() {
        ...
        if( 'edit.php' == $pagenow && get_current_screen()->id == 'newsletter_page_newsletter-settings-page' ){
            ...
            wp_enqueue_script('yit-chosen',$this->plugin_assets_url . '/js/chosen/chosen.jquery.js',array('jquery'));
            wp_enqueue_style('yit_options_chosen_style',$this->plugin_assets_url . '/css/chosen/chosen.css');
        }
    }
