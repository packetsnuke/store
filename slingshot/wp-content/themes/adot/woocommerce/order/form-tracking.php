...
<form action="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" method="post" class="track_order">
	...
	<p class="form-row form-row-first"><label for="orderid"><?php _e( 'Order ID', 'woocommerce' ); ?></label>
	...
	<p class="form-row">
		<input type="submit" class="button" name="track" value="<?php _e( 'track order', 'woocommerce' ); ?>" />
	</p>
