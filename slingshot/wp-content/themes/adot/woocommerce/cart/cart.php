...
<form action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table cart" cellspacing="0">
		<thead>
		<tr>
			<!--				<th class="product-thumbnail">--><?php //_e( 'Image', 'thim' ); ?><!--</th>-->
			...
			<td colspan="6" class="actions">
				...
				<?php if ( WC()->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<label for="coupon_code"><?php _e( 'Voucher Code', 'woocommerce' ); ?></label>
						<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Enter Voucher Code', 'woocommerce' ); ?>" />
