...
?>
	<div class="content-area portfolio_container <?php echo esc_attr($pf_layout); ?>">
		<?php
		if ( $pf_layout !== 'fullwidth' ) {
			echo '<div class="container"><div class="row">';
		}
		?>
		<div class="wapper_portfolio <?php echo esc_attr($class_gutter); ?> <?php echo  esc_attr($item_size); ?> <?php echo  esc_attr($paging); ?> <?php echo  esc_attr($sign_sidebar); ?>">
			<?php if ( $filter_hiden !== "on" ) { ?>
				<div class="portfolio-tabs-wapper filters <?php echo  esc_attr($filter_style); ?>"<?php echo ent2ncr($css_filter_position); ?> >
			...
			<div class="portfolio_column">
				<ul class="content_portfolio <?php echo esc_attr($item_effect); ?>">
					<?php
